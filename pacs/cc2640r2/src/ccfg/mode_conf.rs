...
impl XoscFreqR {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Option<XoscFreq> {
        match self.bits {
            3 => Some(XoscFreq::_24m),
            2 => Some(XoscFreq::_48m),
            1 => Some(XoscFreq::Hposc),
            _ => None,
        }
    }
    #[doc = "24 MHz XOSC_HF"]
...
Reserved for future use. Software should not rely on the value of a reserved. Writing any other value than the reset/default value may result in undefined behavior."]
pub type XoscFreqW<'a, REG> = crate::FieldWriter<'a, REG, 2, XoscFreq>;
