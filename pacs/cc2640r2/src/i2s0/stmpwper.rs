...
pub struct R(crate::R<STMPWPER_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<STMPWPER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<STMPWPER_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<STMPWPER_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `STMPWPER` writer"]
pub struct W(crate::W<STMPWPER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<STMPWPER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<STMPWPER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<STMPWPER_SPEC>) -> Self {
        W(writer)
    }
}
...
Used to define when STMPWCNT is to be reset so number of WCLK edges are found for the size of the sample buffer. This is thus a modulo value for the WCLK counter. This number must correspond to the size of the sample buffer used by the system (that is the index of the last sample plus 1)."]
pub type VALUE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, STMPWPER_SPEC, u16, u16, 16, O>;
...
pub type RESERVED16_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, STMPWPER_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - 15:0\\]
Used to define when STMPWCNT is to be reset so number of WCLK edges are found for the size of the sample buffer. This is thus a modulo value for the WCLK counter. This number must correspond to the size of the sample buffer used by the system (that is the index of the last sample plus 1)."]
    #[inline(always)]
...
#[doc = "WCLK Counter Period Value\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [stmpwper](index.html) module"]
pub struct STMPWPER_SPEC;
impl crate::RegisterSpec for STMPWPER_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [stmpwper::R](R) reader structure"]
impl crate::Readable for STMPWPER_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [stmpwper::W](W) writer structure"]
impl crate::Writable for STMPWPER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets STMPWPER to value 0"]
impl crate::Resettable for STMPWPER_SPEC {
