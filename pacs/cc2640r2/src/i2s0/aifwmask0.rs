...
pub type R = crate::R<Aifwmask0Spec>;
#[doc = "Register `AIFWMASK0` writer"]
pub type W = crate::W<Aifwmask0Spec>;
...
Bit-mask indicating valid channels in a frame on AD0. In single-phase mode, each bit represents one channel, starting with LSB for the first word in the frame. A frame can contain up to 8 channels. Channels that are not included in the mask will not be sampled and stored in memory, and clocked out as '0'. In dual-phase mode, only the two LSBs are considered. For a stereo configuration, set both bits. For a mono configuration, set bit 0 only. In mono mode, only channel 0 will be sampled and stored to memory, and channel 0 will be repeated when clocked out. In mono mode, only channel 0 will be sampled and stored to memory, and channel 0 will be repeated in the second phase when clocked out. If all bits are zero, no input words will be stored to memory, and the output data lines will be constant '0'. This can be utilized when PWM debug output is desired without any actively used output pins."]
    #[inline(always)]
    #[must_use]
    pub fn mask(&mut self) -> MaskW<Aifwmask0Spec> {
        MaskW::new(self, 0)
    }
    #[doc = "Bits 8:31 - 31:8\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved8(&mut self) -> Reserved8W<Aifwmask0Spec> {
        Reserved8W::new(self, 8)
    }
}
#[doc = "Word Selection Bit Mask for Pin 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`aifwmask0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`aifwmask0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Aifwmask0Spec;
impl crate::RegisterSpec for Aifwmask0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`aifwmask0::R`](R) reader structure"]
impl crate::Readable for Aifwmask0Spec {}
#[doc = "`write(|w| ..)` method takes [`aifwmask0::W`](W) writer structure"]
impl crate::Writable for Aifwmask0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets AIFWMASK0 to value 0x03"]
impl crate::Resettable for Aifwmask0Spec {
