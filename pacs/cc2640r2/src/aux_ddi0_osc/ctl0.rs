...
pub type SCLK_MF_SRC_SEL_R = crate::BitReader<SCLK_MF_SRC_SEL_A>;
#[doc = "1:1\\]
Internal. Only to be used through TI provided API.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
Internal. Only to be used through TI provided API."]
pub type SCLK_MF_SRC_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CTL0_SPEC, SCLK_MF_SRC_SEL_A, O>;
impl<'a, const O: u8> SCLK_MF_SRC_SEL_W<'a, O> {
...
pub type SPARE4_R = crate::BitReader<bool>;
#[doc = "Field `SPARE4` writer - 4:4\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type SPARE4_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTL0_SPEC, bool, O>;
...
Source select for aclk_ref 00: RCOSC_HF derived (31.25kHz) 01: XOSC_HF derived (31.25kHz) 10: RCOSC_LF (32kHz) 11: XOSC_LF (32.768kHz)"]
pub type ACLK_REF_SRC_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTL0_SPEC, u8, u8, 2, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED15_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTL0_SPEC, bool, O>;
...
pub type ALLOW_SCLK_HF_SWITCHING_R = crate::BitReader<bool>;
#[doc = "Field `ALLOW_SCLK_HF_SWITCHING` writer - 16:16\\]
0: Default - Switching of HF clock source is disabled . 1: Allows switching of sclk_hf source. Provided to prevent switching of the SCLK_HF source when running from flash (a long period during switching could corrupt flash). When sclk_hf switching is disabled, a new source can be started when SCLK_HF_SRC_SEL is changed, but the switch will not occur until this bit is set. This bit should be set to enable clock switching after STAT0.PENDINGSCLKHFSWITCHING indicates the new HF clock is ready. When switching completes (also indicated by STAT0.PENDINGSCLKHFSWITCHING) sclk_hf switching should be disabled to prevent flash corruption. Switching should not be enabled when running from flash."]
pub type ALLOW_SCLK_HF_SWITCHING_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTL0_SPEC, bool, O>;
#[doc = "Field `RESERVED17` reader - 21:17\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED17_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RESERVED17` writer - 21:17\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED17_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTL0_SPEC, u8, u8, 5, O>;
#[doc = "Field `FORCE_KICKSTART_EN` reader - 22:22\\]
Internal. Only to be used through TI provided API."]
pub type FORCE_KICKSTART_EN_R = crate::BitReader<bool>;
#[doc = "Field `FORCE_KICKSTART_EN` writer - 22:22\\]
Internal. Only to be used through TI provided API."]
pub type FORCE_KICKSTART_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTL0_SPEC, bool, O>;
#[doc = "Field `RESERVED23` reader - 24:23\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED23_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RESERVED23` writer - 24:23\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED23_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTL0_SPEC, u8, u8, 2, O>;
...
Internal. Only to be used through TI provided API."]
    ...
    pub fn sclk_mf_src_sel(&self) -> SCLK_MF_SRC_SEL_R {
        SCLK_MF_SRC_SEL_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bits 2:3 - 3:2\\]
Source select for sclk_lf"]
    #[inline(always)]
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    ...
    pub fn spare4(&self) -> SPARE4_R {
        SPARE4_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bits 5:6 - 6:5\\]
Source select for aclk_ref 00: RCOSC_HF derived (31.25kHz) 01: XOSC_HF derived (31.25kHz) 10: RCOSC_LF (32kHz) 11: XOSC_LF (32.768kHz)"]
    #[inline(always)]
    pub fn aclk_ref_src_sel(&self) -> ACLK_REF_SRC_SEL_R {
        ACLK_REF_SRC_SEL_R::new(((self.bits >> 5) & 3) as u8)
    }
    #[doc = "Bits 7:8 - 8:7\\]
Source select for aclk_tdc. 00: RCOSC_HF (48MHz) 01: RCOSC_HF (24MHz) 10: XOSC_HF (24MHz) 11: Not used"]
    #[inline(always)]
...
0: Default - Switching of HF clock source is disabled . 1: Allows switching of sclk_hf source. Provided to prevent switching of the SCLK_HF source when running from flash (a long period during switching could corrupt flash). When sclk_hf switching is disabled, a new source can be started when SCLK_HF_SRC_SEL is changed, but the switch will not occur until this bit is set. This bit should be set to enable clock switching after STAT0.PENDINGSCLKHFSWITCHING indicates the new HF clock is ready. When switching completes (also indicated by STAT0.PENDINGSCLKHFSWITCHING) sclk_hf switching should be disabled to prevent flash corruption. Switching should not be enabled when running from flash."]
    ...
    pub fn allow_sclk_hf_switching(&self) -> ALLOW_SCLK_HF_SWITCHING_R {
        ALLOW_SCLK_HF_SWITCHING_R::new(((self.bits >> 16) & 1) != 0)
    }
...
Internal. Only to be used through TI provided API."]
    ...
    pub fn force_kickstart_en(&self) -> FORCE_KICKSTART_EN_R {
        FORCE_KICKSTART_EN_R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bits 23:24 - 24:23\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    pub fn reserved23(&self) -> RESERVED23_R {
        RESERVED23_R::new(((self.bits >> 23) & 3) as u8)
    }
    #[doc = "Bit 25 - 25:25\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn sclk_mf_src_sel(&mut self) -> SCLK_MF_SRC_SEL_W<1> {
        SCLK_MF_SRC_SEL_W::new(self)
    }
    #[doc = "Bits 2:3 - 3:2\\]
Source select for sclk_lf"]
    #[inline(always)]
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn spare4(&mut self) -> SPARE4_W<4> {
        SPARE4_W::new(self)
    }
    #[doc = "Bits 5:6 - 6:5\\]
Source select for aclk_ref 00: RCOSC_HF derived (31.25kHz) 01: XOSC_HF derived (31.25kHz) 10: RCOSC_LF (32kHz) 11: XOSC_LF (32.768kHz)"]
    #[inline(always)]
    #[must_use]
    pub fn aclk_ref_src_sel(&mut self) -> ACLK_REF_SRC_SEL_W<5> {
...
0: Default - Switching of HF clock source is disabled . 1: Allows switching of sclk_hf source. Provided to prevent switching of the SCLK_HF source when running from flash (a long period during switching could corrupt flash). When sclk_hf switching is disabled, a new source can be started when SCLK_HF_SRC_SEL is changed, but the switch will not occur until this bit is set. This bit should be set to enable clock switching after STAT0.PENDINGSCLKHFSWITCHING indicates the new HF clock is ready. When switching completes (also indicated by STAT0.PENDINGSCLKHFSWITCHING) sclk_hf switching should be disabled to prevent flash corruption. Switching should not be enabled when running from flash."]
    #[inline(always)]
    #[must_use]
    pub fn allow_sclk_hf_switching(&mut self) -> ALLOW_SCLK_HF_SWITCHING_W<16> {
        ALLOW_SCLK_HF_SWITCHING_W::new(self)
    }
    #[doc = "Bits 17:21 - 21:17\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn force_kickstart_en(&mut self) -> FORCE_KICKSTART_EN_W<22> {
        FORCE_KICKSTART_EN_W::new(self)
    }
    #[doc = "Bits 23:24 - 24:23\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
