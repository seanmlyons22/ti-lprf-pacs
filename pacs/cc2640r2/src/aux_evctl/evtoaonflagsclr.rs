...
Write 1 to clear EVTOAONFLAGS.ADC_DONE. Read value is 0."]
pub type ADC_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVTOAONFLAGSCLR_SPEC, bool, O>;
...
Write 1 to clear EVTOAONFLAGS.TDC_DONE. Read value is 0."]
pub type TDC_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVTOAONFLAGSCLR_SPEC, bool, O>;
...
Write 1 to clear EVTOAONFLAGS.TIMER0_EV. Read value is 0."]
pub type TIMER0_EV_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVTOAONFLAGSCLR_SPEC, bool, O>;
...
Write 1 to clear EVTOAONFLAGS.TIMER1_EV. Read value is 0."]
pub type TIMER1_EV_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVTOAONFLAGSCLR_SPEC, bool, O>;
