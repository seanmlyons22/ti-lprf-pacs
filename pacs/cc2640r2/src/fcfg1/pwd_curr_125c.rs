...
pub type R = crate::R<PwdCurr125cSpec>;
#[doc = "Register `PWD_CURR_125C` writer"]
pub type W = crate::W<PwdCurr125cSpec>;
...
Worst-case baseline maximum powerdown current, in units of 0.5uA"]
    #[inline(always)]
    #[must_use]
    pub fn baseline(&mut self) -> BaselineW<PwdCurr125cSpec> {
...
Additional maximum current, in units of 1uA, with XOSC_HF on in low-power mode"]
    #[inline(always)]
    #[must_use]
    pub fn delta_xosc_lpm(&mut self) -> DeltaXoscLpmW<PwdCurr125cSpec> {
...
Additional maximum current, in 1uA units, with RF memory retention"]
    #[inline(always)]
    #[must_use]
    pub fn delta_rfmem_ret(&mut self) -> DeltaRfmemRetW<PwdCurr125cSpec> {
...
Additional maximum current, in units of 1uA, with cache retention"]
    #[inline(always)]
    #[must_use]
    pub fn delta_cache_ref(&mut self) -> DeltaCacheRefW<PwdCurr125cSpec> {
        DeltaCacheRefW::new(self, 24)
    }
}
#[doc = "Power Down Current Control 125C\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwd_curr_125c::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwd_curr_125c::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PwdCurr125cSpec;
impl crate::RegisterSpec for PwdCurr125cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwd_curr_125c::R`](R) reader structure"]
impl crate::Readable for PwdCurr125cSpec {}
#[doc = "`write(|w| ..)` method takes [`pwd_curr_125c::W`](W) writer structure"]
impl crate::Writable for PwdCurr125cSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWD_CURR_125C to value 0xade1_809a"]
impl crate::Resettable for PwdCurr125cSpec {
    const RESET_VALUE: u32 = 0xade1_809a;
}
