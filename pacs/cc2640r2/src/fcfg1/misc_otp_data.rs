...
pub type PO_TAIL_RES_TRIM_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PO_TAIL_RES_TRIM` writer - 11:8\\]
Internal. Only to be used through TI provided API."]
pub type PO_TAIL_RES_TRIM_W<'a, const O: u8> =
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn po_tail_res_trim(&mut self) -> PO_TAIL_RES_TRIM_W<8> {
        PO_TAIL_RES_TRIM_W::new(self)
    }
    #[doc = "Bits 12:14 - 14:12\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
impl crate::Resettable for MISC_OTP_DATA_SPEC {
    const RESET_VALUE: Self::Ux = 0xc600;
}
