...
pub type R = crate::R<InfrclkdivdsSpec>;
#[doc = "Register `INFRCLKDIVDS` writer"]
pub type W = crate::W<InfrclkdivdsSpec>;
#[doc = "1:0\\]
...
Division rate for clocks driving modules in the MCU_AON domain when system CPU is in seepsleep mode. Division ratio affects both infrastructure clock and perbusull clock."]
    #[inline(always)]
    #[must_use]
    pub fn ratio(&mut self) -> RatioW<InfrclkdivdsSpec> {
        RatioW::new(self, 0)
    }
    #[doc = "Bits 2:31 - 31:2\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved2(&mut self) -> Reserved2W<InfrclkdivdsSpec> {
        Reserved2W::new(self, 2)
    }
}
#[doc = "Infrastructure Clock Division Factor For DeepSleep Mode\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`infrclkdivds::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`infrclkdivds::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct InfrclkdivdsSpec;
impl crate::RegisterSpec for InfrclkdivdsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`infrclkdivds::R`](R) reader structure"]
impl crate::Readable for InfrclkdivdsSpec {}
#[doc = "`write(|w| ..)` method takes [`infrclkdivds::W`](W) writer structure"]
impl crate::Writable for InfrclkdivdsSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets INFRCLKDIVDS to value 0"]
impl crate::Resettable for InfrclkdivdsSpec {
