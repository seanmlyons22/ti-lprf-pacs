...
Interrupt enable for RFCPEIFG.COMMAND_STARTED."]
pub type COMMAND_STARTED_W<'a, const O: u8> = crate::BitWriter<'a, u32, RFCPEIEN_SPEC, bool, O>;
...
Interrupt enable for RFCPEIFG.FG_COMMAND_STARTED."]
pub type FG_COMMAND_STARTED_W<'a, const O: u8> = crate::BitWriter<'a, u32, RFCPEIEN_SPEC, bool, O>;
