...
pub type CommandStartedR = crate::BitReader;
#[doc = "Field `COMMAND_STARTED` writer - 12:12\\]
Interrupt enable for RFCPEIFG.COMMAND_STARTED."]
pub type CommandStartedW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FG_COMMAND_STARTED` reader - 13:13\\]
Interrupt enable for RFCPEIFG.FG_COMMAND_STARTED."]
pub type FgCommandStartedR = crate::BitReader;
#[doc = "Field `FG_COMMAND_STARTED` writer - 13:13\\]
Interrupt enable for RFCPEIFG.FG_COMMAND_STARTED."]
pub type FgCommandStartedW<'a, REG> = crate::BitWriter<'a, REG>;
...
Interrupt enable for RFCPEIFG.COMMAND_STARTED."]
    #[inline(always)]
    #[must_use]
    pub fn command_started(&mut self) -> CommandStartedW<RfcpeienSpec> {
...
Interrupt enable for RFCPEIFG.FG_COMMAND_STARTED."]
    #[inline(always)]
    #[must_use]
    pub fn fg_command_started(&mut self) -> FgCommandStartedW<RfcpeienSpec> {
