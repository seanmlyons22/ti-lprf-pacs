...
#[doc = "Timer 0 Target"]
pub mod t0target;
#[doc = "T0CNTR (rw) register accessor: an alias for `Reg<T0CNTR_SPEC>`"]
pub type T0CNTR = crate::Reg<t0cntr::T0CNTR_SPEC>;
#[doc = "Timer 0 Counter"]
pub mod t0cntr;
...
pub mod t1target;
#[doc = "T1CNTR (rw) register accessor: an alias for `Reg<T1CNTR_SPEC>`"]
pub type T1CNTR = crate::Reg<t1cntr::T1CNTR_SPEC>;
#[doc = "Timer 1 Counter"]
pub mod t1cntr;
