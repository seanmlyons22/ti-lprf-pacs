#[doc = "Register `CH3EVCFG` reader"]
pub struct R(crate::R<CH3EVCFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH3EVCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH3EVCFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH3EVCFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH3EVCFG` writer"]
pub struct W(crate::W<CH3EVCFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH3EVCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH3EVCFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH3EVCFG_SPEC>) -> Self {
        W(writer)
    }
}
...
#[repr(u8)]
pub enum CCACT_A {
    #[doc = "15: Pulse on compare repeatedly. Channel function sequence: - Pulse enabled events when CH3CC.VALUE = CNTR.VALUE. The event is high for two timer clock periods."]
    PULSE_ON_CMP = 15,
    #[doc = "14: Toggle on compare repeatedly. Channel function sequence: - Toggle enabled events when CH3CC.VALUE = CNTR.VALUE."]
    TGL_ON_CMP = 14,
    #[doc = "13: Set on compare repeatedly. Channel function sequence: - Set enabled events when CH3CC.VALUE = CNTR.VALUE."]
    SET_ON_CMP = 13,
    #[doc = "12: Clear on compare repeatedly. Channel function sequence: - Clear enabled events when CH3CC.VALUE = CNTR.VALUE."]
    CLR_ON_CMP = 12,
    ...
    #[doc = "7: Pulse on compare, and then disable channel. Channel function sequence: - Pulse enabled events when CH3CC.VALUE = CNTR.VALUE. - Disable channel. The event is high for two timer clock periods."]
    PULSE_ON_CMP_DIS = 7,
    #[doc = "6: Toggle on compare, and then disable channel. Channel function sequence: - Toggle enabled events when CH3CC.VALUE = CNTR.VALUE. - Disable channel."]
    TGL_ON_CMP_DIS = 6,
    #[doc = "5: Set on compare, and then disable channel. Channel function sequence: - Set enabled events when CH3CC.VALUE = CNTR.VALUE. - Disable channel."]
    SET_ON_CMP_DIS = 5,
    #[doc = "4: Clear on compare, and then disable channel. Channel function sequence: - Clear enabled events when CH3CC.VALUE = CNTR.VALUE. - Disable channel."]
    CLR_ON_CMP_DIS = 4,
    #[doc = "3: Set on zero, toggle on compare, and then disable channel. Channel function sequence: - Set enabled events when CNTR.VALUE = 0. - Toggle enabled events when CH3CC.VALUE = CNTR.VALUE. - Disable channel. Enabled events are cleared when CH3CC.VALUE = 0 and CNTR.VALUE = 0."]
    SET_ON_0_TGL_ON_CMP_DIS = 3,
    #[doc = "2: Clear on zero, toggle on compare, and then disable channel. Channel function sequence: - Clear enabled events when CNTR.VALUE = 0. - Toggle enabled events when CH3CC.VALUE = CNTR.VALUE. - Disable channel. Enabled events are set when CH3CC.VALUE = 0 and CNTR.VALUE = 0."]
...
pub type CCACT_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CH3EVCFG_SPEC, u8, CCACT_A, 4, O>;
...
Event 0 enable. 0: Channel 3 does not control event 0. 1: Channel 3 controls event 0. When 0 < CCACT < 8, EV0_GEN becomes zero after a capture or compare event."]
pub type EV0_GEN_R = crate::BitReader<bool>;
#[doc = "Field `EV0_GEN` writer - 4:4\\]
Event 0 enable. 0: Channel 3 does not control event 0. 1: Channel 3 controls event 0. When 0 < CCACT < 8, EV0_GEN becomes zero after a capture or compare event."]
pub type EV0_GEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH3EVCFG_SPEC, bool, O>;
#[doc = "Field `EV1_GEN` reader - 5:5\\]
Event 1 enable. 0: Channel 3 does not control event 1. 1: Channel 3 controls event 1. When 0 < CCACT < 8, EV1_GEN becomes zero after a capture or compare event."]
pub type EV1_GEN_R = crate::BitReader<bool>;
#[doc = "Field `EV1_GEN` writer - 5:5\\]
Event 1 enable. 0: Channel 3 does not control event 1. 1: Channel 3 controls event 1. When 0 < CCACT < 8, EV1_GEN becomes zero after a capture or compare event."]
pub type EV1_GEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH3EVCFG_SPEC, bool, O>;
#[doc = "Field `EV2_GEN` reader - 6:6\\]
Event 2 enable. 0: Channel 3 does not control event 2. 1: Channel 3 controls event 2. When 0 < CCACT < 8, EV2_GEN becomes zero after a capture or compare event."]
pub type EV2_GEN_R = crate::BitReader<bool>;
#[doc = "Field `EV2_GEN` writer - 6:6\\]
Event 2 enable. 0: Channel 3 does not control event 2. 1: Channel 3 controls event 2. When 0 < CCACT < 8, EV2_GEN becomes zero after a capture or compare event."]
pub type EV2_GEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH3EVCFG_SPEC, bool, O>;
#[doc = "Field `EV3_GEN` reader - 7:7\\]
Event 3 enable. 0: Channel 3 does not control event 3. 1: Channel 3 controls event 3. When 0 < CCACT < 8, EV3_GEN becomes zero after a capture or compare event."]
pub type EV3_GEN_R = crate::BitReader<bool>;
#[doc = "Field `EV3_GEN` writer - 7:7\\]
Event 3 enable. 0: Channel 3 does not control event 3. 1: Channel 3 controls event 3. When 0 < CCACT < 8, EV3_GEN becomes zero after a capture or compare event."]
pub type EV3_GEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH3EVCFG_SPEC, bool, O>;
#[doc = "Field `RESERVED8` reader - 31:8\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED8_R = crate::FieldReader<u32, u32>;
#[doc = "Field `RESERVED8` writer - 31:8\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED8_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH3EVCFG_SPEC, u32, u32, 24, O>;
impl R {
    #[doc = "Bits 0:3 - 3:0\\]
Capture-Compare action. Capture-Compare action defines 15 different channel functions that utilize capture, compare, and zero events."]
    #[inline(always)]
