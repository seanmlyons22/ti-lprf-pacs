...
pub struct R(crate::R<CH0EVCFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH0EVCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH0EVCFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH0EVCFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH0EVCFG` writer"]
pub struct W(crate::W<CH0EVCFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH0EVCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH0EVCFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH0EVCFG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CCACT_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CH0EVCFG_SPEC, u8, CCACT_A, 4, O>;
...
Event 0 enable. 0: Channel 0 does not control event 0. 1: Channel 0 controls event 0. When 0 < CCACT < 8, EV0_GEN becomes zero after a capture or compare event."]
pub type EV0_GEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH0EVCFG_SPEC, bool, O>;
...
Event 1 enable. 0: Channel 0 does not control event 1. 1: Channel 0 controls event 1. When 0 < CCACT < 8, EV1_GEN becomes zero after a capture or compare event."]
pub type EV1_GEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH0EVCFG_SPEC, bool, O>;
...
Event 2 enable. 0: Channel 0 does not control event 2. 1: Channel 0 controls event 2. When 0 < CCACT < 8, EV2_GEN becomes zero after a capture or compare event."]
pub type EV2_GEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH0EVCFG_SPEC, bool, O>;
...
Event 3 enable. 0: Channel 0 does not control event 3. 1: Channel 0 controls event 3. When 0 < CCACT < 8, EV3_GEN becomes zero after a capture or compare event."]
pub type EV3_GEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH0EVCFG_SPEC, bool, O>;
#[doc = "Field `RESERVED8` reader - 31:8\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED8_R = crate::FieldReader<u32, u32>;
#[doc = "Field `RESERVED8` writer - 31:8\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED8_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH0EVCFG_SPEC, u32, u32, 24, O>;
impl R {
    #[doc = "Bits 0:3 - 3:0\\]
Capture-Compare action. Capture-Compare action defines 15 different channel functions that utilize capture, compare, and zero events."]
    #[inline(always)]
