...
#[doc = "Field `FSM_BSLP1` reader - 31:0\\]
Internal. Only to be used through TI provided API."]
pub type FSM_BSLP1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `FSM_BSLP1` writer - 31:0\\]
Internal. Only to be used through TI provided API."]
pub type FSM_BSLP1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FSM_BSLP1_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn fsm_bslp1(&self) -> FSM_BSLP1_R {
        FSM_BSLP1_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn fsm_bslp1(&mut self) -> FSM_BSLP1_W<0> {
        FSM_BSLP1_W::new(self)
    }
