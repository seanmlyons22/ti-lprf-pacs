...
pub type FsmBslp1R = crate::FieldReader<u32>;
#[doc = "Field `FSM_BSLP1` writer - 31:0\\]
Internal. Only to be used through TI provided API."]
pub type FsmBslp1W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn fsm_bslp1(&self) -> FsmBslp1R {
        FsmBslp1R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn fsm_bslp1(&mut self) -> FsmBslp1W<FsmBslp1Spec> {
        FsmBslp1W::new(self, 0)
    }
}
