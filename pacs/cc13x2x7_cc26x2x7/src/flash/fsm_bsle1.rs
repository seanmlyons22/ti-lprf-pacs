...
pub type FsmBsle1R = crate::FieldReader<u32>;
#[doc = "Field `FSM_BSLE1` writer - 31:0\\]
Internal. Only to be used through TI provided API."]
pub type FsmBsle1W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn fsm_bsle1(&self) -> FsmBsle1R {
        FsmBsle1R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn fsm_bsle1(&mut self) -> FsmBsle1W<FsmBsle1Spec> {
        FsmBsle1W::new(self, 0)
    }
}
