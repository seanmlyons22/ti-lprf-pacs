...
pub type FSM_BSLP0_R = crate::FieldReader<u32, u32>;
#[doc = "Field `FSM_BSLP0` writer - 31:0\\]
Internal. Only to be used through TI provided API."]
pub type FSM_BSLP0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FSM_BSLP0_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn fsm_bslp0(&self) -> FSM_BSLP0_R {
        FSM_BSLP0_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn fsm_bslp0(&mut self) -> FSM_BSLP0_W<0> {
        FSM_BSLP0_W::new(self)
    }
