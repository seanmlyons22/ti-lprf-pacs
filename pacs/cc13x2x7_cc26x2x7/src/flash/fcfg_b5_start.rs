...
pub type B5_START_ADDR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `B5_START_ADDR` writer - 23:0\\]
Internal. Only to be used through TI provided API."]
pub type B5_START_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FCFG_B5_START_SPEC, u32, u32, 24, O>;
#[doc = "Field `B5_MUX_FACTOR` reader - 27:24\\]
Internal. Only to be used through TI provided API."]
pub type B5_MUX_FACTOR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `B5_MUX_FACTOR` writer - 27:24\\]
Internal. Only to be used through TI provided API."]
pub type B5_MUX_FACTOR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FCFG_B5_START_SPEC, u8, u8, 4, O>;
#[doc = "Field `B5_MAX_SECTOR` reader - 31:28\\]
Internal. Only to be used through TI provided API."]
pub type B5_MAX_SECTOR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `B5_MAX_SECTOR` writer - 31:28\\]
Internal. Only to be used through TI provided API."]
pub type B5_MAX_SECTOR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FCFG_B5_START_SPEC, u8, u8, 4, O>;
impl R {
    #[doc = "Bits 0:23 - 23:0\\]
Internal. Only to be used through TI provided API."]
    ...
    pub fn b5_start_addr(&self) -> B5_START_ADDR_R {
        B5_START_ADDR_R::new(self.bits & 0x00ff_ffff)
    }
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn b5_start_addr(&mut self) -> B5_START_ADDR_W<0> {
        B5_START_ADDR_W::new(self)
    }
    #[doc = "Bits 24:27 - 27:24\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn b5_mux_factor(&mut self) -> B5_MUX_FACTOR_W<24> {
        B5_MUX_FACTOR_W::new(self)
    }
    #[doc = "Bits 28:31 - 31:28\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn b5_max_sector(&mut self) -> B5_MAX_SECTOR_W<28> {
        B5_MAX_SECTOR_W::new(self)
    }
