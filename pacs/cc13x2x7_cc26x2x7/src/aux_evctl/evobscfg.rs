...
impl EvobsSelR {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> EvobsSel {
        match self.bits {
            63 => EvobsSel::AuxTimer2ClkswRdy,
            62 => EvobsSel::AuxDacHoldActive,
            61 => EvobsSel::AuxSmphAutotakeDone,
            60 => EvobsSel::AuxAdcFifoNotEmpty,
            59 => EvobsSel::AuxAdcFifoAlmostFull,
            58 => EvobsSel::AuxAdcIrq,
            57 => EvobsSel::AuxAdcDone,
            56 => EvobsSel::AuxIsrcResetN,
            55 => EvobsSel::AuxTdcDone,
            54 => EvobsSel::AuxTimer0Ev,
            53 => EvobsSel::AuxTimer1Ev,
            52 => EvobsSel::AuxTimer2Pulse,
            51 => EvobsSel::AuxTimer2Ev3,
            50 => EvobsSel::AuxTimer2Ev2,
            49 => EvobsSel::AuxTimer2Ev1,
            48 => EvobsSel::AuxTimer2Ev0,
            47 => EvobsSel::AuxCompb,
            46 => EvobsSel::AuxCompa,
            45 => EvobsSel::McuObsmux1,
            44 => EvobsSel::McuObsmux0,
            43 => EvobsSel::McuEv,
            42 => EvobsSel::AclkRef,
            41 => EvobsSel::VddrRecharge,
            40 => EvobsSel::McuActive,
            39 => EvobsSel::PwrDwn,
            38 => EvobsSel::SclkLf,
            37 => EvobsSel::AonBatmonTempUpd,
            36 => EvobsSel::AonBatmonBatUpd,
            35 => EvobsSel::AonRtc4khz,
            34 => EvobsSel::AonRtcCh2Dly,
            33 => EvobsSel::AonRtcCh2,
            32 => EvobsSel::ManualEv,
            31 => EvobsSel::Auxio31,
            30 => EvobsSel::Auxio30,
            29 => EvobsSel::Auxio29,
            28 => EvobsSel::Auxio28,
    ...
    pub fn is_aux_timer2_clksw_rdy(&self) -> bool {
        *self == EvobsSel::AuxTimer2ClkswRdy
    }
...
Select which event from the asynchronous event bus that represents AUX_EV_OBS in AUX_AIODIOn."]
pub type EvobsSelW<'a, REG> = crate::FieldWriter<'a, REG, 6, EvobsSel, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn aux_timer2_clksw_rdy(self) -> &'a mut crate::W<REG> {
        self.variant(EvobsSel::AuxTimer2ClkswRdy)
    }
    #[doc = "EVSTAT3.AUX_DAC_HOLD_ACTIVE"]
    #[inline(always)]
    ...
    pub fn aon_batmon_temp_upd(self) -> &'a mut crate::W<REG> {
        self.variant(EvobsSel::AonBatmonTempUpd)
    }
    #[doc = "EVSTAT2.AON_BATMON_BAT_UPD"]
    #[inline(always)]
    pub fn aon_batmon_bat_upd(self) -> &'a mut crate::W<REG> {
        self.variant(EvobsSel::AonBatmonBatUpd)
    }
    #[doc = "EVSTAT2.AON_RTC_4KHZ"]
    #[inline(always)]
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved6(&mut self) -> Reserved6W<EvobscfgSpec> {
