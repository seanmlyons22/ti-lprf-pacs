...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED10_W<'a, const O: u8> = crate::FieldWriter<'a, u32, XOSCHFCTL_SPEC, u8, u8, 2, O>;
...
pub type TCXO_MODE_R = crate::BitReader<bool>;
#[doc = "Field `TCXO_MODE` writer - 12:12\\]
If this register is 1 when BYPASS is 1, this will enable clock qualification on the TCXO clock on external input. This register has no effect when BYPASS is 0."]
pub type TCXO_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, XOSCHFCTL_SPEC, bool, O>;
...
pub type TCXO_MODE_XOSC_HF_EN_R = crate::BitReader<bool>;
#[doc = "Field `TCXO_MODE_XOSC_HF_EN` writer - 13:13\\]
If this register is 1 when TCXO_MODE is 1, then the XOSC_HF is enabled, turning on the XOSC_HF bias current allowing a DC bias point to be provided to the clipped-sine wave clock signal on external input."]
pub type TCXO_MODE_XOSC_HF_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, XOSCHFCTL_SPEC, bool, O>;
#[doc = "Field `SPARE14` reader - 31:14\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type SPARE14_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SPARE14` writer - 31:14\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type SPARE14_W<'a, const O: u8> = crate::FieldWriter<'a, u32, XOSCHFCTL_SPEC, u32, u32, 18, O>;
impl R {
    #[doc = "Bits 0:1 - 1:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
If this register is 1 when BYPASS is 1, this will enable clock qualification on the TCXO clock on external input. This register has no effect when BYPASS is 0."]
    ...
    pub fn tcxo_mode(&self) -> TCXO_MODE_R {
        TCXO_MODE_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - 13:13\\]
If this register is 1 when TCXO_MODE is 1, then the XOSC_HF is enabled, turning on the XOSC_HF bias current allowing a DC bias point to be provided to the clipped-sine wave clock signal on external input."]
    #[inline(always)]
    pub fn tcxo_mode_xosc_hf_en(&self) -> TCXO_MODE_XOSC_HF_EN_R {
        TCXO_MODE_XOSC_HF_EN_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bits 14:31 - 31:14\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    pub fn spare14(&self) -> SPARE14_R {
        SPARE14_R::new((self.bits >> 14) & 0x0003_ffff)
    }
}
impl W {
    #[doc = "Bits 0:1 - 1:0\\]
...
If this register is 1 when BYPASS is 1, this will enable clock qualification on the TCXO clock on external input. This register has no effect when BYPASS is 0."]
    #[inline(always)]
    #[must_use]
    pub fn tcxo_mode(&mut self) -> TCXO_MODE_W<12> {
        TCXO_MODE_W::new(self)
    }
    #[doc = "Bit 13 - 13:13\\]
If this register is 1 when TCXO_MODE is 1, then the XOSC_HF is enabled, turning on the XOSC_HF bias current allowing a DC bias point to be provided to the clipped-sine wave clock signal on external input."]
    #[inline(always)]
    #[must_use]
    pub fn tcxo_mode_xosc_hf_en(&mut self) -> TCXO_MODE_XOSC_HF_EN_W<13> {
        TCXO_MODE_XOSC_HF_EN_W::new(self)
    }
    #[doc = "Bits 14:31 - 31:14\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn spare14(&mut self) -> SPARE14_W<14> {
        SPARE14_W::new(self)
    }
