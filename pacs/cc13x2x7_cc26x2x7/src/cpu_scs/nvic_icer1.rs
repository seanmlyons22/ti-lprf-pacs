...
pub type CLRENA32_R = crate::BitReader<bool>;
#[doc = "Field `CLRENA32` writer - 0:0\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 32 (See EVENT:CPUIRQSEL32.EV for details). Reading the bit returns its current enable state."]
pub type CLRENA32_W<'a, const O: u8> = crate::BitWriter<'a, u32, NVIC_ICER1_SPEC, bool, O>;
...
pub type CLRENA33_R = crate::BitReader<bool>;
#[doc = "Field `CLRENA33` writer - 1:1\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 33 (See EVENT:CPUIRQSEL33.EV for details). Reading the bit returns its current enable state."]
pub type CLRENA33_W<'a, const O: u8> = crate::BitWriter<'a, u32, NVIC_ICER1_SPEC, bool, O>;
...
pub type CLRENA34_R = crate::BitReader<bool>;
#[doc = "Field `CLRENA34` writer - 2:2\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 34 (See EVENT:CPUIRQSEL34.EV for details). Reading the bit returns its current enable state."]
pub type CLRENA34_W<'a, const O: u8> = crate::BitWriter<'a, u32, NVIC_ICER1_SPEC, bool, O>;
...
pub type CLRENA35_R = crate::BitReader<bool>;
#[doc = "Field `CLRENA35` writer - 3:3\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 35 (See EVENT:CPUIRQSEL35.EV for details). Reading the bit returns its current enable state."]
pub type CLRENA35_W<'a, const O: u8> = crate::BitWriter<'a, u32, NVIC_ICER1_SPEC, bool, O>;
...
pub type CLRENA36_R = crate::BitReader<bool>;
#[doc = "Field `CLRENA36` writer - 4:4\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 36 (See EVENT:CPUIRQSEL36.EV for details). Reading the bit returns its current enable state."]
pub type CLRENA36_W<'a, const O: u8> = crate::BitWriter<'a, u32, NVIC_ICER1_SPEC, bool, O>;
...
pub type CLRENA37_R = crate::BitReader<bool>;
#[doc = "Field `CLRENA37` writer - 5:5\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 37 (See EVENT:CPUIRQSEL37.EV for details). Reading the bit returns its current enable state."]
pub type CLRENA37_W<'a, const O: u8> = crate::BitWriter<'a, u32, NVIC_ICER1_SPEC, bool, O>;
...
pub type RESERVED6_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, NVIC_ICER1_SPEC, u32, u32, 26, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 32 (See EVENT:CPUIRQSEL32.EV for details). Reading the bit returns its current enable state."]
    #[inline(always)]
    pub fn clrena32(&self) -> CLRENA32_R {
        CLRENA32_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 33 (See EVENT:CPUIRQSEL33.EV for details). Reading the bit returns its current enable state."]
    #[inline(always)]
    pub fn clrena33(&self) -> CLRENA33_R {
        CLRENA33_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - 2:2\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 34 (See EVENT:CPUIRQSEL34.EV for details). Reading the bit returns its current enable state."]
    #[inline(always)]
    pub fn clrena34(&self) -> CLRENA34_R {
        CLRENA34_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - 3:3\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 35 (See EVENT:CPUIRQSEL35.EV for details). Reading the bit returns its current enable state."]
    #[inline(always)]
    pub fn clrena35(&self) -> CLRENA35_R {
        CLRENA35_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 36 (See EVENT:CPUIRQSEL36.EV for details). Reading the bit returns its current enable state."]
    #[inline(always)]
    pub fn clrena36(&self) -> CLRENA36_R {
        CLRENA36_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - 5:5\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 37 (See EVENT:CPUIRQSEL37.EV for details). Reading the bit returns its current enable state."]
    #[inline(always)]
    pub fn clrena37(&self) -> CLRENA37_R {
        CLRENA37_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bits 6:31 - 31:6\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
...
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 32 (See EVENT:CPUIRQSEL32.EV for details). Reading the bit returns its current enable state."]
    #[inline(always)]
    #[must_use]
    pub fn clrena32(&mut self) -> CLRENA32_W<0> {
        CLRENA32_W::new(self)
    }
    #[doc = "Bit 1 - 1:1\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 33 (See EVENT:CPUIRQSEL33.EV for details). Reading the bit returns its current enable state."]
    #[inline(always)]
    #[must_use]
    pub fn clrena33(&mut self) -> CLRENA33_W<1> {
        CLRENA33_W::new(self)
    }
    #[doc = "Bit 2 - 2:2\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 34 (See EVENT:CPUIRQSEL34.EV for details). Reading the bit returns its current enable state."]
    #[inline(always)]
    #[must_use]
    pub fn clrena34(&mut self) -> CLRENA34_W<2> {
        CLRENA34_W::new(self)
    }
    #[doc = "Bit 3 - 3:3\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 35 (See EVENT:CPUIRQSEL35.EV for details). Reading the bit returns its current enable state."]
    #[inline(always)]
    #[must_use]
    pub fn clrena35(&mut self) -> CLRENA35_W<3> {
        CLRENA35_W::new(self)
    }
    #[doc = "Bit 4 - 4:4\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 36 (See EVENT:CPUIRQSEL36.EV for details). Reading the bit returns its current enable state."]
    #[inline(always)]
    #[must_use]
    pub fn clrena36(&mut self) -> CLRENA36_W<4> {
        CLRENA36_W::new(self)
    }
    #[doc = "Bit 5 - 5:5\\]
Writing 0 to this bit has no effect, writing 1 to this bit disables the interrupt number 37 (See EVENT:CPUIRQSEL37.EV for details). Reading the bit returns its current enable state."]
    #[inline(always)]
    #[must_use]
    pub fn clrena37(&mut self) -> CLRENA37_W<5> {
        CLRENA37_W::new(self)
    }
    #[doc = "Bits 6:31 - 31:6\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
