...
#[doc = "Field `MPU_RBAR_A1` reader - 31:0\\]
Alias for MPU_RBAR"]
pub type MPU_RBAR_A1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `MPU_RBAR_A1` writer - 31:0\\]
Alias for MPU_RBAR"]
pub type MPU_RBAR_A1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MPU_RBAR_A1_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - 31:0\\]
Alias for MPU_RBAR"]
    #[inline(always)]
    pub fn mpu_rbar_a1(&self) -> MPU_RBAR_A1_R {
        MPU_RBAR_A1_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - 31:0\\]
Alias for MPU_RBAR"]
    #[inline(always)]
    #[must_use]
    pub fn mpu_rbar_a1(&mut self) -> MPU_RBAR_A1_W<0> {
        MPU_RBAR_A1_W::new(self)
    }
