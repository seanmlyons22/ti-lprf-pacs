...
pub type LOCK_ACCESS_R = crate::FieldReader<u32, u32>;
#[doc = "Field `LOCK_ACCESS` writer - 31:0\\]
A privileged write of 0xC5ACCE55 enables more write access to Control Registers TER, TPR and TCR. An invalid write removes write access."]
pub type LOCK_ACCESS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LAR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - 31:0\\]
A privileged write of 0xC5ACCE55 enables more write access to Control Registers TER, TPR and TCR. An invalid write removes write access."]
    #[inline(always)]
    pub fn lock_access(&self) -> LOCK_ACCESS_R {
        LOCK_ACCESS_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - 31:0\\]
A privileged write of 0xC5ACCE55 enables more write access to Control Registers TER, TPR and TCR. An invalid write removes write access."]
    #[inline(always)]
    #[must_use]
    pub fn lock_access(&mut self) -> LOCK_ACCESS_W<0> {
        LOCK_ACCESS_W::new(self)
    }
