...
you must configure this register while IOPOE bit 7 is 0. In the formulas i = 0 for AUX_AIODIO0, i = 1 for AUX_AIODIO1, and so forth."]
pub mod io7psel;
#[doc = "IOMODEL (rw) register accessor: an alias for `Reg<IOMODEL_SPEC>`"]
pub type IOMODEL = crate::Reg<iomodel::IOMODEL_SPEC>;
#[doc = "Input Output Mode Low This is an alias register for IOMODE.IO0 thru IOMODE.IO3."]
pub mod iomodel;
#[doc = "IOMODEH (rw) register accessor: an alias for `Reg<IOMODEH_SPEC>`"]
pub type IOMODEH = crate::Reg<iomodeh::IOMODEH_SPEC>;
