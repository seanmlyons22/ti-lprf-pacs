...
pub struct R(crate::R<SSICLKGDS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SSICLKGDS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SSICLKGDS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SSICLKGDS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SSICLKGDS` writer"]
pub struct W(crate::W<SSICLKGDS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SSICLKGDS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SSICLKGDS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SSICLKGDS_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CLK_EN` reader - 1:0\\]
0: Disable clock 1: Enable clock Can be forced on by SSICLKGR.AM_CLK_EN For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
...
pub type CLK_EN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SSICLKGDS_SPEC, u8, CLK_EN_A, 2, O>;
...
pub type RESERVED2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SSICLKGDS_SPEC, u32, u32, 30, O>;
impl R {
    #[doc = "Bits 0:1 - 1:0\\]
0: Disable clock 1: Enable clock Can be forced on by SSICLKGR.AM_CLK_EN For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    #[inline(always)]
...
#[doc = "SSI Clock Gate For Deep Sleep Mode\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ssiclkgds](index.html) module"]
pub struct SSICLKGDS_SPEC;
impl crate::RegisterSpec for SSICLKGDS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ssiclkgds::R](R) reader structure"]
impl crate::Readable for SSICLKGDS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ssiclkgds::W](W) writer structure"]
impl crate::Writable for SSICLKGDS_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SSICLKGDS to value 0"]
impl crate::Resettable for SSICLKGDS_SPEC {
