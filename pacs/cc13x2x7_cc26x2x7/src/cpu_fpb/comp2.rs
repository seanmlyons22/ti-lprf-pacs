...
Compare and remap enable comparator 2. CTRL.ENABLE must also be set to enable comparisons. 0x0: Compare and remap for comparator 2 disabled 0x1: Compare and remap for comparator 2 enabled"]
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, COMP2_SPEC, bool, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED1_W<'a, const O: u8> = crate::BitWriter<'a, u32, COMP2_SPEC, bool, O>;
#[doc = "Field `COMP` reader - 28:2\\]
Comparison address."]
pub type COMP_R = crate::FieldReader<u32, u32>;
#[doc = "Field `COMP` writer - 28:2\\]
Comparison address."]
pub type COMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMP2_SPEC, u32, u32, 27, O>;
#[doc = "Field `RESERVED29` reader - 29:29\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED29_R = crate::BitReader<bool>;
#[doc = "Field `RESERVED29` writer - 29:29\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED29_W<'a, const O: u8> = crate::BitWriter<'a, u32, COMP2_SPEC, bool, O>;
...
This selects what happens when the COMP address is matched. Address remapping only takes place for the 0x0 setting. 0x0: Remap to remap address. See REMAP.REMAP 0x1: Set BKPT on lower halfword, upper is unaffected 0x2: Set BKPT on upper halfword, lower is unaffected 0x3: Set BKPT on both lower and upper halfwords."]
pub type REPLACE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMP2_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Compare and remap enable comparator 2. CTRL.ENABLE must also be set to enable comparisons. 0x0: Compare and remap for comparator 2 disabled 0x1: Compare and remap for comparator 2 enabled"]
    #[inline(always)]
