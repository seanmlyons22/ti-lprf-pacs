#[doc = "Register `PROGWU3CFG` reader"]
pub struct R(crate::R<PROGWU3CFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PROGWU3CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PROGWU3CFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PROGWU3CFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PROGWU3CFG` writer"]
pub struct W(crate::W<PROGWU3CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PROGWU3CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PROGWU3CFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PROGWU3CFG_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `WU_SRC` reader - 5:0\\]
Wakeup source from the asynchronous AUX event bus. Only change WU_SRC when EN is 0 or WUFLAGSCLR.PROG_WU3 is 1. If you write a non-enumerated value the behavior is identical to NO_EVENT. The written value is returned when read."]
...
pub type WU_SRC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PROGWU3CFG_SPEC, u8, WU_SRC_A, 6, O>;
...
Programmable wakeup flag enable. 0: Disable wakeup flag. 1: Enable wakeup flag."]
pub type EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, PROGWU3CFG_SPEC, bool, O>;
#[doc = "Field `POL` reader - 7:7\\]
Polarity of WU_SRC. The procedure used to clear the wakeup flag decides level or edge sensitivity, see WUFLAGSCLR.PROG_WU3."]
...
Polarity of WU_SRC. The procedure used to clear the wakeup flag decides level or edge sensitivity, see WUFLAGSCLR.PROG_WU3."]
pub type POL_W<'a, const O: u8> = crate::BitWriter<'a, u32, PROGWU3CFG_SPEC, POL_A, O>;
...
pub type RESERVED8_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PROGWU3CFG_SPEC, u32, u32, 24, O>;
impl R {
    #[doc = "Bits 0:5 - 5:0\\]
Wakeup source from the asynchronous AUX event bus. Only change WU_SRC when EN is 0 or WUFLAGSCLR.PROG_WU3 is 1. If you write a non-enumerated value the behavior is identical to NO_EVENT. The written value is returned when read."]
    #[inline(always)]
