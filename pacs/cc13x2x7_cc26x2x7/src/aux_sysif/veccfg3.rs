#[doc = "Register `VECCFG3` reader"]
pub struct R(crate::R<VECCFG3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<VECCFG3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<VECCFG3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<VECCFG3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `VECCFG3` writer"]
pub struct W(crate::W<VECCFG3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<VECCFG3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<VECCFG3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<VECCFG3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `VEC_EV` reader - 3:0\\]
Select trigger event for vector 3. Non-enumerated values are treated as NONE."]
...
Select trigger event for vector 3. Non-enumerated values are treated as NONE."]
pub type VEC_EV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, VECCFG3_SPEC, u8, VEC_EV_A, 4, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, VECCFG3_SPEC, u32, u32, 28, O>;
impl R {
    #[doc = "Bits 0:3 - 3:0\\]
Select trigger event for vector 3. Non-enumerated values are treated as NONE."]
    #[inline(always)]
...
#[doc = "Vector Configuration 3 AUX_SCE wakeup vector 3 configuration\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [veccfg3](index.html) module"]
pub struct VECCFG3_SPEC;
impl crate::RegisterSpec for VECCFG3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [veccfg3::R](R) reader structure"]
impl crate::Readable for VECCFG3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [veccfg3::W](W) writer structure"]
impl crate::Writable for VECCFG3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets VECCFG3 to value 0"]
impl crate::Resettable for VECCFG3_SPEC {
