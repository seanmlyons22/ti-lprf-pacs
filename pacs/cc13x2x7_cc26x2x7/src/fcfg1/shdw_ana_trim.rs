...
Internal. Only to be used through TI provided API."]
pub type BodBandgapTrimCnfExtR = crate::FieldReader;
#[doc = "Field `BOD_BANDGAP_TRIM_CNF_EXT` writer - 28:27\\]
Internal. Only to be used through TI provided API."]
pub type BodBandgapTrimCnfExtW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `DET_LOGIC_DIS` reader - 29:29\\]
Internal. Only to be used through TI provided API."]
pub type DetLogicDisR = crate::BitReader;
#[doc = "Field `DET_LOGIC_DIS` writer - 29:29\\]
Internal. Only to be used through TI provided API."]
pub type DetLogicDisW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ALT_VDDR_TRIM` reader - 30:30\\]
Internal. Only to be used through TI provided API."]
pub type AltVddrTrimR = crate::BitReader;
#[doc = "Field `ALT_VDDR_TRIM` writer - 30:30\\]
Internal. Only to be used through TI provided API."]
pub type AltVddrTrimW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:5 - 5:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn bod_bandgap_trim_cnf_ext(&self) -> BodBandgapTrimCnfExtR {
        BodBandgapTrimCnfExtR::new(((self.bits >> 27) & 3) as u8)
    }
    #[doc = "Bit 29 - 29:29\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn det_logic_dis(&self) -> DetLogicDisR {
        DetLogicDisR::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - 30:30\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn alt_vddr_trim(&self) -> AltVddrTrimR {
        AltVddrTrimR::new(((self.bits >> 30) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:5 - 5:0\\]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn bod_bandgap_trim_cnf_ext(&mut self) -> BodBandgapTrimCnfExtW<ShdwAnaTrimSpec> {
        BodBandgapTrimCnfExtW::new(self, 27)
    }
    #[doc = "Bit 29 - 29:29\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn det_logic_dis(&mut self) -> DetLogicDisW<ShdwAnaTrimSpec> {
        DetLogicDisW::new(self, 29)
    }
    #[doc = "Bit 30 - 30:30\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn alt_vddr_trim(&mut self) -> AltVddrTrimW<ShdwAnaTrimSpec> {
        AltVddrTrimW::new(self, 30)
    }
}
