...
pub type R = crate::R<Smph13Spec>;
#[doc = "Register `SMPH13` writer"]
pub type W = crate::W<Smph13Spec>;
...
Status when reading: 0: Semaphore is taken 1: Semaphore is available Reading the register causes it to change value to 0. Releasing the semaphore is done by writing 1."]
    #[inline(always)]
    #[must_use]
    pub fn stat(&mut self) -> StatW<Smph13Spec> {
        StatW::new(self, 0)
    }
    #[doc = "Bits 1:31 - 31:1\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved1(&mut self) -> Reserved1W<Smph13Spec> {
        Reserved1W::new(self, 1)
    }
}
#[doc = "MCU SEMAPHORE 13\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`smph13::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`smph13::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Smph13Spec;
impl crate::RegisterSpec for Smph13Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`smph13::R`](R) reader structure"]
impl crate::Readable for Smph13Spec {}
#[doc = "`write(|w| ..)` method takes [`smph13::W`](W) writer structure"]
impl crate::Writable for Smph13Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SMPH13 to value 0x01"]
impl crate::Resettable for Smph13Spec {
