    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "UDMA0 trigger event will be generated when the ADC FIFO is almost full (3/4 full)."]
    #[inline(always)]
    pub fn fifo_almost_full(self) -> &'a mut crate::W<REG> {
        self.variant(Sel::FifoAlmostFull)
    }
    #[doc = "UDMA0 trigger event will be generated when there are samples in the ADC FIFO."]
    #[inline(always)]
    pub fn fifo_not_empty(self) -> &'a mut crate::W<REG> {
        self.variant(Sel::FifoNotEmpty)
    }
}
