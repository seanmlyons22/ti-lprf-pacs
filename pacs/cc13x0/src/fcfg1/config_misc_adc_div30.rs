...
pub type R = crate::R<ConfigMiscAdcDiv30Spec>;
#[doc = "Register `CONFIG_MISC_ADC_DIV30` writer"]
pub type W = crate::W<ConfigMiscAdcDiv30Spec>;
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn dactrim(&mut self) -> DactrimW<ConfigMiscAdcDiv30Spec> {
        DactrimW::new(self, 0)
    }
    #[doc = "Bits 6:8 - 8:6\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn quantctlthres(&mut self) -> QuantctlthresW<ConfigMiscAdcDiv30Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn rssi_offset(&mut self) -> RssiOffsetW<ConfigMiscAdcDiv30Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn min_allowed_rtrim(&mut self) -> MinAllowedRtrimW<ConfigMiscAdcDiv30Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn reserved1(&mut self) -> Reserved1W<ConfigMiscAdcDiv30Spec> {
        Reserved1W::new(self, 22)
    }
}
#[doc = "Internal. Only to be used through TI provided API.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`config_misc_adc_div30::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`config_misc_adc_div30::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ConfigMiscAdcDiv30Spec;
impl crate::RegisterSpec for ConfigMiscAdcDiv30Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`config_misc_adc_div30::R`](R) reader structure"]
impl crate::Readable for ConfigMiscAdcDiv30Spec {}
#[doc = "`write(|w| ..)` method takes [`config_misc_adc_div30::W`](W) writer structure"]
impl crate::Writable for ConfigMiscAdcDiv30Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CONFIG_MISC_ADC_DIV30 to value 0xffc2_014d"]
impl crate::Resettable for ConfigMiscAdcDiv30Spec {
