...
pub type R = crate::R<PwdCurr110cSpec>;
#[doc = "Register `PWD_CURR_110C` writer"]
pub type W = crate::W<PwdCurr110cSpec>;
...
Worst-case baseline maximum powerdown current, in units of 0.5uA"]
    #[inline(always)]
    #[must_use]
    pub fn baseline(&mut self) -> BaselineW<PwdCurr110cSpec> {
...
Additional maximum current, in units of 1uA, with XOSC_HF on in low-power mode"]
    #[inline(always)]
    #[must_use]
    pub fn delta_xosc_lpm(&mut self) -> DeltaXoscLpmW<PwdCurr110cSpec> {
...
Additional maximum current, in 1uA units, with RF memory retention"]
    #[inline(always)]
    #[must_use]
    pub fn delta_rfmem_ret(&mut self) -> DeltaRfmemRetW<PwdCurr110cSpec> {
...
Additional maximum current, in units of 1uA, with cache retention"]
    #[inline(always)]
    #[must_use]
    pub fn delta_cache_ref(&mut self) -> DeltaCacheRefW<PwdCurr110cSpec> {
        DeltaCacheRefW::new(self, 24)
    }
}
#[doc = "Power Down Current Control 110C\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwd_curr_110c::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwd_curr_110c::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PwdCurr110cSpec;
impl crate::RegisterSpec for PwdCurr110cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwd_curr_110c::R`](R) reader structure"]
impl crate::Readable for PwdCurr110cSpec {}
#[doc = "`write(|w| ..)` method takes [`pwd_curr_110c::W`](W) writer structure"]
impl crate::Writable for PwdCurr110cSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWD_CURR_110C to value 0x789e_706b"]
impl crate::Resettable for PwdCurr110cSpec {
    const RESET_VALUE: u32 = 0x789e_706b;
}
