...
pub struct R(crate::R<CONFIG_RF_FRONTEND_DIV30_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CONFIG_RF_FRONTEND_DIV30_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CONFIG_RF_FRONTEND_DIV30_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CONFIG_RF_FRONTEND_DIV30_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CONFIG_RF_FRONTEND_DIV30` writer"]
pub struct W(crate::W<CONFIG_RF_FRONTEND_DIV30_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CONFIG_RF_FRONTEND_DIV30_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CONFIG_RF_FRONTEND_DIV30_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CONFIG_RF_FRONTEND_DIV30_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RFLDO_TRIM_OUTPUT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONFIG_RF_FRONTEND_DIV30_SPEC, u8, u8, 7, O>;
...
pub type CTL_PA0_TRIM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONFIG_RF_FRONTEND_DIV30_SPEC, u8, u8, 5, O>;
...
pub type LNA_IB_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONFIG_RF_FRONTEND_DIV30_SPEC, u8, u8, 4, O>;
...
#[doc = "Internal. Only to be used through TI provided API.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [config_rf_frontend_div30](index.html) module"]
pub struct CONFIG_RF_FRONTEND_DIV30_SPEC;
impl crate::RegisterSpec for CONFIG_RF_FRONTEND_DIV30_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [config_rf_frontend_div30::R](R) reader structure"]
impl crate::Readable for CONFIG_RF_FRONTEND_DIV30_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [config_rf_frontend_div30::W](W) writer structure"]
impl crate::Writable for CONFIG_RF_FRONTEND_DIV30_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CONFIG_RF_FRONTEND_DIV30 to value 0x7000_3f80"]
impl crate::Resettable for CONFIG_RF_FRONTEND_DIV30_SPEC {
