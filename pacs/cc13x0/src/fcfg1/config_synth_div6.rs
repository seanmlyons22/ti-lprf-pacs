...
pub type R = crate::R<ConfigSynthDiv6Spec>;
#[doc = "Register `CONFIG_SYNTH_DIV6` writer"]
pub type W = crate::W<ConfigSynthDiv6Spec>;
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn sldo_trim_output(&mut self) -> SldoTrimOutputW<ConfigSynthDiv6Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn ldovco_trim_output(&mut self) -> LdovcoTrimOutputW<ConfigSynthDiv6Spec> {
...
Trim value for RF Core. Value is read by RF Core ROM FW during RF Core initialization."]
    #[inline(always)]
    #[must_use]
    pub fn rfc_mdm_demiqmc0(&mut self) -> RfcMdmDemiqmc0W<ConfigSynthDiv6Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn disable_corner_cap(&mut self) -> DisableCornerCapW<ConfigSynthDiv6Spec> {
        DisableCornerCapW::new(self, 28)
    }
}
#[doc = "Internal. Only to be used through TI provided API.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`config_synth_div6::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`config_synth_div6::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ConfigSynthDiv6Spec;
impl crate::RegisterSpec for ConfigSynthDiv6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`config_synth_div6::R`](R) reader structure"]
impl crate::Readable for ConfigSynthDiv6Spec {}
#[doc = "`write(|w| ..)` method takes [`config_synth_div6::W`](W) writer structure"]
impl crate::Writable for ConfigSynthDiv6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CONFIG_SYNTH_DIV6 to value 0xe000_0000"]
impl crate::Resettable for ConfigSynthDiv6Spec {
