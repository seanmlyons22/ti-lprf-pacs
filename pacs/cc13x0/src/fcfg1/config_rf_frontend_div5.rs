...
pub type RFLDO_TRIM_OUTPUT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONFIG_RF_FRONTEND_DIV5_SPEC, u8, u8, 7, O>;
...
pub type CTL_PA0_TRIM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONFIG_RF_FRONTEND_DIV5_SPEC, u8, u8, 5, O>;
...
pub type LNA_IB_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONFIG_RF_FRONTEND_DIV5_SPEC, u8, u8, 4, O>;
