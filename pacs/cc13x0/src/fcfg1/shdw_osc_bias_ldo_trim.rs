...
Internal. Only to be used through TI provided API."]
pub type SET_RCOSC_HF_COARSE_RESISTOR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SET_RCOSC_HF_COARSE_RESISTOR` writer - 28:27\\]
Internal. Only to be used through TI provided API."]
pub type SET_RCOSC_HF_COARSE_RESISTOR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SHDW_OSC_BIAS_LDO_TRIM_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bits 0:7 - 7:0\\]
Internal. Only to be used through TI provided API."]
...
Internal. Only to be used through TI provided API."]
    ...
    pub fn set_rcosc_hf_coarse_resistor(&self) -> SET_RCOSC_HF_COARSE_RESISTOR_R {
        SET_RCOSC_HF_COARSE_RESISTOR_R::new(((self.bits >> 27) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:7 - 7:0\\]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn set_rcosc_hf_coarse_resistor(&mut self) -> SET_RCOSC_HF_COARSE_RESISTOR_W<27> {
        SET_RCOSC_HF_COARSE_RESISTOR_W::new(self)
    }
