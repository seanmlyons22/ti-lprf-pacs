...
Internal. Only to be used through TI provided API."]
pub type NanoampResTrimW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
Internal. Only to be used through TI provided API."]
    ...
    pub fn nanoamp_res_trim(&self) -> NanoampResTrimR {
        NanoampResTrimR::new(((self.bits >> 16) & 0x3f) as u8)
    }
    #[doc = "Bit 22 - 22:22\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
impl crate::Resettable for Ana2TrimSpec {
    const RESET_VALUE: u32 = 0x8240_f87f;
}
