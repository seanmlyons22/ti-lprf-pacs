...
Internal. Only to be used through TI provided API."]
pub type RESERVED1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ANA2_TRIM_SPEC, u8, u8, 4, O>;
...
pub type NANOAMP_RES_TRIM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ANA2_TRIM_SPEC, u8, u8, 6, O>;
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn nanoamp_res_trim(&mut self) -> NANOAMP_RES_TRIM_W<16> {
...
#[doc = "`reset()` method sets ANA2_TRIM to value 0x8240_f87f"]
impl crate::Resettable for ANA2_TRIM_SPEC {
    const RESET_VALUE: Self::Ux = 0x8240_f87f;
}
