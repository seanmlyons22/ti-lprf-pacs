...
pub type SOC_ADC_ABS_GAIN_TEMP1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `SOC_ADC_ABS_GAIN_TEMP1` writer - 15:0\\]
SOC_ADC gain in absolute reference mode at temperature 1 (30C). Calculated in production test.."]
pub type SOC_ADC_ABS_GAIN_TEMP1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SOC_ADC_ABS_GAIN_SPEC, u16, u16, 16, O>;
...
SOC_ADC gain in absolute reference mode at temperature 1 (30C). Calculated in production test.."]
    #[inline(always)]
    #[must_use]
    pub fn soc_adc_abs_gain_temp1(&mut self) -> SOC_ADC_ABS_GAIN_TEMP1_W<0> {
        SOC_ADC_ABS_GAIN_TEMP1_W::new(self)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
...
#[doc = "`reset()` method sets SOC_ADC_ABS_GAIN to value 0xffff_0000"]
