...
SOC_ADC gain in absolute reference mode at temperature 1 (30C). Calculated in production test.."]
pub type SocAdcAbsGainTemp1W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
...
SOC_ADC gain in absolute reference mode at temperature 1 (30C). Calculated in production test.."]
    #[inline(always)]
    #[must_use]
    pub fn soc_adc_abs_gain_temp1(&mut self) -> SocAdcAbsGainTemp1W<SocAdcAbsGainSpec> {
        SocAdcAbsGainTemp1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved16(&mut self) -> Reserved16W<SocAdcAbsGainSpec> {
