...
pub type R = crate::R<ConfigRfFrontendDiv6Spec>;
#[doc = "Register `CONFIG_RF_FRONTEND_DIV6` writer"]
pub type W = crate::W<ConfigRfFrontendDiv6Spec>;
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn rfldo_trim_output(&mut self) -> RfldoTrimOutputW<ConfigRfFrontendDiv6Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn ctl_pa0_trim(&mut self) -> CtlPa0TrimW<ConfigRfFrontendDiv6Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn ifamp_trim(&mut self) -> IfampTrimW<ConfigRfFrontendDiv6Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn lna_ib(&mut self) -> LnaIbW<ConfigRfFrontendDiv6Spec> {
        LnaIbW::new(self, 24)
    }
    #[doc = "Bits 28:31 - 31:28\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn ifamp_ib(&mut self) -> IfampIbW<ConfigRfFrontendDiv6Spec> {
        IfampIbW::new(self, 28)
    }
}
#[doc = "Internal. Only to be used through TI provided API.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`config_rf_frontend_div6::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`config_rf_frontend_div6::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ConfigRfFrontendDiv6Spec;
impl crate::RegisterSpec for ConfigRfFrontendDiv6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`config_rf_frontend_div6::R`](R) reader structure"]
impl crate::Readable for ConfigRfFrontendDiv6Spec {}
#[doc = "`write(|w| ..)` method takes [`config_rf_frontend_div6::W`](W) writer structure"]
impl crate::Writable for ConfigRfFrontendDiv6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CONFIG_RF_FRONTEND_DIV6 to value 0x7000_3f80"]
impl crate::Resettable for ConfigRfFrontendDiv6Spec {
