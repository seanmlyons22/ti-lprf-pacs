...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn sldo_trim_output(&mut self) -> SldoTrimOutputW<ConfigSynthDiv12Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn ldovco_trim_output(&mut self) -> LdovcoTrimOutputW<ConfigSynthDiv12Spec> {
...
Trim value for RF Core. Value is read by RF Core ROM FW during RF Core initialization."]
    #[inline(always)]
    #[must_use]
    pub fn rfc_mdm_demiqmc0(&mut self) -> RfcMdmDemiqmc0W<ConfigSynthDiv12Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn disable_corner_cap(&mut self) -> DisableCornerCapW<ConfigSynthDiv12Spec> {
...
#[doc = "`reset()` method sets CONFIG_SYNTH_DIV12 to value 0xe000_0000"]
