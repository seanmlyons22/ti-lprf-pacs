...
pub type HPOSC_COMP_P2_R = crate::FieldReader<u8, u8>;
#[doc = "Field `HPOSC_COMP_P2` writer - 7:0\\]
Internal. Only to be used through TI provided API."]
pub type HPOSC_COMP_P2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FREQ_OFFSET_SPEC, u8, u8, 8, O>;
#[doc = "Field `HPOSC_COMP_P1` reader - 15:8\\]
Internal. Only to be used through TI provided API."]
pub type HPOSC_COMP_P1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `HPOSC_COMP_P1` writer - 15:8\\]
Internal. Only to be used through TI provided API."]
pub type HPOSC_COMP_P1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FREQ_OFFSET_SPEC, u8, u8, 8, O>;
#[doc = "Field `HPOSC_COMP_P0` reader - 31:16\\]
Internal. Only to be used through TI provided API."]
pub type HPOSC_COMP_P0_R = crate::FieldReader<u16, u16>;
#[doc = "Field `HPOSC_COMP_P0` writer - 31:16\\]
Internal. Only to be used through TI provided API."]
pub type HPOSC_COMP_P0_W<'a, const O: u8> =
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn hposc_comp_p2(&mut self) -> HPOSC_COMP_P2_W<0> {
        HPOSC_COMP_P2_W::new(self)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn hposc_comp_p1(&mut self) -> HPOSC_COMP_P1_W<8> {
        HPOSC_COMP_P1_W::new(self)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn hposc_comp_p0(&mut self) -> HPOSC_COMP_P0_W<16> {
        HPOSC_COMP_P0_W::new(self)
    }
