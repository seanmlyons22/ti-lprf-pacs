...
pub type DACTRIM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONFIG_MISC_ADC_DIV10_SPEC, u8, u8, 6, O>;
...
pub type QUANTCTLTHRES_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONFIG_MISC_ADC_DIV10_SPEC, u8, u8, 3, O>;
...
pub type RSSI_OFFSET_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONFIG_MISC_ADC_DIV10_SPEC, u8, u8, 8, O>;
...
pub type MIN_ALLOWED_RTRIM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONFIG_MISC_ADC_DIV10_SPEC, u8, u8, 4, O>;
...
pub type RESERVED1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONFIG_MISC_ADC_DIV10_SPEC, u16, u16, 10, O>;
impl R {
    #[doc = "Bits 0:5 - 5:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
