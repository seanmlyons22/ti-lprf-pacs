...
Version number of the DMA Controller (209)"]
pub type VER_NUM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMAHWVER_SPEC, u8, u8, 8, O>;
...
Bit-by-bit complement of the VER_NUM field bits."]
pub type VER_NUM_COMPL_W<'a, const O: u8> =
...
Patch level."]
pub type HW_PATCH_LVL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMAHWVER_SPEC, u8, u8, 4, O>;
...
Minor version number"]
pub type HW_MINOR_VER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMAHWVER_SPEC, u8, u8, 4, O>;
...
Major version number"]
pub type HW_MAJOR_VER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMAHWVER_SPEC, u8, u8, 4, O>;
