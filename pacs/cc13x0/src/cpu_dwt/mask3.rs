...
pub type R = crate::R<Mask3Spec>;
#[doc = "Register `MASK3` writer"]
pub type W = crate::W<Mask3Spec>;
...
Mask on data address when matching against COMP3. This is the size of the ignore mask. That is, DWT matching is performed as:(ADDR ANDed with (0xFFFF left bit-shifted by MASK)) == COMP3. However, the actual comparison is slightly more complex to enable matching an address wherever it appears on a bus. So, if COMP3 is 3, this matches a word access of 0, because 3 would be within the word."]
    #[inline(always)]
    #[must_use]
    pub fn mask(&mut self) -> MaskW<Mask3Spec> {
        MaskW::new(self, 0)
    }
    #[doc = "Bits 4:31 - 31:4\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved4(&mut self) -> Reserved4W<Mask3Spec> {
        Reserved4W::new(self, 4)
    }
}
#[doc = "Mask 3 Use the DWT Mask Registers 3 to apply a mask to data addresses when matching against COMP3.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mask3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mask3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Mask3Spec;
impl crate::RegisterSpec for Mask3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mask3::R`](R) reader structure"]
impl crate::Readable for Mask3Spec {}
#[doc = "`write(|w| ..)` method takes [`mask3::W`](W) writer structure"]
impl crate::Writable for Mask3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MASK3 to value 0"]
impl crate::Resettable for Mask3Spec {
