...
pub struct W(crate::W<RESERVED0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RESERVED0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RESERVED0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RESERVED0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RESERVED0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RESERVED0_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - 31:0\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
...
impl crate::Writable for RESERVED0_SPEC {
    type Writer = W;
