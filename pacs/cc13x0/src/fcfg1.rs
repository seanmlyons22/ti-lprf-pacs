...
#[doc = "Internal. Only to be used through TI provided API."]
pub mod ldo_trim;
#[doc = "BAT_RC_LDO_TRIM (rw) register accessor: an alias for `Reg<BAT_RC_LDO_TRIM_SPEC>`"]
pub type BAT_RC_LDO_TRIM = crate::Reg<bat_rc_ldo_trim::BAT_RC_LDO_TRIM_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
...
#[doc = "TRIM_CAL_REVISION (rw) register accessor: an alias for `Reg<TRIM_CAL_REVISION_SPEC>`"]
pub type TRIM_CAL_REVISION = crate::Reg<trim_cal_revision::TRIM_CAL_REVISION_SPEC>;
#[doc = "Internal. Only to be used through TI provided API."]
