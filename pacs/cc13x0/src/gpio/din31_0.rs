...
Data input from DIO 26"]
    #[inline(always)]
    #[must_use]
    pub fn dio26(&mut self) -> Dio26W<Din31_0Spec> {
        Dio26W::new(self, 26)
    }
    #[doc = "Bit 27 - 27:27\\]
Data input from DIO 27"]
    #[inline(always)]
    #[must_use]
    pub fn dio27(&mut self) -> Dio27W<Din31_0Spec> {
        Dio27W::new(self, 27)
    }
    #[doc = "Bit 28 - 28:28\\]
Data input from DIO 28"]
    #[inline(always)]
    #[must_use]
    pub fn dio28(&mut self) -> Dio28W<Din31_0Spec> {
        Dio28W::new(self, 28)
    }
    #[doc = "Bit 29 - 29:29\\]
Data input from DIO 29"]
    #[inline(always)]
    #[must_use]
    pub fn dio29(&mut self) -> Dio29W<Din31_0Spec> {
        Dio29W::new(self, 29)
    }
    #[doc = "Bit 30 - 30:30\\]
Data input from DIO 30"]
    #[inline(always)]
    #[must_use]
    pub fn dio30(&mut self) -> Dio30W<Din31_0Spec> {
        Dio30W::new(self, 30)
    }
    #[doc = "Bit 31 - 31:31\\]
Data input from DIO 31"]
    #[inline(always)]
    #[must_use]
    pub fn dio31(&mut self) -> Dio31W<Din31_0Spec> {
        Dio31W::new(self, 31)
    }
}
