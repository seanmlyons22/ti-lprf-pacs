...
/// [TRM](https://www.ti.com/lit/ug/swcu117/swcu117.pdf)
///
/// # Initialization
///
    ...
    pub const fn new() -> Self {
        Self {
            ...
            mode_conf: mode_conf(
                ...
                true,
                0xFF,
                CCFG_DEFAULT_MODE_CONF_VDDR_CAP,
            ),
...
pub const CCFG_DEFAULT_MODE_CONF_1_ALT_DCDC_DITHER_EN: bool = true;
...
pub const CCFG_DEFAULT_MODE_CONF_VDDR_CAP: u8 = 0x3A;
pub const CCFG_DEFAULT_MODE_CONF_SCLK_LF: CCFG_MODE_CONF_SCLK_LF = CCFG_MODE_CONF_SCLK_LF::LF_XTAL;
pub const CCFG_DEFAULT_MODE_CONF_XOSC_HF: CCFG_MODE_CONF_XOSC_HF = CCFG_MODE_CONF_XOSC_HF::XTAL_24; // HF source is a 24 MHz xtal
...
pub const CCFG_DEFAULT_TAP_DAP_0_PWRPROF: CCFG_TAP_DAP_ENABLE = CCFG_TAP_DAP_ENABLE::DISABLED; // Access disabled
pub const CCFG_DEFAULT_TAP_DAP_0_TEST_TAP: CCFG_TAP_DAP_ENABLE = CCFG_TAP_DAP_ENABLE::ENABLED; // Access disabled
...
///
/// # Arguments
/// * `disable_linear_cap_array_delta` - Boolean, defining if the linear cap array delta is disabled
///   The default CAPARRAY setting is good as long as no CAPARRAY_DELTA adjustment is added but the CAPARRAY setting
///   will give an un-linear behavior if the workaround is not enabled. The workaround is disabled by default to avoid unexpected changes
///   upon software updates.
...
/// * `vddr_cap` -  Unsigned 8-bit integer representing the min. decoupling capacitance on VDDR in units of 100nF
