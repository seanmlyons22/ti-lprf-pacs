...
pub struct R(crate::R<TEMPUL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TEMPUL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TEMPUL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TEMPUL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TEMPUL` writer"]
pub struct W(crate::W<TEMPUL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TEMPUL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TEMPUL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TEMPUL_SPEC>) -> Self {
        W(writer)
    }
}
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TEMPUL_SPEC, u8, u8, 6, O>;
...
Fractional part of temperature upper limit. Total value = INTEGER + FRACTIONAL The encoding is an extension of the 2's complement encoding. 00: 0.0C 01: 0.25C 10: 0.5C 11: 0.75C For example: 000000001,00 = ( 1+0,00) = 1,00 000000000,11 = ( 0+0,75) = 0,75 000000000,10 = ( 0+0,50) = 0,50 000000000,01 = ( 0+0,25) = 0,25 000000000,00 = ( 0+0,00) = 0,00 111111111,11 = (-1+0,75) = -0,25 111111111,10 = (-1+0,50) = -0,50 111111111,01 = (-1+0,25) = -0,75 111111111,00 = (-1+0,00) = -1,00 111111110,11 = (-2+0,75) = -1,25"]
pub type FRAC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TEMPUL_SPEC, u8, u8, 2, O>;
...
Integer part (signed) of temperature upper limit. Total value = INTEGER + FRACTIONAL 2's complement encoding 0x100: Min value 0x1D8: -40C 0x1FF: -1C 0x00: 0C 0x1B: 27C 0x55: 85C 0xFF: Max value"]
pub type INT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TEMPUL_SPEC, u16, u16, 9, O>;
#[doc = "Field `RESERVED17` reader - 31:17\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED17_R = crate::FieldReader<u16, u16>;
#[doc = "Field `RESERVED17` writer - 31:17\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED17_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TEMPUL_SPEC, u16, u16, 15, O>;
impl R {
    #[doc = "Bits 0:5 - 5:0\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
...
#[doc = "Temperature Upper Limit\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tempul](index.html) module"]
pub struct TEMPUL_SPEC;
impl crate::RegisterSpec for TEMPUL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tempul::R](R) reader structure"]
impl crate::Readable for TEMPUL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tempul::W](W) writer structure"]
impl crate::Writable for TEMPUL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TEMPUL to value 0xffc0"]
impl crate::Resettable for TEMPUL_SPEC {
    const RESET_VALUE: Self::Ux = 0xffc0;
}
