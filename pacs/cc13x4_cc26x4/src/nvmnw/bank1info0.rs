...
pub struct R(crate::R<BANK1INFO0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BANK1INFO0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BANK1INFO0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BANK1INFO0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BANK1INFO0` writer"]
pub struct W(crate::W<BANK1INFO0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BANK1INFO0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BANK1INFO0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BANK1INFO0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MAINSIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, BANK1INFO0_SPEC, u16, MAINSIZE_A, 12, O>;
...
pub type RESERVED12_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, BANK1INFO0_SPEC, u32, u32, 20, O>;
impl R {
    #[doc = "Bits 0:11 - 11:0\\]
Main region size in sectors Minimum:0x8 (8) Maximum:0x200 (512)"]
    #[inline(always)]
