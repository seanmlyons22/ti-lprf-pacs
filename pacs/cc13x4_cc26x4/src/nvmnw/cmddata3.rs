...
pub struct R(crate::R<CMDDATA3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CMDDATA3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CMDDATA3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CMDDATA3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CMDDATA3` writer"]
pub struct W(crate::W<CMDDATA3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMDDATA3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CMDDATA3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMDDATA3_SPEC>) -> Self {
        W(writer)
    }
}
...
A 32-bit data value is placed in this field."]
pub type VAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMDDATA3_SPEC, u32, VAL_A, 32, O>;
