...
pub struct R(crate::R<BANK1INFO1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BANK1INFO1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BANK1INFO1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BANK1INFO1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BANK1INFO1` writer"]
pub struct W(crate::W<BANK1INFO1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BANK1INFO1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BANK1INFO1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BANK1INFO1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NONMAINSIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, BANK1INFO1_SPEC, u8, NONMAINSIZE_A, 8, O>;
...
pub type TRIMSIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, BANK1INFO1_SPEC, u8, TRIMSIZE_A, 8, O>;
...
pub type ENGRSIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, BANK1INFO1_SPEC, u8, ENGRSIZE_A, 8, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED24_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BANK1INFO1_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - 7:0\\]
Non-main region size in sectors"]
    #[inline(always)]
