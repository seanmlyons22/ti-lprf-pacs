...
Non-main region size in sectors"]
    #[inline(always)]
    #[must_use]
    pub fn nonmainsize(&mut self) -> NonmainsizeW<Bank1info1Spec> {
...
Trim region size in sectors"]
    #[inline(always)]
    #[must_use]
    pub fn trimsize(&mut self) -> TrimsizeW<Bank1info1Spec> {
...
Engr region size in sectors Minimum:0x0 (0) Maximum:0x10 (16)"]
    #[inline(always)]
    #[must_use]
    pub fn engrsize(&mut self) -> EngrsizeW<Bank1info1Spec> {
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved24(&mut self) -> Reserved24W<Bank1info1Spec> {
