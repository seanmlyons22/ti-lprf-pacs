...
pub struct R(crate::R<CMDWEPROTTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CMDWEPROTTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CMDWEPROTTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CMDWEPROTTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CMDWEPROTTR` writer"]
pub struct W(crate::W<CMDWEPROTTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMDWEPROTTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CMDWEPROTTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMDWEPROTTR_SPEC>) -> Self {
        W(writer)
    }
}
...
Each bit protects 1 sector. bit \\[0\\]:When 1, sector 0 of the engr region will be protected from program and erase. bit \\[1\\]:When 1, sector 1 of the engr region will be protected from program and erase. : : bit \\[31\\]:When 1, sector 31 of the engr region will be protected from program and erase."]
pub type VAL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMDWEPROTTR_SPEC, VAL_A, O>;
...
pub type RESERVED1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CMDWEPROTTR_SPEC, u32, u32, 31, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Each bit protects 1 sector. bit \\[0\\]:When 1, sector 0 of the engr region will be protected from program and erase. bit \\[1\\]:When 1, sector 1 of the engr region will be protected from program and erase. : : bit \\[31\\]:When 1, sector 31 of the engr region will be protected from program and erase."]
    #[inline(always)]
