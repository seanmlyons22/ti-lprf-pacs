#[doc = "Register `DFTDATARED1` reader"]
pub struct R(crate::R<DFTDATARED1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFTDATARED1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DFTDATARED1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DFTDATARED1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DFTDATARED1` writer"]
pub struct W(crate::W<DFTDATARED1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DFTDATARED1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DFTDATARED1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DFTDATARED1_SPEC>) -> Self {
        W(writer)
    }
}
...
Data for redundant bits"]
pub type VAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFTDATARED1_SPEC, u8, u8, 4, O>;
...
pub type RESERVED4_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DFTDATARED1_SPEC, u32, u32, 28, O>;
impl R {
    #[doc = "Bits 0:3 - 3:0\\]
Data for redundant bits"]
    #[inline(always)]
