...
pub type R = crate::R<Cmddata0Spec>;
#[doc = "Register `CMDDATA0` writer"]
pub type W = crate::W<Cmddata0Spec>;
#[doc = "31:0\\]
...
A 32-bit data value is placed in this field."]
    #[inline(always)]
    #[must_use]
    pub fn val(&mut self) -> ValW<Cmddata0Spec> {
        ValW::new(self, 0)
    }
}
