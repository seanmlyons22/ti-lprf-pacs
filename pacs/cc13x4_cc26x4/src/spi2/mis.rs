...
Masked RXFIFO overflow event. This interrupt is set if an RX FIFO overflow has been detected."]
pub type RXFIFO_OVF_W<'a, const O: u8> = crate::BitWriter<'a, u32, MIS_SPEC, RXFIFO_OVF_A, O>;
...
Masked Parity error event: this bit if a parity error has been detected"]
pub type PER_W<'a, const O: u8> = crate::BitWriter<'a, u32, MIS_SPEC, PER_A, O>;
...
Masked SPI Receive Time-Out Interrupt."]
pub type RTOUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, MIS_SPEC, RTOUT_A, O>;
...
Masked receive FIFO event. This interrupt is set if the selected Receive FIFO level has been reached"]
pub type RX_W<'a, const O: u8> = crate::BitWriter<'a, u32, MIS_SPEC, RX_A, O>;
...
Masked Transmit FIFO event. This interrupt is set if the selected Transmit FIFO level has been reached."]
pub type TX_W<'a, const O: u8> = crate::BitWriter<'a, u32, MIS_SPEC, TX_A, O>;
...
Masked Transmit FIFO Empty event."]
pub type TXEMPTY_W<'a, const O: u8> = crate::BitWriter<'a, u32, MIS_SPEC, TXEMPTY_A, O>;
...
Masked SPI IDLE mode event."]
pub type IDLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MIS_SPEC, IDLE_A, O>;
...
Masked DMA Done event for RX."]
pub type DMA_DONE_RX_W<'a, const O: u8> = crate::BitWriter<'a, u32, MIS_SPEC, DMA_DONE_RX_A, O>;
...
Masked DMA Done event for TX."]
pub type DMA_DONE_TX_W<'a, const O: u8> = crate::BitWriter<'a, u32, MIS_SPEC, DMA_DONE_TX_A, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED9_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MIS_SPEC, u32, u32, 23, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Masked RXFIFO overflow event. This interrupt is set if an RX FIFO overflow has been detected."]
    #[inline(always)]
