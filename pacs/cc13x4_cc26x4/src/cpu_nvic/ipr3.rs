...
pub struct W(crate::W<IPR3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IPR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IPR3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IPR3_SPEC>) -> Self {
        W(writer)
    }
}
...
For register NVIC_IPR*3, the priority of interrupt number 4*3+0, or is RES0 if the PE does not implement this interrupt"]
pub type PRI_N0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IPR3_SPEC, u8, u8, 8, O>;
...
For register NVIC_IPR*3, the priority of interrupt number 4*3+1, or is RES0 if the PE does not implement this interrupt"]
pub type PRI_N1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IPR3_SPEC, u8, u8, 8, O>;
...
For register NVIC_IPR*3, the priority of interrupt number 4*3+2, or is RES0 if the PE does not implement this interrupt"]
pub type PRI_N2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IPR3_SPEC, u8, u8, 8, O>;
...
For register NVIC_IPR*3, the priority of interrupt number 4*3+3, or is RES0 if the PE does not implement this interrupt"]
pub type PRI_N3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IPR3_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - 7:0\\]
For register NVIC_IPR*3, the priority of interrupt number 4*3+0, or is RES0 if the PE does not implement this interrupt"]
    #[inline(always)]
...
impl crate::Writable for IPR3_SPEC {
    type Writer = W;
