...
pub type R = crate::R<Ipr11Spec>;
#[doc = "Register `IPR11` writer"]
pub type W = crate::W<Ipr11Spec>;
...
For register NVIC_IPR*11, the priority of interrupt number 4*11+0, or is RES0 if the PE does not implement this interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn pri_n0(&mut self) -> PriN0W<Ipr11Spec> {
        PriN0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - 15:8\\]
For register NVIC_IPR*11, the priority of interrupt number 4*11+1, or is RES0 if the PE does not implement this interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn pri_n1(&mut self) -> PriN1W<Ipr11Spec> {
        PriN1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - 23:16\\]
For register NVIC_IPR*11, the priority of interrupt number 4*11+2, or is RES0 if the PE does not implement this interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn pri_n2(&mut self) -> PriN2W<Ipr11Spec> {
        PriN2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - 31:24\\]
For register NVIC_IPR*11, the priority of interrupt number 4*11+3, or is RES0 if the PE does not implement this interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn pri_n3(&mut self) -> PriN3W<Ipr11Spec> {
        PriN3W::new(self, 24)
    }
}
#[doc = "Sets or reads interrupt priorities\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ipr11::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ipr11::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ipr11Spec;
impl crate::RegisterSpec for Ipr11Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ipr11::R`](R) reader structure"]
impl crate::Readable for Ipr11Spec {}
#[doc = "`write(|w| ..)` method takes [`ipr11::W`](W) writer structure"]
impl crate::Writable for Ipr11Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets IPR11 to value 0"]
impl crate::Resettable for Ipr11Spec {
