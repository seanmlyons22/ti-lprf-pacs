...
#[doc = "Register `IPR2` writer"]
pub struct W(crate::W<IPR2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IPR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IPR2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IPR2_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PRI_N0` reader - 7:0\\]
For register NVIC_IPR*2, the priority of interrupt number 4*2+0, or is RES0 if the PE does not implement this interrupt"]
pub type PRI_N0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PRI_N0` writer - 7:0\\]
For register NVIC_IPR*2, the priority of interrupt number 4*2+0, or is RES0 if the PE does not implement this interrupt"]
pub type PRI_N0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IPR2_SPEC, u8, u8, 8, O>;
#[doc = "Field `PRI_N1` reader - 15:8\\]
For register NVIC_IPR*2, the priority of interrupt number 4*2+1, or is RES0 if the PE does not implement this interrupt"]
pub type PRI_N1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PRI_N1` writer - 15:8\\]
For register NVIC_IPR*2, the priority of interrupt number 4*2+1, or is RES0 if the PE does not implement this interrupt"]
pub type PRI_N1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IPR2_SPEC, u8, u8, 8, O>;
#[doc = "Field `PRI_N2` reader - 23:16\\]
For register NVIC_IPR*2, the priority of interrupt number 4*2+2, or is RES0 if the PE does not implement this interrupt"]
pub type PRI_N2_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PRI_N2` writer - 23:16\\]
For register NVIC_IPR*2, the priority of interrupt number 4*2+2, or is RES0 if the PE does not implement this interrupt"]
pub type PRI_N2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IPR2_SPEC, u8, u8, 8, O>;
#[doc = "Field `PRI_N3` reader - 31:24\\]
For register NVIC_IPR*2, the priority of interrupt number 4*2+3, or is RES0 if the PE does not implement this interrupt"]
pub type PRI_N3_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PRI_N3` writer - 31:24\\]
For register NVIC_IPR*2, the priority of interrupt number 4*2+3, or is RES0 if the PE does not implement this interrupt"]
pub type PRI_N3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IPR2_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - 7:0\\]
For register NVIC_IPR*2, the priority of interrupt number 4*2+0, or is RES0 if the PE does not implement this interrupt"]
    #[inline(always)]
...
#[doc = "`write(|w| ..)` method takes [ipr2::W](W) writer structure"]
impl crate::Writable for IPR2_SPEC {
    type Writer = W;
