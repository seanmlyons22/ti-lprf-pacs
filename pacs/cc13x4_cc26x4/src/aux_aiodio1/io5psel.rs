#[doc = "Register `IO5PSEL` reader"]
pub struct R(crate::R<IO5PSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IO5PSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IO5PSEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IO5PSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IO5PSEL` writer"]
pub struct W(crate::W<IO5PSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IO5PSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IO5PSEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IO5PSEL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SRC` reader - 2:0\\]
Select a peripheral signal that connects to AUXIO\\[8i+5\\]
when IOPOE bit 5 is set."]
...
Select a peripheral signal that connects to AUXIO\\[8i+5\\]
when IOPOE bit 5 is set."]
pub type SRC_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, IO5PSEL_SPEC, u8, SRC_A, 3, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IO5PSEL_SPEC, u32, u32, 29, O>;
impl R {
    #[doc = "Bits 0:2 - 2:0\\]
Select a peripheral signal that connects to AUXIO\\[8i+5\\]
when IOPOE bit 5 is set."]
...
you must configure this register while IOPOE bit 5 is 0. In the formulas i = 0 for AUX_AIODIO0, i = 1 for AUX_AIODIO1, and so forth.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [io5psel](index.html) module"]
pub struct IO5PSEL_SPEC;
impl crate::RegisterSpec for IO5PSEL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [io5psel::R](R) reader structure"]
impl crate::Readable for IO5PSEL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [io5psel::W](W) writer structure"]
impl crate::Writable for IO5PSEL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IO5PSEL to value 0"]
impl crate::Resettable for IO5PSEL_SPEC {
