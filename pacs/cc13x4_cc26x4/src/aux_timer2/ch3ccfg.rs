...
pub struct R(crate::R<CH3CCFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH3CCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH3CCFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH3CCFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH3CCFG` writer"]
pub struct W(crate::W<CH3CCFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH3CCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH3CCFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH3CCFG_SPEC>) -> Self {
        W(writer)
    }
}
...
Edge configuration. Channel captures counter value at selected edge on signal source selected by CAPT_SRC. See CH3EVCFG.CCACT."]
pub type EDGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH3CCFG_SPEC, EDGE_A, O>;
...
pub type CAPT_SRC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH3CCFG_SPEC, u8, CAPT_SRC_A, 6, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED7_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH3CCFG_SPEC, u32, u32, 25, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Edge configuration. Channel captures counter value at selected edge on signal source selected by CAPT_SRC. See CH3EVCFG.CCACT."]
    #[inline(always)]
