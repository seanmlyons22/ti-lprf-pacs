...
pub type R = crate::R<Bank0TrimCfg1Spec>;
#[doc = "Register `BANK0_TRIM_CFG_1` writer"]
pub type W = crate::W<Bank0TrimCfg1Spec>;
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn redswenw0(&mut self) -> Redswenw0W<Bank0TrimCfg1Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn redswenw1(&mut self) -> Redswenw1W<Bank0TrimCfg1Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn redswenw2(&mut self) -> Redswenw2W<Bank0TrimCfg1Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn redswenw3(&mut self) -> Redswenw3W<Bank0TrimCfg1Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn redswselw0(&mut self) -> Redswselw0W<Bank0TrimCfg1Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn redswselw1(&mut self) -> Redswselw1W<Bank0TrimCfg1Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn redswselw2(&mut self) -> Redswselw2W<Bank0TrimCfg1Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn redswselw3(&mut self) -> Redswselw3W<Bank0TrimCfg1Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn reserved6(&mut self) -> Reserved6W<Bank0TrimCfg1Spec> {
        Reserved6W::new(self, 28)
    }
}
#[doc = "Internal. Only to be used through TI provided API.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bank0_trim_cfg_1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bank0_trim_cfg_1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Bank0TrimCfg1Spec;
impl crate::RegisterSpec for Bank0TrimCfg1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bank0_trim_cfg_1::R`](R) reader structure"]
impl crate::Readable for Bank0TrimCfg1Spec {}
#[doc = "`write(|w| ..)` method takes [`bank0_trim_cfg_1::W`](W) writer structure"]
impl crate::Writable for Bank0TrimCfg1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BANK0_TRIM_CFG_1 to value 0"]
impl crate::Resettable for Bank0TrimCfg1Spec {
