...
pub type R = crate::R<Veccfg5Spec>;
#[doc = "Register `VECCFG5` writer"]
pub type W = crate::W<Veccfg5Spec>;
#[doc = "3:0\\]
...
Select trigger event for vector 5. Non-enumerated values are treated as NONE."]
    #[inline(always)]
    #[must_use]
    pub fn vec_ev(&mut self) -> VecEvW<Veccfg5Spec> {
        VecEvW::new(self, 0)
    }
    #[doc = "Bits 4:31 - 31:4\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved4(&mut self) -> Reserved4W<Veccfg5Spec> {
        Reserved4W::new(self, 4)
    }
}
#[doc = "Vector Configuration 5 AUX_SCE wakeup vector 5 configuration\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`veccfg5::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`veccfg5::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Veccfg5Spec;
impl crate::RegisterSpec for Veccfg5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`veccfg5::R`](R) reader structure"]
impl crate::Readable for Veccfg5Spec {}
#[doc = "`write(|w| ..)` method takes [`veccfg5::W`](W) writer structure"]
impl crate::Writable for Veccfg5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VECCFG5 to value 0"]
impl crate::Resettable for Veccfg5Spec {
