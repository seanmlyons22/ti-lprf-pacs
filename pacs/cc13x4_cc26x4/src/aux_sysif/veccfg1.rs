...
Select trigger event for vector 1. Non-enumerated values are treated as NONE."]
...
Select trigger event for vector 1. Non-enumerated values are treated as NONE."]
pub type VEC_EV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, VECCFG1_SPEC, u8, VEC_EV_A, 4, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, VECCFG1_SPEC, u32, u32, 28, O>;
impl R {
    #[doc = "Bits 0:3 - 3:0\\]
Select trigger event for vector 1. Non-enumerated values are treated as NONE."]
    #[inline(always)]
