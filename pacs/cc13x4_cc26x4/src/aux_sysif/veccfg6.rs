...
pub type R = crate::R<Veccfg6Spec>;
#[doc = "Register `VECCFG6` writer"]
pub type W = crate::W<Veccfg6Spec>;
#[doc = "3:0\\]
...
Select trigger event for vector 6. Non-enumerated values are treated as NONE."]
    #[inline(always)]
    #[must_use]
    pub fn vec_ev(&mut self) -> VecEvW<Veccfg6Spec> {
        VecEvW::new(self, 0)
    }
    #[doc = "Bits 4:31 - 31:4\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
