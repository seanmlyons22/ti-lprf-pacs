...
Inductor peak current if alternate DC/DC setting is enabled (SIZE_AND_DIS_FLAGS.DIS_ALT_DCDC_SETTING=0). Assuming 10uH external inductor! 0: Min 46mA ... 4: Typical 70mA ... 7: Max 87mA"]
...
pub type TCXO_MAX_START_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TCXO_MAX_START` writer - 30:24\\]
Maximum TCXO startup time in units of 100us. Bit field value is only valid if MODE_CONF.XOSC_FREQ=0."]
pub type TCXO_MAX_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MODE_CONF_1_SPEC, u8, u8, 7, O>;
...
pub type TCXO_TYPE_R = crate::BitReader<bool>;
#[doc = "Field `TCXO_TYPE` writer - 31:31\\]
Selects the TCXO type. 0: CMOS type. Internal common-mode bias will not be enabled. 1: Clipped-sine type. Internal common-mode bias will be enabled when TCXO is used. Bit field value is only valid if MODE_CONF.XOSC_FREQ=0."]
pub type TCXO_TYPE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MODE_CONF_1_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:7 - 7:0\\]
Unsigned value of maximum XOSC startup time (worst case) in units of 100us. Value only applies if SIZE_AND_DIS_FLAGS.DIS_XOSC_OVR=0."]
    #[inline(always)]
...
Maximum TCXO startup time in units of 100us. Bit field value is only valid if MODE_CONF.XOSC_FREQ=0."]
    #[inline(always)]
    pub fn tcxo_max_start(&self) -> TCXO_MAX_START_R {
        TCXO_MAX_START_R::new(((self.bits >> 24) & 0x7f) as u8)
    }
    #[doc = "Bit 31 - 31:31\\]
Selects the TCXO type. 0: CMOS type. Internal common-mode bias will not be enabled. 1: Clipped-sine type. Internal common-mode bias will be enabled when TCXO is used. Bit field value is only valid if MODE_CONF.XOSC_FREQ=0."]
    #[inline(always)]
    pub fn tcxo_type(&self) -> TCXO_TYPE_R {
        TCXO_TYPE_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:7 - 7:0\\]
...
Maximum TCXO startup time in units of 100us. Bit field value is only valid if MODE_CONF.XOSC_FREQ=0."]
    #[inline(always)]
    #[must_use]
    pub fn tcxo_max_start(&mut self) -> TCXO_MAX_START_W<24> {
        TCXO_MAX_START_W::new(self)
    }
    #[doc = "Bit 31 - 31:31\\]
Selects the TCXO type. 0: CMOS type. Internal common-mode bias will not be enabled. 1: Clipped-sine type. Internal common-mode bias will be enabled when TCXO is used. Bit field value is only valid if MODE_CONF.XOSC_FREQ=0."]
    #[inline(always)]
    #[must_use]
    pub fn tcxo_type(&mut self) -> TCXO_TYPE_W<31> {
        TCXO_TYPE_W::new(self)
    }
