...
pub struct R(crate::R<SRAMNSADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SRAMNSADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SRAMNSADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SRAMNSADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SRAMNSADDR` writer"]
pub struct W(crate::W<SRAMNSADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SRAMNSADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SRAMNSADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SRAMNSADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RESERVED0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SRAMNSADDR_SPEC, u16, u16, 10, O>;
...
Non-Secure boundary address. Writing this field when BUSSECCFG.VALID is set may result in undefined behavior."]
pub type BOUNDARY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SRAMNSADDR_SPEC, u16, u16, 9, O>;
...
pub type RESERVED19_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SRAMNSADDR_SPEC, u16, u16, 12, O>;
#[doc = "Field `PARITY` reader - 31:31\\]
Register parity bit"]
pub type PARITY_R = crate::BitReader<bool>;
#[doc = "Field `PARITY` writer - 31:31\\]
Register parity bit"]
pub type PARITY_W<'a, const O: u8> = crate::BitWriter<'a, u32, SRAMNSADDR_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:9 - 9:0\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
...
#[doc = "SRAM Non-Secure Callable boundary Address\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sramnsaddr](index.html) module"]
pub struct SRAMNSADDR_SPEC;
impl crate::RegisterSpec for SRAMNSADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sramnsaddr::R](R) reader structure"]
impl crate::Readable for SRAMNSADDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sramnsaddr::W](W) writer structure"]
impl crate::Writable for SRAMNSADDR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SRAMNSADDR to value 0x0004_8000"]
impl crate::Resettable for SRAMNSADDR_SPEC {
    const RESET_VALUE: Self::Ux = 0x0004_8000;
}
