...
pub type R = crate::R<PerbuscpuclkdivSpec>;
#[doc = "Register `PERBUSCPUCLKDIV` writer"]
pub type W = crate::W<PerbuscpuclkdivSpec>;
#[doc = "3:0\\]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn ratio(&mut self) -> RatioW<PerbuscpuclkdivSpec> {
        RatioW::new(self, 0)
    }
    #[doc = "Bits 4:31 - 31:4\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn reserved4(&mut self) -> Reserved4W<PerbuscpuclkdivSpec> {
        Reserved4W::new(self, 4)
    }
}
#[doc = "Internal. Only to be used through TI provided API.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`perbuscpuclkdiv::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`perbuscpuclkdiv::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PerbuscpuclkdivSpec;
impl crate::RegisterSpec for PerbuscpuclkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`perbuscpuclkdiv::R`](R) reader structure"]
impl crate::Readable for PerbuscpuclkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`perbuscpuclkdiv::W`](W) writer structure"]
impl crate::Writable for PerbuscpuclkdivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PERBUSCPUCLKDIV to value 0"]
impl crate::Resettable for PerbuscpuclkdivSpec {
