...
pub type R = crate::R<SpiclkgsSpec>;
#[doc = "Register `SPICLKGS` writer"]
pub type W = crate::W<SpiclkgsSpec>;
#[doc = "3:0\\]
...
0: Disable clock 1: Enable clock Can be forced on by SPICLKGR.AM_CLK_EN For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    #[inline(always)]
    #[must_use]
    pub fn clk_en(&mut self) -> ClkEnW<SpiclkgsSpec> {
        ClkEnW::new(self, 0)
    }
    #[doc = "Bits 4:31 - 31:4\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved4(&mut self) -> Reserved4W<SpiclkgsSpec> {
        Reserved4W::new(self, 4)
    }
}
#[doc = "SPI Clock Gate For Sleep Mode\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`spiclkgs::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`spiclkgs::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SpiclkgsSpec;
impl crate::RegisterSpec for SpiclkgsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spiclkgs::R`](R) reader structure"]
impl crate::Readable for SpiclkgsSpec {}
#[doc = "`write(|w| ..)` method takes [`spiclkgs::W`](W) writer structure"]
impl crate::Writable for SpiclkgsSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SPICLKGS to value 0"]
impl crate::Resettable for SpiclkgsSpec {
