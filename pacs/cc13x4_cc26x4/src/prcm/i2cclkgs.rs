...
pub struct R(crate::R<I2CCLKGS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<I2CCLKGS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<I2CCLKGS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<I2CCLKGS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `I2CCLKGS` writer"]
pub struct W(crate::W<I2CCLKGS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<I2CCLKGS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<I2CCLKGS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<I2CCLKGS_SPEC>) -> Self {
        W(writer)
    }
}
...
0: Disable clock 1: Enable clock Can be forced on by I2CCLKGR.AM_CLK_EN For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
pub type CLK_EN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, I2CCLKGS_SPEC, u8, CLK_EN_A, 2, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, I2CCLKGS_SPEC, u32, u32, 30, O>;
impl R {
    #[doc = "Bits 0:1 - 1:0\\]
0: Disable clock 1: Enable clock Can be forced on by I2CCLKGR.AM_CLK_EN For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    #[inline(always)]
...
#[doc = "I2C Clock Gate For Sleep Mode\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i2cclkgs](index.html) module"]
pub struct I2CCLKGS_SPEC;
impl crate::RegisterSpec for I2CCLKGS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [i2cclkgs::R](R) reader structure"]
impl crate::Readable for I2CCLKGS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [i2cclkgs::W](W) writer structure"]
impl crate::Writable for I2CCLKGS_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets I2CCLKGS to value 0"]
impl crate::Resettable for I2CCLKGS_SPEC {
