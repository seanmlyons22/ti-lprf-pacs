...
RCOSC_LF_GOOD"]
pub type RCOSC_LF_GOOD_R = crate::BitReader<bool>;
#[doc = "Field `RCOSC_LF_GOOD` writer - 31:31\\]
RCOSC_LF_GOOD"]
pub type RCOSC_LF_GOOD_W<'a, const O: u8> = crate::BitWriter<'a, u32, STAT0_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Indicates when SCLK_HF clock source is ready to be switched"]
    #[inline(always)]
...
RCOSC_LF_GOOD"]
    #[inline(always)]
    pub fn rcosc_lf_good(&self) -> RCOSC_LF_GOOD_R {
        RCOSC_LF_GOOD_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - 0:0\\]
...
RCOSC_LF_GOOD"]
    #[inline(always)]
    #[must_use]
    pub fn rcosc_lf_good(&mut self) -> RCOSC_LF_GOOD_W<31> {
        RCOSC_LF_GOOD_W::new(self)
    }
