...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn dcdc_drv_ds(&self) -> DcdcDrvDsR {
        DcdcDrvDsR::new(((self.bits >> 12) & 7) as u8)
    }
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn dcdc_drv_ds(&mut self) -> DcdcDrvDsW<Ana2TrimSpec> {
        DcdcDrvDsW::new(self, 12)
    }
    #[doc = "Bits 15:21 - 21:15\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
impl crate::Resettable for Ana2TrimSpec {
    const RESET_VALUE: u32 = 0x8240_087f;
}
