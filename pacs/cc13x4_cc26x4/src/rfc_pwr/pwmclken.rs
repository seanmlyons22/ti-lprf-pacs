...
pub type IqramR = crate::BitReader;
#[doc = "Field `IQRAM` writer - 11:11\\]
Enable clock to IQ RAM in coherent demodulator"]
pub type IqramW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DemodR = crate::BitReader;
#[doc = "Field `DEMOD` writer - 13:13\\]
Enable clock to the Demodulator"]
pub type DemodW<'a, REG> = crate::BitWriter<'a, REG>;
...
Enable clock to IQ RAM in coherent demodulator"]
    #[inline(always)]
    pub fn iqram(&self) -> IqramR {
        IqramR::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - 12:12\\]
Enable clock to the Modulator"]
    #[inline(always)]
...
Enable clock to the Demodulator"]
    #[inline(always)]
    pub fn demod(&self) -> DemodR {
        DemodR::new(((self.bits >> 13) & 1) != 0)
    }
...
Enable clock to IQ RAM in coherent demodulator"]
    #[inline(always)]
    #[must_use]
    pub fn iqram(&mut self) -> IqramW<PwmclkenSpec> {
        IqramW::new(self, 11)
    }
    #[doc = "Bit 12 - 12:12\\]
Enable clock to the Modulator"]
    #[inline(always)]
    #[must_use]
    pub fn mod_(&mut self) -> ModW<PwmclkenSpec> {
        ModW::new(self, 12)
    }
    #[doc = "Bit 13 - 13:13\\]
Enable clock to the Demodulator"]
