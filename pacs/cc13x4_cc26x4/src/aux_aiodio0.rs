...
you must configure this register while IOPOE bit 7 is 0. In the formulas i = 0 for AUX_AIODIO0, i = 1 for AUX_AIODIO1, and so forth."]
pub mod io7psel;
#[doc = "IOMODEL (rw) register accessor: Input Output Mode Low This is an alias register for IOMODE.IO0 thru IOMODE.IO3.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`iomodel::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`iomodel::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@iomodel`]
module"]
#[doc(alias = "IOMODEL")]
pub type Iomodel = crate::Reg<iomodel::IomodelSpec>;
#[doc = "Input Output Mode Low This is an alias register for IOMODE.IO0 thru IOMODE.IO3."]
pub mod iomodel;
#[doc = "IOMODEH (rw) register accessor: Input Output Mode High This is an alias register for IOMODE.IO4 thru IOMODE.IO7.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`iomodeh::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`iomodeh::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@iomodeh`]
module"]
#[doc(alias = "IOMODEH")]
pub type Iomodeh = crate::Reg<iomodeh::IomodehSpec>;
