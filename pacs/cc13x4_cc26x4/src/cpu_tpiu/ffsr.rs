...
#[doc = "Field `FLINPROG` reader - 0:0\\]
Read only. Flush in progress. Value can be: 0x0 When all the data received, before the flush is acknowledged, has been output on the trace port 0x1 When a flush is initiated."]
pub type FLINPROG_R = crate::BitReader<bool>;
#[doc = "Field `FLINPROG` writer - 0:0\\]
Read only. Flush in progress. Value can be: 0x0 When all the data received, before the flush is acknowledged, has been output on the trace port 0x1 When a flush is initiated."]
pub type FLINPROG_W<'a, const O: u8> = crate::BitWriter<'a, u32, FFSR_SPEC, bool, O>;
#[doc = "Field `FTSTOPPED` reader - 1:1\\]
This field always reads as zero"]
pub type FTSTOPPED_R = crate::BitReader<bool>;
#[doc = "Field `FTSTOPPED` writer - 1:1\\]
This field always reads as zero"]
pub type FTSTOPPED_W<'a, const O: u8> = crate::BitWriter<'a, u32, FFSR_SPEC, bool, O>;
#[doc = "Field `TCPRESENT` reader - 2:2\\]
This field always reads as zero"]
pub type TCPRESENT_R = crate::BitReader<bool>;
#[doc = "Field `TCPRESENT` writer - 2:2\\]
This field always reads as zero"]
pub type TCPRESENT_W<'a, const O: u8> = crate::BitWriter<'a, u32, FFSR_SPEC, bool, O>;
...
Read only. Flush in progress. Value can be: 0x0 When all the data received, before the flush is acknowledged, has been output on the trace port 0x1 When a flush is initiated."]
    #[inline(always)]
    pub fn flinprog(&self) -> FLINPROG_R {
        FLINPROG_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - 1:1\\]
This field always reads as zero"]
    #[inline(always)]
    pub fn ftstopped(&self) -> FTSTOPPED_R {
        FTSTOPPED_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - 2:2\\]
This field always reads as zero"]
    #[inline(always)]
...
Read only. Flush in progress. Value can be: 0x0 When all the data received, before the flush is acknowledged, has been output on the trace port 0x1 When a flush is initiated."]
    #[inline(always)]
    #[must_use]
    pub fn flinprog(&mut self) -> FLINPROG_W<0> {
        FLINPROG_W::new(self)
    }
    #[doc = "Bit 1 - 1:1\\]
This field always reads as zero"]
    #[inline(always)]
    #[must_use]
    pub fn ftstopped(&mut self) -> FTSTOPPED_W<1> {
        FTSTOPPED_W::new(self)
    }
    #[doc = "Bit 2 - 2:2\\]
This field always reads as zero"]
    #[inline(always)]
    #[must_use]
    pub fn tcpresent(&mut self) -> TCPRESENT_W<2> {
        TCPRESENT_W::new(self)
    }
    #[doc = "Bit 3 - 3:3\\]
0: Formatter can be stopped 1: Formatter cannot be stopped"]
    #[inline(always)]
