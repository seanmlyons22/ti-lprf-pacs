...
pub struct R(crate::R<NONSECDDIACC2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<NONSECDDIACC2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<NONSECDDIACC2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<NONSECDDIACC2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `NONSECDDIACC2` writer"]
pub struct W(crate::W<NONSECDDIACC2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<NONSECDDIACC2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<NONSECDDIACC2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<NONSECDDIACC2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type WR_MASK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, NONSECDDIACC2_SPEC, u16, u16, 16, O>;
...
Address AUX_SCE is allowed to update this DDI half-word using SET or CLR access."]
pub type ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, NONSECDDIACC2_SPEC, u8, u8, 6, O>;
...
Read Enable 0: AUX_SCE is not allowed to read DDI half-word given by ADDR. 1: AUX_SCE is allowed to read DDI half-word given by ADDR."]
pub type RD_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, NONSECDDIACC2_SPEC, bool, O>;
...
pub type RESERVED23_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, NONSECDDIACC2_SPEC, u16, u16, 9, O>;
impl R {
    #[doc = "Bits 0:15 - 15:0\\]
Mask AUX_SCE is allowed to update bits in half-word given by ADDR according to this bit mask."]
    #[inline(always)]
