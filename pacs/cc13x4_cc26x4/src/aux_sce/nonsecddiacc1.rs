...
pub type R = crate::R<Nonsecddiacc1Spec>;
#[doc = "Register `NONSECDDIACC1` writer"]
pub type W = crate::W<Nonsecddiacc1Spec>;
...
Mask AUX_SCE is allowed to update bits in half-word given by ADDR according to this bit mask."]
    #[inline(always)]
    #[must_use]
    pub fn wr_mask(&mut self) -> WrMaskW<Nonsecddiacc1Spec> {
        WrMaskW::new(self, 0)
    }
    #[doc = "Bits 16:21 - 21:16\\]
Address AUX_SCE is allowed to update this DDI half-word using SET or CLR access."]
    #[inline(always)]
    #[must_use]
    pub fn addr(&mut self) -> AddrW<Nonsecddiacc1Spec> {
        AddrW::new(self, 16)
    }
    #[doc = "Bit 22 - 22:22\\]
Read Enable 0: AUX_SCE is not allowed to read DDI half-word given by ADDR. 1: AUX_SCE is allowed to read DDI half-word given by ADDR."]
...
pub struct Nonsecddiacc1Spec;
impl crate::RegisterSpec for Nonsecddiacc1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`nonsecddiacc1::R`](R) reader structure"]
impl crate::Readable for Nonsecddiacc1Spec {}
#[doc = "`write(|w| ..)` method takes [`nonsecddiacc1::W`](W) writer structure"]
impl crate::Writable for Nonsecddiacc1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets NONSECDDIACC1 to value 0"]
impl crate::Resettable for Nonsecddiacc1Spec {
