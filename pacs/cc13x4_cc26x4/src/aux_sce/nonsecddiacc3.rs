...
pub type R = crate::R<Nonsecddiacc3Spec>;
#[doc = "Register `NONSECDDIACC3` writer"]
pub type W = crate::W<Nonsecddiacc3Spec>;
...
Mask AUX_SCE is allowed to update bits in half-word given by ADDR according to this bit mask."]
    #[inline(always)]
    #[must_use]
    pub fn wr_mask(&mut self) -> WrMaskW<Nonsecddiacc3Spec> {
        WrMaskW::new(self, 0)
    }
    #[doc = "Bits 16:21 - 21:16\\]
Address AUX_SCE is allowed to update this DDI half-word using SET or CLR access."]
    #[inline(always)]
    #[must_use]
    pub fn addr(&mut self) -> AddrW<Nonsecddiacc3Spec> {
        AddrW::new(self, 16)
    }
    #[doc = "Bit 22 - 22:22\\]
Read Enable 0: AUX_SCE is not allowed to read DDI half-word given by ADDR. 1: AUX_SCE is allowed to read DDI half-word given by ADDR."]
    #[inline(always)]
    #[must_use]
    pub fn rd_en(&mut self) -> RdEnW<Nonsecddiacc3Spec> {
        RdEnW::new(self, 22)
    }
    #[doc = "Bits 23:31 - 31:23\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
