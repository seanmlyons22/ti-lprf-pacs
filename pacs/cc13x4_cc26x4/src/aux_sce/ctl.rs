...
#[doc = "Field `RESET_VECTOR` writer - 15:8\\]
Internal. Only to be used through TI provided API."]
pub type RESET_VECTOR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTL_SPEC, u8, u8, 8, O>;
...
Internal. Only to be used through TI provided API."]
    ...
    pub fn reset_vector(&self) -> RESET_VECTOR_R {
        RESET_VECTOR_R::new(((self.bits >> 8) & 0xff) as u8)
    }
