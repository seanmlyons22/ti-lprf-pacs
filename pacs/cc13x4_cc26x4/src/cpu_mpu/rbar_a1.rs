...
pub type R = crate::R<RbarA1Spec>;
#[doc = "Register `RBAR_A1` writer"]
pub type W = crate::W<RbarA1Spec>;
...
Defines whether code can be executed from this region"]
    #[inline(always)]
    #[must_use]
    pub fn xn(&mut self) -> XnW<RbarA1Spec> {
        XnW::new(self, 0)
    }
    #[doc = "Bits 1:2 - 2:1\\]
Defines the access permissions for this region"]
    #[inline(always)]
    #[must_use]
    pub fn ap(&mut self) -> ApW<RbarA1Spec> {
        ApW::new(self, 1)
    }
    #[doc = "Bits 3:4 - 4:3\\]
Defines the Shareability domain of this region for Normal memory"]
    #[inline(always)]
    #[must_use]
    pub fn sh(&mut self) -> ShW<RbarA1Spec> {
        ShW::new(self, 3)
    }
    #[doc = "Bits 5:31 - 31:5\\]
Contains bits \\[31:5\\]
of the lower inclusive limit of the selected MPU memory region. This value is zero extended to provide the base address to be checked against"]
    #[inline(always)]
    #[must_use]
    pub fn base(&mut self) -> BaseW<RbarA1Spec> {
        BaseW::new(self, 5)
    }
}
#[doc = "Provides indirect read and write access to the base address of the MPU region selected by MPU_RNR\\[7:2\\]:(1\\[1:0\\])\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rbar_a1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rbar_a1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RbarA1Spec;
impl crate::RegisterSpec for RbarA1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rbar_a1::R`](R) reader structure"]
impl crate::Readable for RbarA1Spec {}
#[doc = "`write(|w| ..)` method takes [`rbar_a1::W`](W) writer structure"]
impl crate::Writable for RbarA1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RBAR_A1 to value 0"]
impl crate::Resettable for RbarA1Spec {
