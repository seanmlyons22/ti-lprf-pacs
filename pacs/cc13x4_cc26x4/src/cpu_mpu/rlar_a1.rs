...
pub type R = crate::R<RlarA1Spec>;
#[doc = "Register `RLAR_A1` writer"]
pub type W = crate::W<RlarA1Spec>;
...
Region enable"]
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EnW<RlarA1Spec> {
        EnW::new(self, 0)
    }
    #[doc = "Bits 1:3 - 3:1\\]
Associates a set of attributes in the MPU_MAIR0 and MPU_MAIR1 fields"]
    #[inline(always)]
    #[must_use]
    pub fn attrindx(&mut self) -> AttrindxW<RlarA1Spec> {
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved4(&mut self) -> Reserved4W<RlarA1Spec> {
...
of the upper inclusive limit of the selected MPU memory region. This value is postfixed with 0x1F to provide the limit address to be checked against"]
    #[inline(always)]
    #[must_use]
    pub fn limit(&mut self) -> LimitW<RlarA1Spec> {
        LimitW::new(self, 5)
    }
}
#[doc = "Provides indirect read and write access to the limit address of the currently selected MPU region selected by MPU_RNR\\[7:2\\]:(1\\[1:0\\])\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rlar_a1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rlar_a1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RlarA1Spec;
impl crate::RegisterSpec for RlarA1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rlar_a1::R`](R) reader structure"]
impl crate::Readable for RlarA1Spec {}
#[doc = "`write(|w| ..)` method takes [`rlar_a1::W`](W) writer structure"]
impl crate::Writable for RlarA1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RLAR_A1 to value 0"]
impl crate::Resettable for RlarA1Spec {
