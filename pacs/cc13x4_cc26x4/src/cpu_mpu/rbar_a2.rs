...
pub struct R(crate::R<RBAR_A2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RBAR_A2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RBAR_A2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RBAR_A2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RBAR_A2` writer"]
pub struct W(crate::W<RBAR_A2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RBAR_A2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RBAR_A2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RBAR_A2_SPEC>) -> Self {
        W(writer)
    }
}
...
Defines whether code can be executed from this region"]
pub type XN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RBAR_A2_SPEC, bool, O>;
...
Defines the access permissions for this region"]
pub type AP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RBAR_A2_SPEC, u8, u8, 2, O>;
...
Defines the Shareability domain of this region for Normal memory"]
pub type SH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RBAR_A2_SPEC, u8, u8, 2, O>;
...
Contains bits \\[31:5\\]
of the lower inclusive limit of the selected MPU memory region. This value is zero extended to provide the base address to be checked against"]
pub type BASE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RBAR_A2_SPEC, u32, u32, 27, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Defines whether code can be executed from this region"]
    #[inline(always)]
