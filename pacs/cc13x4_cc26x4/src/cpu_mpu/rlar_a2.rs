...
pub struct R(crate::R<RLAR_A2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLAR_A2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLAR_A2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLAR_A2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RLAR_A2` writer"]
pub struct W(crate::W<RLAR_A2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RLAR_A2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RLAR_A2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RLAR_A2_SPEC>) -> Self {
        W(writer)
    }
}
...
Region enable"]
pub type EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RLAR_A2_SPEC, bool, O>;
...
Associates a set of attributes in the MPU_MAIR0 and MPU_MAIR1 fields"]
pub type ATTRINDX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RLAR_A2_SPEC, u8, u8, 3, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED4_W<'a, const O: u8> = crate::BitWriter<'a, u32, RLAR_A2_SPEC, bool, O>;
...
Contains bits \\[31:5\\]
of the upper inclusive limit of the selected MPU memory region. This value is postfixed with 0x1F to provide the limit address to be checked against"]
pub type LIMIT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RLAR_A2_SPEC, u32, u32, 27, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Region enable"]
    #[inline(always)]
