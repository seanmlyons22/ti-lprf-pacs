...
pub struct R(crate::R<IO1PSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IO1PSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IO1PSEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IO1PSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IO1PSEL` writer"]
pub struct W(crate::W<IO1PSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IO1PSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IO1PSEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IO1PSEL_SPEC>) -> Self {
        W(writer)
    }
}
...
Select a peripheral signal that connects to AUXIO\\[8i+1\\]
when IOPOE bit 1 is set."]
pub type SRC_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, IO1PSEL_SPEC, u8, SRC_A, 3, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IO1PSEL_SPEC, u32, u32, 29, O>;
impl R {
    #[doc = "Bits 0:2 - 2:0\\]
Select a peripheral signal that connects to AUXIO\\[8i+1\\]
when IOPOE bit 1 is set."]
