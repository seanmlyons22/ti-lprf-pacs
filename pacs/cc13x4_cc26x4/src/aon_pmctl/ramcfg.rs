...
MCU SRAM is partitioned into 8 banks . This register controls which of the banks that has retention during MCU Bus domain power off"]
...
pub enum BUS_SRAM_RET_EN_A {
    #[doc = "15: Retention on for all banks BANK\\[0\\]: BANK\\[1\\]: BANK\\[2\\]: BANK\\[3\\]:BANK\\[4\\]: BANK\\[5\\]: BANK\\[6\\]: BANK\\[7\\]
+ PARITY_BANK retained"]
    RET_FULL = 15,
    #[doc = "7: Retention on for BANK\\[0\\]: BANK\\[1\\]: BANK\\[2\\]: BANK\\[3\\]:BANK\\[4\\]: BANK\\[5\\]
+ PARITY_BANK retained"]
    RET_LEVEL3 = 7,
    #[doc = "3: Retention on for BANK\\[0\\]: BANK\\[1\\]: BANK\\[2\\]: BANK\\[3\\]:BANK\\[4\\]
+ PARITY_BANK retained"]
    RET_LEVEL2 = 3,
    #[doc = "1: Retention on for BANK\\[0\\]: BANK\\[1\\]: BANK\\[2\\]: BANK\\[3\\]
+ PARITY_BANK retained"]
    RET_LEVEL1 = 1,
...
impl BUS_SRAM_RET_EN_R {
    ...
    pub fn variant(&self) -> Option<BUS_SRAM_RET_EN_A> {
        match self.bits {
            ...
            7 => Some(BUS_SRAM_RET_EN_A::RET_LEVEL3),
            3 => Some(BUS_SRAM_RET_EN_A::RET_LEVEL2),
            1 => Some(BUS_SRAM_RET_EN_A::RET_LEVEL1),
...
impl<'a, const O: u8> BUS_SRAM_RET_EN_W<'a, O> {
    #[doc = "Retention on for all banks BANK\\[0\\]: BANK\\[1\\]: BANK\\[2\\]: BANK\\[3\\]:BANK\\[4\\]: BANK\\[5\\]: BANK\\[6\\]: BANK\\[7\\]
+ PARITY_BANK retained"]
    #[inline(always)]
    pub fn ret_full(self) -> &'a mut W {
        self.variant(BUS_SRAM_RET_EN_A::RET_FULL)
    }
    #[doc = "Retention on for BANK\\[0\\]: BANK\\[1\\]: BANK\\[2\\]: BANK\\[3\\]:BANK\\[4\\]: BANK\\[5\\]
+ PARITY_BANK retained"]
    #[inline(always)]
    pub fn ret_level3(self) -> &'a mut W {
        self.variant(BUS_SRAM_RET_EN_A::RET_LEVEL3)
    }
    #[doc = "Retention on for BANK\\[0\\]: BANK\\[1\\]: BANK\\[2\\]: BANK\\[3\\]:BANK\\[4\\]
+ PARITY_BANK retained"]
    #[inline(always)]
    pub fn ret_level2(self) -> &'a mut W {
        self.variant(BUS_SRAM_RET_EN_A::RET_LEVEL2)
    }
    #[doc = "Retention on for BANK\\[0\\]: BANK\\[1\\]: BANK\\[2\\]: BANK\\[3\\]
+ PARITY_BANK retained"]
    #[inline(always)]
