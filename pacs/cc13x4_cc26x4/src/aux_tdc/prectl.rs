...
impl SrcR {
    ...
    pub const fn variant(&self) -> Option<Src> {
        match self.bits {
            ...
            52 => Some(Src::AuxTimer2Pulse),
            51 => Some(Src::AuxTimer2Ev3),
            50 => Some(Src::AuxTimer2Ev2),
            49 => Some(Src::AuxTimer2Ev1),
            48 => Some(Src::AuxTimer2Ev0),
            ...
            39 => Some(Src::PwrDwn),
            38 => Some(Src::SclkLf),
            37 => Some(Src::AonBatmonTempUpd),
            36 => Some(Src::AonBatmonBatUpd),
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn aon_batmon_temp_upd(self) -> &'a mut crate::W<REG> {
        self.variant(Src::AonBatmonTempUpd)
    }
    #[doc = "AUX_EVCTL:EVSTAT2.AON_BATMON_BAT_UPD"]
    #[inline(always)]
    pub fn aon_batmon_bat_upd(self) -> &'a mut crate::W<REG> {
        self.variant(Src::AonBatmonBatUpd)
    }
    #[doc = "AUX_EVCTL:EVSTAT2.AON_RTC_4KHZ"]
    #[inline(always)]
