...
pub mod uartclkgds;
#[doc = "SPICLKGR (rw) register accessor: an alias for `Reg<SPICLKGR_SPEC>`"]
pub type SPICLKGR = crate::Reg<spiclkgr::SPICLKGR_SPEC>;
#[doc = "SPI Clock Gate For Run And All Modes"]
pub mod spiclkgr;
#[doc = "SPICLKGS (rw) register accessor: an alias for `Reg<SPICLKGS_SPEC>`"]
pub type SPICLKGS = crate::Reg<spiclkgs::SPICLKGS_SPEC>;
#[doc = "SPI Clock Gate For Sleep Mode"]
pub mod spiclkgs;
#[doc = "SPICLKGDS (rw) register accessor: an alias for `Reg<SPICLKGDS_SPEC>`"]
pub type SPICLKGDS = crate::Reg<spiclkgds::SPICLKGDS_SPEC>;
...
pub mod resetuart;
#[doc = "RESETSPI (rw) register accessor: an alias for `Reg<RESETSPI_SPEC>`"]
pub type RESETSPI = crate::Reg<resetspi::RESETSPI_SPEC>;
...
pub mod oscicr;
#[doc = "NVMNSCADDR (rw) register accessor: an alias for `Reg<NVMNSCADDR_SPEC>`"]
pub type NVMNSCADDR = crate::Reg<nvmnscaddr::NVMNSCADDR_SPEC>;
#[doc = "NVM Non-Secure Callable boundary Address"]
pub mod nvmnscaddr;
#[doc = "NVMNSADDR (rw) register accessor: an alias for `Reg<NVMNSADDR_SPEC>`"]
pub type NVMNSADDR = crate::Reg<nvmnsaddr::NVMNSADDR_SPEC>;
#[doc = "NVM Non-Secure boundary Address"]
pub mod nvmnsaddr;
#[doc = "SRAMNSCADDR (rw) register accessor: an alias for `Reg<SRAMNSCADDR_SPEC>`"]
pub type SRAMNSCADDR = crate::Reg<sramnscaddr::SRAMNSCADDR_SPEC>;
#[doc = "SRAM Non-Secure Callable boundary Address"]
pub mod sramnscaddr;
#[doc = "SRAMNSADDR (rw) register accessor: an alias for `Reg<SRAMNSADDR_SPEC>`"]
pub type SRAMNSADDR = crate::Reg<sramnsaddr::SRAMNSADDR_SPEC>;
#[doc = "SRAM Non-Secure Callable boundary Address"]
pub mod sramnsaddr;
#[doc = "BUSSECCFG (rw) register accessor: an alias for `Reg<BUSSECCFG_SPEC>`"]
pub type BUSSECCFG = crate::Reg<busseccfg::BUSSECCFG_SPEC>;
#[doc = "BUS Security Configuration Register"]
pub mod busseccfg;
#[doc = "CPULOCK (rw) register accessor: an alias for `Reg<CPULOCK_SPEC>`"]
