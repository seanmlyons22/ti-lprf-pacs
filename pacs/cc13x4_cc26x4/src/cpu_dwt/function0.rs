...
Controls the type of match generated by this comparator"]
pub type MATCH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FUNCTION0_SPEC, u8, u8, 4, O>;
...
Defines the action on a match. This field is ignored and the comparator generates no actions if it is disabled by MATCH"]
pub type ACTION_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FUNCTION0_SPEC, u8, u8, 2, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED6_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FUNCTION0_SPEC, u8, u8, 4, O>;
...
Defines the size of the object being watched for by Data Value and Data Address comparators"]
pub type DATAVSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FUNCTION0_SPEC, u8, u8, 2, O>;
...
pub type RESERVED12_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FUNCTION0_SPEC, u16, u16, 12, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED25_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FUNCTION0_SPEC, u8, u8, 2, O>;
...
Identifies the capabilities for MATCH for comparator *n"]
pub type ID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FUNCTION0_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:3 - 3:0\\]
Controls the type of match generated by this comparator"]
    #[inline(always)]
