...
pub struct R(crate::R<DIN47_32_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DIN47_32_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DIN47_32_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DIN47_32_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DIN47_32` writer"]
pub struct W(crate::W<DIN47_32_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DIN47_32_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DIN47_32_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DIN47_32_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RESERVED16_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DIN47_32_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Data input from DIO 32"]
    #[inline(always)]
...
#[doc = "Data Input from DIO 32 to 47\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [din47_32](index.html) module"]
pub struct DIN47_32_SPEC;
impl crate::RegisterSpec for DIN47_32_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [din47_32::R](R) reader structure"]
impl crate::Readable for DIN47_32_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [din47_32::W](W) writer structure"]
impl crate::Writable for DIN47_32_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DIN47_32 to value 0"]
impl crate::Resettable for DIN47_32_SPEC {
