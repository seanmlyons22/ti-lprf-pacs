...
pub type R = crate::R<Douttgl47_32Spec>;
#[doc = "Register `DOUTTGL47_32` writer"]
pub type W = crate::W<Douttgl47_32Spec>;
...
Toggles bit 32"]
    #[inline(always)]
    #[must_use]
    pub fn dio32(&mut self) -> Dio32W<Douttgl47_32Spec> {
        Dio32W::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Toggles bit 33"]
    #[inline(always)]
    #[must_use]
    pub fn dio33(&mut self) -> Dio33W<Douttgl47_32Spec> {
        Dio33W::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Toggles bit 34"]
    #[inline(always)]
    #[must_use]
    pub fn dio34(&mut self) -> Dio34W<Douttgl47_32Spec> {
        Dio34W::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Toggles bit 35"]
    #[inline(always)]
    #[must_use]
    pub fn dio35(&mut self) -> Dio35W<Douttgl47_32Spec> {
        Dio35W::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Toggles bit 36"]
    #[inline(always)]
    #[must_use]
    pub fn dio36(&mut self) -> Dio36W<Douttgl47_32Spec> {
        Dio36W::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Toggles bit 37"]
    #[inline(always)]
    #[must_use]
    pub fn dio37(&mut self) -> Dio37W<Douttgl47_32Spec> {
        Dio37W::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Toggles bit 38"]
    #[inline(always)]
    #[must_use]
    pub fn dio38(&mut self) -> Dio38W<Douttgl47_32Spec> {
        Dio38W::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Toggles bit 39"]
    #[inline(always)]
    #[must_use]
    pub fn dio39(&mut self) -> Dio39W<Douttgl47_32Spec> {
        Dio39W::new(self, 7)
    }
    #[doc = "Bit 8 - 8:8\\]
Toggles bit 40"]
    #[inline(always)]
    #[must_use]
    pub fn dio40(&mut self) -> Dio40W<Douttgl47_32Spec> {
        Dio40W::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Toggles bit 41"]
    #[inline(always)]
    #[must_use]
    pub fn dio41(&mut self) -> Dio41W<Douttgl47_32Spec> {
        Dio41W::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
Toggles bit 42"]
    #[inline(always)]
    #[must_use]
    pub fn dio42(&mut self) -> Dio42W<Douttgl47_32Spec> {
        Dio42W::new(self, 10)
    }
    #[doc = "Bit 11 - 11:11\\]
Toggles bit 43"]
    #[inline(always)]
    #[must_use]
    pub fn dio43(&mut self) -> Dio43W<Douttgl47_32Spec> {
        Dio43W::new(self, 11)
    }
    #[doc = "Bit 12 - 12:12\\]
Toggles bit 44"]
    #[inline(always)]
    #[must_use]
    pub fn dio44(&mut self) -> Dio44W<Douttgl47_32Spec> {
        Dio44W::new(self, 12)
    }
    #[doc = "Bit 13 - 13:13\\]
Toggles bit 45"]
    #[inline(always)]
    #[must_use]
    pub fn dio45(&mut self) -> Dio45W<Douttgl47_32Spec> {
        Dio45W::new(self, 13)
    }
    #[doc = "Bit 14 - 14:14\\]
Toggles bit 46"]
    #[inline(always)]
    #[must_use]
    pub fn dio46(&mut self) -> Dio46W<Douttgl47_32Spec> {
        Dio46W::new(self, 14)
    }
    #[doc = "Bit 15 - 15:15\\]
Toggles bit 47"]
    #[inline(always)]
    #[must_use]
    pub fn dio47(&mut self) -> Dio47W<Douttgl47_32Spec> {
        Dio47W::new(self, 15)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved16(&mut self) -> Reserved16W<Douttgl47_32Spec> {
        Reserved16W::new(self, 16)
    }
}
#[doc = "Data Out Toggle Writing 1 to a bit position will invert the corresponding DIO output.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`douttgl47_32::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`douttgl47_32::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Douttgl47_32Spec;
impl crate::RegisterSpec for Douttgl47_32Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`douttgl47_32::R`](R) reader structure"]
impl crate::Readable for Douttgl47_32Spec {}
#[doc = "`write(|w| ..)` method takes [`douttgl47_32::W`](W) writer structure"]
impl crate::Writable for Douttgl47_32Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DOUTTGL47_32 to value 0"]
impl crate::Resettable for Douttgl47_32Spec {
