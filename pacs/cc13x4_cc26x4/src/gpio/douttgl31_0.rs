...
Toggles bit 26"]
    #[inline(always)]
    #[must_use]
    pub fn dio26(&mut self) -> Dio26W<Douttgl31_0Spec> {
        Dio26W::new(self, 26)
    }
    #[doc = "Bit 27 - 27:27\\]
Toggles bit 27"]
    #[inline(always)]
    #[must_use]
    pub fn dio27(&mut self) -> Dio27W<Douttgl31_0Spec> {
        Dio27W::new(self, 27)
    }
    #[doc = "Bit 28 - 28:28\\]
Toggles bit 28"]
    #[inline(always)]
    #[must_use]
    pub fn dio28(&mut self) -> Dio28W<Douttgl31_0Spec> {
        Dio28W::new(self, 28)
    }
    #[doc = "Bit 29 - 29:29\\]
Toggles bit 29"]
    #[inline(always)]
    #[must_use]
    pub fn dio29(&mut self) -> Dio29W<Douttgl31_0Spec> {
        Dio29W::new(self, 29)
    }
    #[doc = "Bit 30 - 30:30\\]
Toggles bit 30"]
    #[inline(always)]
    #[must_use]
    pub fn dio30(&mut self) -> Dio30W<Douttgl31_0Spec> {
        Dio30W::new(self, 30)
    }
    #[doc = "Bit 31 - 31:31\\]
Toggles bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn dio31(&mut self) -> Dio31W<Douttgl31_0Spec> {
        Dio31W::new(self, 31)
    }
}
