...
Sets the state of the pin that is configured as DIO#12, if the corresponding DOE47_0 bitfield is set."]
...
Sets the state of the pin that is configured as DIO#13, if the corresponding DOE47_0 bitfield is set."]
...
Sets the state of the pin that is configured as DIO#14, if the corresponding DOE47_0 bitfield is set."]
...
Sets the state of the pin that is configured as DIO#15, if the corresponding DOE47_0 bitfield is set."]
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved1(&mut self) -> Reserved1W<Dout15_12Spec> {
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved9(&mut self) -> Reserved9W<Dout15_12Spec> {
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved17(&mut self) -> Reserved17W<Dout15_12Spec> {
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved25(&mut self) -> Reserved25W<Dout15_12Spec> {
