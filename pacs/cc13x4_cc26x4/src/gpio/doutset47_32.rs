...
pub type R = crate::R<Doutset47_32Spec>;
#[doc = "Register `DOUTSET47_32` writer"]
pub type W = crate::W<Doutset47_32Spec>;
...
Set bit 32"]
    #[inline(always)]
    #[must_use]
    pub fn dio32(&mut self) -> Dio32W<Doutset47_32Spec> {
        Dio32W::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Set bit 33"]
    #[inline(always)]
    #[must_use]
    pub fn dio33(&mut self) -> Dio33W<Doutset47_32Spec> {
        Dio33W::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Set bit 34"]
    #[inline(always)]
    #[must_use]
    pub fn dio34(&mut self) -> Dio34W<Doutset47_32Spec> {
        Dio34W::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Set bit 35"]
    #[inline(always)]
    #[must_use]
    pub fn dio35(&mut self) -> Dio35W<Doutset47_32Spec> {
        Dio35W::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Set bit 36"]
    #[inline(always)]
    #[must_use]
    pub fn dio36(&mut self) -> Dio36W<Doutset47_32Spec> {
        Dio36W::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Set bit 37"]
    #[inline(always)]
    #[must_use]
    pub fn dio37(&mut self) -> Dio37W<Doutset47_32Spec> {
        Dio37W::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Set bit 38"]
    #[inline(always)]
    #[must_use]
    pub fn dio38(&mut self) -> Dio38W<Doutset47_32Spec> {
        Dio38W::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Set bit 39"]
    #[inline(always)]
    #[must_use]
    pub fn dio39(&mut self) -> Dio39W<Doutset47_32Spec> {
        Dio39W::new(self, 7)
    }
    #[doc = "Bit 8 - 8:8\\]
Set bit 40"]
    #[inline(always)]
    #[must_use]
    pub fn dio40(&mut self) -> Dio40W<Doutset47_32Spec> {
        Dio40W::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Set bit 41"]
    #[inline(always)]
    #[must_use]
    pub fn dio41(&mut self) -> Dio41W<Doutset47_32Spec> {
        Dio41W::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
Set bit 42"]
    #[inline(always)]
    #[must_use]
    pub fn dio42(&mut self) -> Dio42W<Doutset47_32Spec> {
        Dio42W::new(self, 10)
    }
    #[doc = "Bit 11 - 11:11\\]
Set bit 43"]
    #[inline(always)]
    #[must_use]
    pub fn dio43(&mut self) -> Dio43W<Doutset47_32Spec> {
        Dio43W::new(self, 11)
    }
    #[doc = "Bit 12 - 12:12\\]
Set bit 44"]
    #[inline(always)]
    #[must_use]
    pub fn dio44(&mut self) -> Dio44W<Doutset47_32Spec> {
        Dio44W::new(self, 12)
    }
    #[doc = "Bit 13 - 13:13\\]
Set bit 45"]
    #[inline(always)]
    #[must_use]
    pub fn dio45(&mut self) -> Dio45W<Doutset47_32Spec> {
        Dio45W::new(self, 13)
    }
    #[doc = "Bit 14 - 14:14\\]
Set bit 46"]
    #[inline(always)]
    #[must_use]
    pub fn dio46(&mut self) -> Dio46W<Doutset47_32Spec> {
        Dio46W::new(self, 14)
    }
    #[doc = "Bit 15 - 15:15\\]
Set bit 47"]
    #[inline(always)]
    #[must_use]
    pub fn dio47(&mut self) -> Dio47W<Doutset47_32Spec> {
        Dio47W::new(self, 15)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved16(&mut self) -> Reserved16W<Doutset47_32Spec> {
        Reserved16W::new(self, 16)
    }
}
#[doc = "Data Out Set Writing 1 to a bit position sets the corresponding bit in the DOUT47_0 register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`doutset47_32::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`doutset47_32::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Doutset47_32Spec;
impl crate::RegisterSpec for Doutset47_32Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doutset47_32::R`](R) reader structure"]
impl crate::Readable for Doutset47_32Spec {}
#[doc = "`write(|w| ..)` method takes [`doutset47_32::W`](W) writer structure"]
impl crate::Writable for Doutset47_32Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DOUTSET47_32 to value 0"]
impl crate::Resettable for Doutset47_32Spec {
