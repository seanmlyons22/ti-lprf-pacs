...
pub type R = crate::R<Dout47_32Spec>;
#[doc = "Register `DOUT47_32` writer"]
pub type W = crate::W<Dout47_32Spec>;
...
Data output for DIO 32"]
    #[inline(always)]
    #[must_use]
    pub fn dio32(&mut self) -> Dio32W<Dout47_32Spec> {
        Dio32W::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Data output for DIO 33"]
    #[inline(always)]
    #[must_use]
    pub fn dio33(&mut self) -> Dio33W<Dout47_32Spec> {
        Dio33W::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Data output for DIO 34"]
    #[inline(always)]
    #[must_use]
    pub fn dio34(&mut self) -> Dio34W<Dout47_32Spec> {
        Dio34W::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Data output for DIO 35"]
    #[inline(always)]
    #[must_use]
    pub fn dio35(&mut self) -> Dio35W<Dout47_32Spec> {
        Dio35W::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Data output for DIO 36"]
    #[inline(always)]
    #[must_use]
    pub fn dio36(&mut self) -> Dio36W<Dout47_32Spec> {
        Dio36W::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Data output for DIO 37"]
    #[inline(always)]
    #[must_use]
    pub fn dio37(&mut self) -> Dio37W<Dout47_32Spec> {
        Dio37W::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Data output for DIO 38"]
    #[inline(always)]
    #[must_use]
    pub fn dio38(&mut self) -> Dio38W<Dout47_32Spec> {
        Dio38W::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Data output for DIO 39"]
    #[inline(always)]
    #[must_use]
    pub fn dio39(&mut self) -> Dio39W<Dout47_32Spec> {
        Dio39W::new(self, 7)
    }
    #[doc = "Bit 8 - 8:8\\]
Data output for DIO 40"]
    #[inline(always)]
    #[must_use]
    pub fn dio40(&mut self) -> Dio40W<Dout47_32Spec> {
        Dio40W::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Data output for DIO 41"]
    #[inline(always)]
    #[must_use]
    pub fn dio41(&mut self) -> Dio41W<Dout47_32Spec> {
        Dio41W::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
Data output for DIO 42"]
    #[inline(always)]
    #[must_use]
    pub fn dio42(&mut self) -> Dio42W<Dout47_32Spec> {
        Dio42W::new(self, 10)
    }
    #[doc = "Bit 11 - 11:11\\]
Data output for DIO 43"]
    #[inline(always)]
    #[must_use]
    pub fn dio43(&mut self) -> Dio43W<Dout47_32Spec> {
        Dio43W::new(self, 11)
    }
    #[doc = "Bit 12 - 12:12\\]
Data output for DIO 44"]
    #[inline(always)]
    #[must_use]
    pub fn dio44(&mut self) -> Dio44W<Dout47_32Spec> {
        Dio44W::new(self, 12)
    }
    #[doc = "Bit 13 - 13:13\\]
Data output for DIO 45"]
    #[inline(always)]
    #[must_use]
    pub fn dio45(&mut self) -> Dio45W<Dout47_32Spec> {
        Dio45W::new(self, 13)
    }
    #[doc = "Bit 14 - 14:14\\]
Data output for DIO 46"]
    #[inline(always)]
    #[must_use]
    pub fn dio46(&mut self) -> Dio46W<Dout47_32Spec> {
        Dio46W::new(self, 14)
    }
    #[doc = "Bit 15 - 15:15\\]
Data output for DIO 47"]
...
pub struct Dout47_32Spec;
impl crate::RegisterSpec for Dout47_32Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dout47_32::R`](R) reader structure"]
impl crate::Readable for Dout47_32Spec {}
#[doc = "`write(|w| ..)` method takes [`dout47_32::W`](W) writer structure"]
impl crate::Writable for Dout47_32Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DOUT47_32 to value 0"]
impl crate::Resettable for Dout47_32Spec {
