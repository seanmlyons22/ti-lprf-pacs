...
pub struct R(crate::R<EVFLAGS47_32_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EVFLAGS47_32_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EVFLAGS47_32_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EVFLAGS47_32_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EVFLAGS47_32` writer"]
pub struct W(crate::W<EVFLAGS47_32_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EVFLAGS47_32_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EVFLAGS47_32_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EVFLAGS47_32_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RESERVED16_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EVFLAGS47_32_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Event for DIO 32"]
    #[inline(always)]
