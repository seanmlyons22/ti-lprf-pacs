...
pub type R = crate::R<Gpt2acaptselSpec>;
#[doc = "Register `GPT2ACAPTSEL` writer"]
pub type W = crate::W<Gpt2acaptselSpec>;
#[doc = "7:0\\]
...
Read/write selection value Writing any other value than values defined by a ENUM may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn ev(&mut self) -> EvW<Gpt2acaptselSpec> {
        EvW::new(self, 0)
    }
}
#[doc = "Output Selection for GPT2 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpt2acaptsel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpt2acaptsel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpt2acaptselSpec;
impl crate::RegisterSpec for Gpt2acaptselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpt2acaptsel::R`](R) reader structure"]
impl crate::Readable for Gpt2acaptselSpec {}
#[doc = "`write(|w| ..)` method takes [`gpt2acaptsel::W`](W) writer structure"]
impl crate::Writable for Gpt2acaptselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPT2ACAPTSEL to value 0x59"]
impl crate::Resettable for Gpt2acaptselSpec {
    const RESET_VALUE: u32 = 0x59;
}
