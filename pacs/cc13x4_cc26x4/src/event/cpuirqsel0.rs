...
pub type R = crate::R<Cpuirqsel0Spec>;
#[doc = "Register `CPUIRQSEL0` writer"]
pub type W = crate::W<Cpuirqsel0Spec>;
#[doc = "7:0\\]
...
Read only selection value"]
    #[inline(always)]
    #[must_use]
    pub fn ev(&mut self) -> EvW<Cpuirqsel0Spec> {
        EvW::new(self, 0)
    }
}
#[doc = "Output Selection for CPU Interrupt 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cpuirqsel0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cpuirqsel0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cpuirqsel0Spec;
impl crate::RegisterSpec for Cpuirqsel0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpuirqsel0::R`](R) reader structure"]
impl crate::Readable for Cpuirqsel0Spec {}
#[doc = "`write(|w| ..)` method takes [`cpuirqsel0::W`](W) writer structure"]
impl crate::Writable for Cpuirqsel0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CPUIRQSEL0 to value 0x04"]
impl crate::Resettable for Cpuirqsel0Spec {
