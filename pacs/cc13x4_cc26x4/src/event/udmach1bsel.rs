...
pub struct R(crate::R<UDMACH1BSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UDMACH1BSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UDMACH1BSEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UDMACH1BSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UDMACH1BSEL` writer"]
pub struct W(crate::W<UDMACH1BSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UDMACH1BSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UDMACH1BSEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UDMACH1BSEL_SPEC>) -> Self {
        W(writer)
    }
}
...
Read only selection value"]
pub type EV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, UDMACH1BSEL_SPEC, u8, EV_A, 8, O>;
