...
pub struct R(crate::R<FRZSEL0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FRZSEL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FRZSEL0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FRZSEL0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FRZSEL0` writer"]
pub struct W(crate::W<FRZSEL0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FRZSEL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FRZSEL0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FRZSEL0_SPEC>) -> Self {
        W(writer)
    }
}
...
Read/write selection value Writing any other value than values defined by a ENUM may result in undefined behavior."]
pub type EV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FRZSEL0_SPEC, u8, EV_A, 8, O>;
