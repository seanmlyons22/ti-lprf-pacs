...
pub type R = crate::R<Iocfg40Spec>;
#[doc = "Register `IOCFG40` writer"]
pub type W = crate::W<Iocfg40Spec>;
#[doc = "6:0\\]
...
Selects usage for DIO40 Note: This field should not be written other than the times when PORT_ID value is specifically required to change."]
    #[inline(always)]
    #[must_use]
    pub fn port_id(&mut self) -> PortIdW<Iocfg40Spec> {
        PortIdW::new(self, 0)
    }
    #[doc = "Bit 7 - 7:7\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved7(&mut self) -> Reserved7W<Iocfg40Spec> {
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert RTC event 1: Input edge detection asserts RTC event"]
    #[inline(always)]
    #[must_use]
    pub fn ioev_rtc_en(&mut self) -> IoevRtcEnW<Iocfg40Spec> {
...
Select source for drive strength control of this IO. This setting controls the drive strength of the Low-Current (LC) mode. Higher drive strength can be selected in IOCURR"]
    #[inline(always)]
    #[must_use]
    pub fn iostr(&mut self) -> IostrW<Iocfg40Spec> {
        IostrW::new(self, 9)
    }
    #[doc = "Bits 11:12 - 12:11\\]
Selects IO current mode of this IO."]
    #[inline(always)]
    #[must_use]
    pub fn iocurr(&mut self) -> IocurrW<Iocfg40Spec> {
        IocurrW::new(self, 11)
    }
    #[doc = "Bit 13 - 13:13\\]
0: Normal slew rate 1: Enables reduced slew rate in output driver."]
    #[inline(always)]
    #[must_use]
    pub fn slew_red(&mut self) -> SlewRedW<Iocfg40Spec> {
...
Pull control"]
    #[inline(always)]
    #[must_use]
    pub fn pull_ctl(&mut self) -> PullCtlW<Iocfg40Spec> {
...
Enable generation of edge detection events on this IO"]
    #[inline(always)]
    #[must_use]
    pub fn edge_det(&mut self) -> EdgeDetW<Iocfg40Spec> {
...
0: No interrupt generation 1: Enable interrupt generation for this IO (Only effective if EDGE_DET is enabled)"]
    #[inline(always)]
    #[must_use]
    pub fn edge_irq_en(&mut self) -> EdgeIrqEnW<Iocfg40Spec> {
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved19(&mut self) -> Reserved19W<Iocfg40Spec> {
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert AON_PROG0 event 1: Input edge detection asserts AON_PROG0 event"]
    #[inline(always)]
    #[must_use]
    pub fn ioev_aon_prog0_en(&mut self) -> IoevAonProg0EnW<Iocfg40Spec> {
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert AON_PROG1 event 1: Input edge detection asserts AON_PROG1 event"]
    #[inline(always)]
    #[must_use]
    pub fn ioev_aon_prog1_en(&mut self) -> IoevAonProg1EnW<Iocfg40Spec> {
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert AON_PROG2 event 1: Input edge detection asserts AON_PROG2 event"]
    #[inline(always)]
    #[must_use]
    pub fn ioev_aon_prog2_en(&mut self) -> IoevAonProg2EnW<Iocfg40Spec> {
...
IO Mode Not applicable for IO configured for AON periph. signals and AUX PORT_ID 0x01-0x08 AUX has its own open_source/drain configuration. 0x2: Reserved. Undefined behavior. 0x3: Reserved. Undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn iomode(&mut self) -> IomodeW<Iocfg40Spec> {
        IomodeW::new(self, 24)
    }
    #[doc = "Bits 27:28 - 28:27\\]
If DIO is configured GPIO or non-AON peripheral signals, PORT_ID 0x00 or >0x08: 00: No wake-up 01: No wake-up 10: Wakes up from shutdown if this pad is going low. 11: Wakes up from shutdown if this pad is going high. If IO is configured for AON peripheral signals or AUX PORT_ID 0x01-0x08, this register only sets wakeup enable or not. 00, 01: Wakeup disabled 10, 11: Wakeup enabled Polarity is controlled from AON registers. Note:When the MSB is set, the IOC will deactivate the output enable for the DIO."]
    #[inline(always)]
    #[must_use]
    pub fn wu_cfg(&mut self) -> WuCfgW<Iocfg40Spec> {
        WuCfgW::new(self, 27)
    }
    #[doc = "Bit 29 - 29:29\\]
0: Input disabled 1: Input enabled Note: If IO is configured for AUX PORT_ID = 0x08, the enable will be ignored."]
    #[inline(always)]
    #[must_use]
    pub fn ie(&mut self) -> IeW<Iocfg40Spec> {
        IeW::new(self, 29)
    }
    #[doc = "Bit 30 - 30:30\\]
0: Input hysteresis disable 1: Input hysteresis enable"]
    #[inline(always)]
    #[must_use]
    pub fn hyst_en(&mut self) -> HystEnW<Iocfg40Spec> {
        HystEnW::new(self, 30)
    }
    #[doc = "Bit 31 - 31:31\\]
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert MCU_WU event 1: Input edge detection asserts MCU_WU event"]
    #[inline(always)]
    #[must_use]
    pub fn ioev_mcu_wu_en(&mut self) -> IoevMcuWuEnW<Iocfg40Spec> {
        IoevMcuWuEnW::new(self, 31)
    }
}
#[doc = "Configuration of DIO40\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`iocfg40::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`iocfg40::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Iocfg40Spec;
impl crate::RegisterSpec for Iocfg40Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`iocfg40::R`](R) reader structure"]
impl crate::Readable for Iocfg40Spec {}
#[doc = "`write(|w| ..)` method takes [`iocfg40::W`](W) writer structure"]
impl crate::Writable for Iocfg40Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets IOCFG40 to value 0xc000"]
impl crate::Resettable for Iocfg40Spec {
