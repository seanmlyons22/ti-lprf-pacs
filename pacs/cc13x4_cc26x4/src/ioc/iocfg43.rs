#[doc = "Register `IOCFG43` reader"]
pub struct R(crate::R<IOCFG43_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IOCFG43_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IOCFG43_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IOCFG43_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IOCFG43` writer"]
pub struct W(crate::W<IOCFG43_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IOCFG43_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IOCFG43_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IOCFG43_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PORT_ID` reader - 6:0\\]
Selects usage for DIO43 Note: This field should not be written other than the times when PORT_ID value is specifically required to change."]
...
impl PORT_ID_R {
    ...
    pub fn variant(&self) -> Option<PORT_ID_A> {
        match self.bits {
            74 => Some(PORT_ID_A::I2C1_MSSCL),
            73 => Some(PORT_ID_A::I2C1_MSSDA),
            72 => Some(PORT_ID_A::UART3_RTS),
            71 => Some(PORT_ID_A::UART3_CTS),
            70 => Some(PORT_ID_A::UART3_TX),
            69 => Some(PORT_ID_A::UART3_RX),
            68 => Some(PORT_ID_A::UART2_RTS),
            67 => Some(PORT_ID_A::UART2_CTS),
            66 => Some(PORT_ID_A::UART2_TX),
            65 => Some(PORT_ID_A::UART2_RX),
            64 => Some(PORT_ID_A::SPI3_CLK),
            63 => Some(PORT_ID_A::SPI3_CS),
            62 => Some(PORT_ID_A::SPI3_TX),
            61 => Some(PORT_ID_A::SPI3_RX),
            60 => Some(PORT_ID_A::SPI2_CLK),
            59 => Some(PORT_ID_A::SPI2_CS),
            58 => Some(PORT_ID_A::SPI2_TX),
            57 => Some(PORT_ID_A::SPI2_RX),
            ...
            36 => Some(PORT_ID_A::SPI1_CLK),
            35 => Some(PORT_ID_A::SPI1_CS),
            34 => Some(PORT_ID_A::SPI1_TX),
            33 => Some(PORT_ID_A::SPI1_RX),
...
pub type PORT_ID_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IOCFG43_SPEC, u8, PORT_ID_A, 7, O>;
impl<'a, const O: u8> PORT_ID_W<'a, O> {
    #[doc = "I2C1 Clock"]
    #[inline(always)]
    pub fn i2c1_msscl(self) -> &'a mut W {
        self.variant(PORT_ID_A::I2C1_MSSCL)
    }
    #[doc = "I2C1 Data"]
    #[inline(always)]
    pub fn i2c1_mssda(self) -> &'a mut W {
        self.variant(PORT_ID_A::I2C1_MSSDA)
    }
    #[doc = "UART3 RTS"]
    #[inline(always)]
    pub fn uart3_rts(self) -> &'a mut W {
        self.variant(PORT_ID_A::UART3_RTS)
    }
    #[doc = "UART3 CTS"]
    #[inline(always)]
    pub fn uart3_cts(self) -> &'a mut W {
        self.variant(PORT_ID_A::UART3_CTS)
    }
    #[doc = "UART3 TX"]
    #[inline(always)]
    pub fn uart3_tx(self) -> &'a mut W {
        self.variant(PORT_ID_A::UART3_TX)
    }
    #[doc = "UART3 RX"]
    #[inline(always)]
    pub fn uart3_rx(self) -> &'a mut W {
        self.variant(PORT_ID_A::UART3_RX)
    }
    #[doc = "UART2 RTS"]
    #[inline(always)]
    pub fn uart2_rts(self) -> &'a mut W {
        self.variant(PORT_ID_A::UART2_RTS)
    }
    #[doc = "UART2 CTS"]
    #[inline(always)]
    pub fn uart2_cts(self) -> &'a mut W {
        self.variant(PORT_ID_A::UART2_CTS)
    }
    #[doc = "UART2 TX"]
    #[inline(always)]
    pub fn uart2_tx(self) -> &'a mut W {
        self.variant(PORT_ID_A::UART2_TX)
    }
    #[doc = "UART2 RX"]
    #[inline(always)]
    pub fn uart2_rx(self) -> &'a mut W {
        self.variant(PORT_ID_A::UART2_RX)
    }
    #[doc = "SPI3 CLK"]
    #[inline(always)]
    pub fn spi3_clk(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI3_CLK)
    }
    #[doc = "SPI3 CS"]
    #[inline(always)]
    pub fn spi3_cs(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI3_CS)
    }
    #[doc = "SPI3 TX"]
    #[inline(always)]
    pub fn spi3_tx(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI3_TX)
    }
    #[doc = "SPI3 RX"]
    #[inline(always)]
    pub fn spi3_rx(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI3_RX)
    }
    #[doc = "SPI2 CLK"]
    #[inline(always)]
    pub fn spi2_clk(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI2_CLK)
    }
    #[doc = "SPI2 CS"]
    #[inline(always)]
    pub fn spi2_cs(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI2_CS)
    }
    #[doc = "SPI2 TX"]
    #[inline(always)]
    pub fn spi2_tx(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI2_TX)
    }
    #[doc = "SPI2 RX"]
    #[inline(always)]
    pub fn spi2_rx(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI2_RX)
    }
    ...
    #[doc = "SPI1 CLK"]
    #[inline(always)]
    pub fn spi1_clk(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI1_CLK)
    }
    #[doc = "SPI1 CS"]
    #[inline(always)]
    pub fn spi1_cs(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI1_CS)
    }
    #[doc = "SPI1 TX"]
    #[inline(always)]
    pub fn spi1_tx(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI1_TX)
    }
    #[doc = "SPI1 RX"]
    #[inline(always)]
    pub fn spi1_rx(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI1_RX)
    }
    #[doc = "CPU SWV"]
    #[inline(always)]
    ...
    #[doc = "I2C0 Clock"]
    #[inline(always)]
    pub fn i2c0_msscl(self) -> &'a mut W {
        self.variant(PORT_ID_A::I2C0_MSSCL)
    }
    #[doc = "I2C0 Data"]
    #[inline(always)]
    pub fn i2c0_mssda(self) -> &'a mut W {
        self.variant(PORT_ID_A::I2C0_MSSDA)
    }
    #[doc = "SPI0 CLK"]
    #[inline(always)]
    pub fn spi0_clk(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI0_CLK)
    }
    #[doc = "SPI0 CS"]
    #[inline(always)]
    pub fn spi0_cs(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI0_CS)
    }
    #[doc = "SPI0 TX"]
    #[inline(always)]
    pub fn spi0_tx(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI0_TX)
    }
    #[doc = "SPI0 RX"]
    #[inline(always)]
    pub fn spi0_rx(self) -> &'a mut W {
        self.variant(PORT_ID_A::SPI0_RX)
    }
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED7_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG43_SPEC, bool, O>;
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert RTC event 1: Input edge detection asserts RTC event"]
pub type IOEV_RTC_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG43_SPEC, bool, O>;
...
pub type IOSTR_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, IOCFG43_SPEC, u8, IOSTR_A, 2, O>;
...
Selects IO current mode of this IO."]
pub type IOCURR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IOCFG43_SPEC, u8, IOCURR_A, 2, O>;
...
0: Normal slew rate 1: Enables reduced slew rate in output driver."]
pub type SLEW_RED_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG43_SPEC, bool, O>;
...
pub type PULL_CTL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IOCFG43_SPEC, u8, PULL_CTL_A, 2, O>;
...
pub type EDGE_DET_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, IOCFG43_SPEC, u8, EDGE_DET_A, 2, O>;
...
#[doc = "Field `EDGE_IRQ_EN` reader - 20:18\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type EDGE_IRQ_EN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EDGE_IRQ_EN` writer - 20:18\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type EDGE_IRQ_EN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IOCFG43_SPEC, u8, u8, 3, O>;
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert AON_PROG0 event 1: Input edge detection asserts AON_PROG0 event"]
pub type IOEV_AON_PROG0_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG43_SPEC, bool, O>;
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert AON_PROG1 event 1: Input edge detection asserts AON_PROG1 event"]
pub type IOEV_AON_PROG1_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG43_SPEC, bool, O>;
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert AON_PROG2 event 1: Input edge detection asserts AON_PROG2 event"]
pub type IOEV_AON_PROG2_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG43_SPEC, bool, O>;
...
IO Mode Not applicable for IO configured for AON periph. signals and AUX PORT_ID 0x01-0x08 AUX has its own open_source/drain configuration. 0x2: Reserved. Undefined behavior. 0x3: Reserved. Undefined behavior."]
pub type IOMODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IOCFG43_SPEC, u8, IOMODE_A, 3, O>;
...
If DIO is configured GPIO or non-AON peripheral signals, PORT_ID 0x00 or >0x08: 00: No wake-up 01: No wake-up 10: Wakes up from shutdown if this pad is going low. 11: Wakes up from shutdown if this pad is going high. If IO is configured for AON peripheral signals or AUX PORT_ID 0x01-0x08, this register only sets wakeup enable or not. 00, 01: Wakeup disabled 10, 11: Wakeup enabled Polarity is controlled from AON registers. Note:When the MSB is set, the IOC will deactivate the output enable for the DIO."]
pub type WU_CFG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IOCFG43_SPEC, u8, u8, 2, O>;
...
0: Input disabled 1: Input enabled Note: If IO is configured for AUX PORT_ID = 0x08, the enable will be ignored."]
pub type IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG43_SPEC, bool, O>;
...
0: Input hysteresis disable 1: Input hysteresis enable"]
pub type HYST_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG43_SPEC, bool, O>;
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert MCU_WU event 1: Input edge detection asserts MCU_WU event"]
pub type IOEV_MCU_WU_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG43_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:6 - 6:0\\]
Selects usage for DIO43 Note: This field should not be written other than the times when PORT_ID value is specifically required to change."]
    #[inline(always)]
    pub fn port_id(&self) -> PORT_ID_R {
        PORT_ID_R::new((self.bits & 0x7f) as u8)
    }
    #[doc = "Bit 7 - 7:7\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert RTC event 1: Input edge detection asserts RTC event"]
    ...
    pub fn ioev_rtc_en(&self) -> IOEV_RTC_EN_R {
        IOEV_RTC_EN_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bits 9:10 - 10:9\\]
Select source for drive strength control of this IO. This setting controls the drive strength of the Low-Current (LC) mode. Higher drive strength can be selected in IOCURR"]
    #[inline(always)]
    pub fn iostr(&self) -> IOSTR_R {
        IOSTR_R::new(((self.bits >> 9) & 3) as u8)
    }
    #[doc = "Bits 11:12 - 12:11\\]
Selects IO current mode of this IO."]
    #[inline(always)]
    pub fn iocurr(&self) -> IOCURR_R {
        IOCURR_R::new(((self.bits >> 11) & 3) as u8)
    }
    #[doc = "Bit 13 - 13:13\\]
0: Normal slew rate 1: Enables reduced slew rate in output driver."]
    #[inline(always)]
    pub fn slew_red(&self) -> SLEW_RED_R {
        SLEW_RED_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bits 14:15 - 15:14\\]
Pull control"]
    #[inline(always)]
    pub fn pull_ctl(&self) -> PULL_CTL_R {
        PULL_CTL_R::new(((self.bits >> 14) & 3) as u8)
    }
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    ...
    pub fn edge_irq_en(&self) -> EDGE_IRQ_EN_R {
        EDGE_IRQ_EN_R::new(((self.bits >> 18) & 7) as u8)
    }
    #[doc = "Bit 21 - 21:21\\]
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert AON_PROG0 event 1: Input edge detection asserts AON_PROG0 event"]
    #[inline(always)]
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert MCU_WU event 1: Input edge detection asserts MCU_WU event"]
    ...
    pub fn ioev_mcu_wu_en(&self) -> IOEV_MCU_WU_EN_R {
        IOEV_MCU_WU_EN_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:6 - 6:0\\]
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert RTC event 1: Input edge detection asserts RTC event"]
    #[inline(always)]
    #[must_use]
    pub fn ioev_rtc_en(&mut self) -> IOEV_RTC_EN_W<8> {
...
Select source for drive strength control of this IO. This setting controls the drive strength of the Low-Current (LC) mode. Higher drive strength can be selected in IOCURR"]
    #[inline(always)]
    #[must_use]
    pub fn iostr(&mut self) -> IOSTR_W<9> {
        IOSTR_W::new(self)
    }
    #[doc = "Bits 11:12 - 12:11\\]
Selects IO current mode of this IO."]
    #[inline(always)]
    #[must_use]
    pub fn iocurr(&mut self) -> IOCURR_W<11> {
        IOCURR_W::new(self)
    }
    #[doc = "Bit 13 - 13:13\\]
0: Normal slew rate 1: Enables reduced slew rate in output driver."]
    #[inline(always)]
    #[must_use]
    pub fn slew_red(&mut self) -> SLEW_RED_W<13> {
        SLEW_RED_W::new(self)
    }
    #[doc = "Bits 14:15 - 15:14\\]
Pull control"]
    #[inline(always)]
    #[must_use]
    pub fn pull_ctl(&mut self) -> PULL_CTL_W<14> {
        PULL_CTL_W::new(self)
    }
    #[doc = "Bits 16:17 - 17:16\\]
Enable generation of edge detection events on this IO"]
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert MCU_WU event 1: Input edge detection asserts MCU_WU event"]
    #[inline(always)]
    #[must_use]
    pub fn ioev_mcu_wu_en(&mut self) -> IOEV_MCU_WU_EN_W<31> {
...
#[doc = "Configuration of DIO43\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [iocfg43](index.html) module"]
pub struct IOCFG43_SPEC;
impl crate::RegisterSpec for IOCFG43_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [iocfg43::R](R) reader structure"]
impl crate::Readable for IOCFG43_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [iocfg43::W](W) writer structure"]
impl crate::Writable for IOCFG43_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IOCFG43 to value 0xc000"]
impl crate::Resettable for IOCFG43_SPEC {
