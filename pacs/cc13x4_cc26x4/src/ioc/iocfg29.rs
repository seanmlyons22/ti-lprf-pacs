#[doc = "Register `IOCFG29` reader"]
pub struct R(crate::R<IOCFG29_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IOCFG29_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IOCFG29_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IOCFG29_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IOCFG29` writer"]
pub struct W(crate::W<IOCFG29_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IOCFG29_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IOCFG29_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IOCFG29_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PORT_ID` reader - 6:0\\]
Selects usage for DIO29 Note: This field should not be written other than the times when PORT_ID value is specifically required to change."]
...
pub type PORT_ID_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IOCFG29_SPEC, u8, PORT_ID_A, 7, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED7_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG29_SPEC, bool, O>;
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert RTC event 1: Input edge detection asserts RTC event"]
pub type IOEV_RTC_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG29_SPEC, bool, O>;
...
pub type IOSTR_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, IOCFG29_SPEC, u8, IOSTR_A, 2, O>;
...
Selects IO current mode of this IO."]
pub type IOCURR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IOCFG29_SPEC, u8, IOCURR_A, 2, O>;
...
0: Normal slew rate 1: Enables reduced slew rate in output driver."]
pub type SLEW_RED_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG29_SPEC, bool, O>;
...
pub type PULL_CTL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IOCFG29_SPEC, u8, PULL_CTL_A, 2, O>;
...
pub type EDGE_DET_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, IOCFG29_SPEC, u8, EDGE_DET_A, 2, O>;
...
0: No interrupt generation 1: Enable interrupt generation for this IO (Only effective if EDGE_DET is enabled)"]
pub type EDGE_IRQ_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG29_SPEC, bool, O>;
#[doc = "Field `RESERVED19` reader - 20:19\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED19_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RESERVED19` writer - 20:19\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED19_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IOCFG29_SPEC, u8, u8, 2, O>;
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert AON_PROG0 event 1: Input edge detection asserts AON_PROG0 event"]
pub type IOEV_AON_PROG0_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG29_SPEC, bool, O>;
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert AON_PROG1 event 1: Input edge detection asserts AON_PROG1 event"]
pub type IOEV_AON_PROG1_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG29_SPEC, bool, O>;
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert AON_PROG2 event 1: Input edge detection asserts AON_PROG2 event"]
pub type IOEV_AON_PROG2_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG29_SPEC, bool, O>;
...
IO Mode Not applicable for IO configured for AON periph. signals and AUX PORT_ID 0x01-0x08 AUX has its own open_source/drain configuration. 0x2: Reserved. Undefined behavior. 0x3: Reserved. Undefined behavior."]
pub type IOMODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IOCFG29_SPEC, u8, IOMODE_A, 3, O>;
...
If DIO is configured GPIO or non-AON peripheral signals, PORT_ID 0x00 or >0x08: 00: No wake-up 01: No wake-up 10: Wakes up from shutdown if this pad is going low. 11: Wakes up from shutdown if this pad is going high. If IO is configured for AON peripheral signals or AUX PORT_ID 0x01-0x08, this register only sets wakeup enable or not. 00, 01: Wakeup disabled 10, 11: Wakeup enabled Polarity is controlled from AON registers. Note:When the MSB is set, the IOC will deactivate the output enable for the DIO."]
pub type WU_CFG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IOCFG29_SPEC, u8, u8, 2, O>;
...
0: Input disabled 1: Input enabled Note: If IO is configured for AUX PORT_ID = 0x08, the enable will be ignored."]
pub type IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG29_SPEC, bool, O>;
...
0: Input hysteresis disable 1: Input hysteresis enable"]
pub type HYST_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG29_SPEC, bool, O>;
...
Event asserted by this IO when edge detection is enabled 0: Input edge detection does not assert MCU_WU event 1: Input edge detection asserts MCU_WU event"]
pub type IOEV_MCU_WU_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG29_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:6 - 6:0\\]
Selects usage for DIO29 Note: This field should not be written other than the times when PORT_ID value is specifically required to change."]
    #[inline(always)]
...
#[doc = "Configuration of DIO29\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [iocfg29](index.html) module"]
pub struct IOCFG29_SPEC;
impl crate::RegisterSpec for IOCFG29_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [iocfg29::R](R) reader structure"]
impl crate::Readable for IOCFG29_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [iocfg29::W](W) writer structure"]
impl crate::Writable for IOCFG29_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IOCFG29 to value 0xc000"]
impl crate::Resettable for IOCFG29_SPEC {
