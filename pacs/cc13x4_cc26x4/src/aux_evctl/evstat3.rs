...
AUX_TIMER2 event output 0. Configuration of AUX_SYSIF:EVSYNCRATE.AUX_TIMER2_SYNC_RATE sets the synchronization rate for this event."]
pub type AUX_TIMER2_EV0_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVSTAT3_SPEC, bool, O>;
...
AUX_TIMER2 event output 1. Configuration of AUX_SYSIF:EVSYNCRATE.AUX_TIMER2_SYNC_RATE sets the synchronization rate for this event."]
pub type AUX_TIMER2_EV1_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVSTAT3_SPEC, bool, O>;
...
AUX_TIMER2 event output 2. Configuration of AUX_SYSIF:EVSYNCRATE.AUX_TIMER2_SYNC_RATE sets the synchronization rate for this event."]
pub type AUX_TIMER2_EV2_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVSTAT3_SPEC, bool, O>;
...
AUX_TIMER2 event output 3. Configuration of AUX_SYSIF:EVSYNCRATE.AUX_TIMER2_SYNC_RATE sets the synchronization rate for this event."]
pub type AUX_TIMER2_EV3_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVSTAT3_SPEC, bool, O>;
...
AUX_TIMER2 pulse event. Configuration of AUX_SYSIF:EVSYNCRATE.AUX_TIMER2_SYNC_RATE sets the synchronization rate for this event."]
pub type AUX_TIMER2_PULSE_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVSTAT3_SPEC, bool, O>;
...
pub type AUX_TIMER2_CLKSWITCH_RDY_R = crate::BitReader<bool>;
#[doc = "Field `AUX_TIMER2_CLKSWITCH_RDY` writer - 15:15\\]
AUX_SYSIF:TIMER2CLKSWITCH.RDY"]
pub type AUX_TIMER2_CLKSWITCH_RDY_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EVSTAT3_SPEC, bool, O>;
...
AUX_TIMER2 event output 0. Configuration of AUX_SYSIF:EVSYNCRATE.AUX_TIMER2_SYNC_RATE sets the synchronization rate for this event."]
    ...
    pub fn aux_timer2_ev0(&self) -> AUX_TIMER2_EV0_R {
        AUX_TIMER2_EV0_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - 1:1\\]
AUX_TIMER2 event output 1. Configuration of AUX_SYSIF:EVSYNCRATE.AUX_TIMER2_SYNC_RATE sets the synchronization rate for this event."]
    #[inline(always)]
    pub fn aux_timer2_ev1(&self) -> AUX_TIMER2_EV1_R {
        AUX_TIMER2_EV1_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - 2:2\\]
AUX_TIMER2 event output 2. Configuration of AUX_SYSIF:EVSYNCRATE.AUX_TIMER2_SYNC_RATE sets the synchronization rate for this event."]
    #[inline(always)]
    pub fn aux_timer2_ev2(&self) -> AUX_TIMER2_EV2_R {
        AUX_TIMER2_EV2_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - 3:3\\]
AUX_TIMER2 event output 3. Configuration of AUX_SYSIF:EVSYNCRATE.AUX_TIMER2_SYNC_RATE sets the synchronization rate for this event."]
    #[inline(always)]
    pub fn aux_timer2_ev3(&self) -> AUX_TIMER2_EV3_R {
        AUX_TIMER2_EV3_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - 4:4\\]
AUX_TIMER2 pulse event. Configuration of AUX_SYSIF:EVSYNCRATE.AUX_TIMER2_SYNC_RATE sets the synchronization rate for this event."]
    #[inline(always)]
    pub fn aux_timer2_pulse(&self) -> AUX_TIMER2_PULSE_R {
        AUX_TIMER2_PULSE_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - 5:5\\]
AUX_TIMER1_EV event, see AUX_TIMER01:T1TARGET for description."]
    #[inline(always)]
...
AUX_SYSIF:TIMER2CLKSWITCH.RDY"]
    ...
    pub fn aux_timer2_clkswitch_rdy(&self) -> AUX_TIMER2_CLKSWITCH_RDY_R {
        AUX_TIMER2_CLKSWITCH_RDY_R::new(((self.bits >> 15) & 1) != 0)
    }
...
AUX_TIMER2 event output 0. Configuration of AUX_SYSIF:EVSYNCRATE.AUX_TIMER2_SYNC_RATE sets the synchronization rate for this event."]
    #[inline(always)]
    #[must_use]
    pub fn aux_timer2_ev0(&mut self) -> AUX_TIMER2_EV0_W<0> {
...
AUX_TIMER2 event output 1. Configuration of AUX_SYSIF:EVSYNCRATE.AUX_TIMER2_SYNC_RATE sets the synchronization rate for this event."]
    #[inline(always)]
    #[must_use]
    pub fn aux_timer2_ev1(&mut self) -> AUX_TIMER2_EV1_W<1> {
...
AUX_TIMER2 event output 2. Configuration of AUX_SYSIF:EVSYNCRATE.AUX_TIMER2_SYNC_RATE sets the synchronization rate for this event."]
    #[inline(always)]
    #[must_use]
    pub fn aux_timer2_ev2(&mut self) -> AUX_TIMER2_EV2_W<2> {
...
AUX_TIMER2 event output 3. Configuration of AUX_SYSIF:EVSYNCRATE.AUX_TIMER2_SYNC_RATE sets the synchronization rate for this event."]
    #[inline(always)]
    #[must_use]
    pub fn aux_timer2_ev3(&mut self) -> AUX_TIMER2_EV3_W<3> {
...
AUX_TIMER2 pulse event. Configuration of AUX_SYSIF:EVSYNCRATE.AUX_TIMER2_SYNC_RATE sets the synchronization rate for this event."]
    #[inline(always)]
    #[must_use]
    pub fn aux_timer2_pulse(&mut self) -> AUX_TIMER2_PULSE_W<4> {
...
AUX_SYSIF:TIMER2CLKSWITCH.RDY"]
    #[inline(always)]
    #[must_use]
    pub fn aux_timer2_clkswitch_rdy(&mut self) -> AUX_TIMER2_CLKSWITCH_RDY_W<15> {
        AUX_TIMER2_CLKSWITCH_RDY_W::new(self)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
