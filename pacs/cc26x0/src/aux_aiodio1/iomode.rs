...
#[repr(u8)]
pub enum Io0 {
    #[doc = "3: Open-Source Mode: When GPIODOUT bit 0 is 0: AUXIO\\[8i+0\\]
is tri-stated or pulled. This depends on IOC:IOCFGn.PULL_CTL. When GPIODOUT bit 0 is 1: AUXIO\\[8i+0\\]
is driven high."]
    OpenSource = 3,
    #[doc = "2: Open-Drain Mode: When GPIODOUT bit 0 is 0: AUXIO\\[8i+0\\]
...
is enabled for digital input."]
    In = 1,
    #[doc = "0: Output Mode: GPIODOUT bit 0 drives AUXIO\\[8i+0\\]."]
    Out = 0,
}
...
#[repr(u8)]
pub enum Io1 {
    #[doc = "3: Open-Source Mode: When GPIODOUT bit 1 is 0: AUXIO\\[8i+1\\]
is tri-stated or pulled. This depends on IOC:IOCFGn.PULL_CTL. When GPIODOUT bit 1 is 1: AUXIO\\[8i+1\\]
is driven high."]
    OpenSource = 3,
    #[doc = "2: Open-Drain Mode: When GPIODOUT bit 1 is 0: AUXIO\\[8i+1\\]
...
is enabled for digital input."]
    In = 1,
    #[doc = "0: Output Mode: GPIODOUT bit 1 drives AUXIO\\[8i+1\\]."]
    Out = 0,
}
...
#[repr(u8)]
pub enum Io2 {
    #[doc = "3: Open-Source Mode: When GPIODOUT bit 2 is 0: AUXIO\\[8i+2\\]
is tri-stated or pulled. This depends on IOC:IOCFGn.PULL_CTL. When GPIODOUT bit 2 is 1: AUXIO\\[8i+2\\]
is driven high."]
    OpenSource = 3,
    #[doc = "2: Open-Drain Mode: When GPIODOUT bit 2 is 0: AUXIO\\[8i+2\\]
...
is enabled for digital input."]
    In = 1,
    #[doc = "0: Output Mode: GPIODOUT bit 2 drives AUXIO\\[8i+2\\]."]
    Out = 0,
}
...
#[repr(u8)]
pub enum Io3 {
    #[doc = "3: Open-Source Mode: When GPIODOUT bit 3 is 0: AUXIO\\[8i+3\\]
is tri-stated or pulled. This depends on IOC:IOCFGn.PULL_CTL. When GPIODOUT bit 3 is 1: AUXIO\\[8i+3\\]
is driven high."]
    OpenSource = 3,
    #[doc = "2: Open-Drain Mode: When GPIODOUT bit 3 is 0: AUXIO\\[8i+3\\]
...
is enabled for digital input."]
    In = 1,
    #[doc = "0: Output Mode: GPIODOUT bit 3 drives AUXIO\\[8i+3\\]."]
    Out = 0,
}
...
#[repr(u8)]
pub enum Io4 {
    #[doc = "3: Open-Source Mode: When GPIODOUT bit 4 is 0: AUXIO\\[8i+4\\]
is tri-stated or pulled. This depends on IOC:IOCFGn.PULL_CTL. When GPIODOUT bit 4 is 1: AUXIO\\[8i+4\\]
is driven high."]
    OpenSource = 3,
    #[doc = "2: Open-Drain Mode: When GPIODOUT bit 4 is 0: AUXIO\\[8i+4\\]
...
is enabled for digital input."]
    In = 1,
    #[doc = "0: Output Mode: GPIODOUT bit 4 drives AUXIO\\[8i+4\\]."]
    Out = 0,
}
...
#[repr(u8)]
pub enum Io5 {
    #[doc = "3: Open-Source Mode: When GPIODOUT bit 5 is 0: AUXIO\\[8i+5\\]
is tri-stated or pulled. This depends on IOC:IOCFGn.PULL_CTL. When GPIODOUT bit 5 is 1: AUXIO\\[8i+5\\]
is driven high."]
    OpenSource = 3,
    #[doc = "2: Open-Drain Mode: When GPIODOUT bit 5 is 0: AUXIO\\[8i+5\\]
...
is enabled for digital input."]
    In = 1,
    #[doc = "0: Output Mode: GPIODOUT bit 5 drives AUXIO\\[8i+5\\]."]
    Out = 0,
}
...
#[repr(u8)]
pub enum Io6 {
    #[doc = "3: Open-Source Mode: When GPIODOUT bit 6 is 0: AUXIO\\[8i+6\\]
is tri-stated or pulled. This depends on IOC:IOCFGn.PULL_CTL. When GPIODOUT bit 6 is 1: AUXIO\\[8i+6\\]
is driven high."]
    OpenSource = 3,
    #[doc = "2: Open-Drain Mode: When GPIODOUT bit 6 is 0: AUXIO\\[8i+6\\]
...
is enabled for digital input."]
    In = 1,
    #[doc = "0: Output Mode: GPIODOUT bit 6 drives AUXIO\\[8i+6\\]."]
    Out = 0,
}
...
#[repr(u8)]
pub enum Io7 {
    #[doc = "3: Open-Source Mode: When GPIODOUT bit 7 is 0: AUXIO\\[8i+7\\]
is tri-stated or pulled. This depends on IOC:IOCFGn.PULL_CTL. When GPIODOUT bit 7 is 1: AUXIO\\[8i+7\\]
is driven high."]
    OpenSource = 3,
    #[doc = "2: Open-Drain Mode: When GPIODOUT bit 7 is 0: AUXIO\\[8i+7\\]
...
is enabled for digital input."]
    In = 1,
    #[doc = "0: Output Mode: GPIODOUT bit 7 drives AUXIO\\[8i+7\\]."]
    Out = 0,
}
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved16(&mut self) -> Reserved16W<IomodeSpec> {
