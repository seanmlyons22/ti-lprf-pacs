...
Internal. Only to be used through TI provided API."]
pub type Reg4W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `REG5` reader - 31:16\\]
Internal. Only to be used through TI provided API."]
pub type Reg5R = crate::FieldReader<u16>;
#[doc = "Field `REG5` writer - 31:16\\]
Internal. Only to be used through TI provided API."]
pub type Reg5W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - 15:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn reg4(&mut self) -> Reg4W<Reg5_4Spec> {
        Reg4W::new(self, 0)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn reg5(&mut self) -> Reg5W<Reg5_4Spec> {
        Reg5W::new(self, 16)
    }
}
