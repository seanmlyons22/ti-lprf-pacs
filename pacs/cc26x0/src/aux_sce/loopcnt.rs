...
pub type ITER_LEFT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ITER_LEFT` writer - 7:0\\]
Internal. Only to be used through TI provided API."]
pub type ITER_LEFT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LOOPCNT_SPEC, u8, u8, 8, O>;
#[doc = "Field `RESERVED8` reader - 31:8\\]
Internal. Only to be used through TI provided API."]
pub type RESERVED8_R = crate::FieldReader<u32, u32>;
#[doc = "Field `RESERVED8` writer - 31:8\\]
Internal. Only to be used through TI provided API."]
pub type RESERVED8_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LOOPCNT_SPEC, u32, u32, 24, O>;
impl R {
    #[doc = "Bits 0:7 - 7:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn iter_left(&mut self) -> ITER_LEFT_W<0> {
        ITER_LEFT_W::new(self)
    }
    #[doc = "Bits 8:31 - 31:8\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
