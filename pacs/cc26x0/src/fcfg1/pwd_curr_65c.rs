...
Worst-case baseline maximum powerdown current, in units of 0.5uA"]
pub type BASELINE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PWD_CURR_65C_SPEC, u8, u8, 8, O>;
...
pub type DELTA_XOSC_LPM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PWD_CURR_65C_SPEC, u8, u8, 8, O>;
...
impl crate::Resettable for PWD_CURR_65C_SPEC {
    const RESET_VALUE: Self::Ux = 0x1c25_9c14;
}
