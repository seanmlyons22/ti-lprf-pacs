...
pub type R = crate::R<PwdCurr80cSpec>;
#[doc = "Register `PWD_CURR_80C` writer"]
pub type W = crate::W<PwdCurr80cSpec>;
...
Worst-case baseline maximum powerdown current, in units of 0.5uA"]
    #[inline(always)]
    #[must_use]
    pub fn baseline(&mut self) -> BaselineW<PwdCurr80cSpec> {
...
Additional maximum current, in units of 1uA, with XOSC_HF on in low-power mode"]
    #[inline(always)]
    #[must_use]
    pub fn delta_xosc_lpm(&mut self) -> DeltaXoscLpmW<PwdCurr80cSpec> {
...
Additional maximum current, in 1uA units, with RF memory retention"]
    #[inline(always)]
    #[must_use]
    pub fn delta_rfmem_ret(&mut self) -> DeltaRfmemRetW<PwdCurr80cSpec> {
...
Additional maximum current, in units of 1uA, with cache retention"]
    #[inline(always)]
    #[must_use]
    pub fn delta_cache_ref(&mut self) -> DeltaCacheRefW<PwdCurr80cSpec> {
        DeltaCacheRefW::new(self, 24)
    }
}
#[doc = "Power Down Current Control 80C\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwd_curr_80c::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwd_curr_80c::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PwdCurr80cSpec;
impl crate::RegisterSpec for PwdCurr80cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwd_curr_80c::R`](R) reader structure"]
impl crate::Readable for PwdCurr80cSpec {}
#[doc = "`write(|w| ..)` method takes [`pwd_curr_80c::W`](W) writer structure"]
impl crate::Writable for PwdCurr80cSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PWD_CURR_80C to value 0x2e3b_9021"]
impl crate::Resettable for PwdCurr80cSpec {
    const RESET_VALUE: u32 = 0x2e3b_9021;
}
