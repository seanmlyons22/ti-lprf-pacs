...
pub type PoTailResTrimR = crate::FieldReader;
#[doc = "Field `PO_TAIL_RES_TRIM` writer - 11:8\\]
Internal. Only to be used through TI provided API."]
pub type PoTailResTrimW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn po_tail_res_trim(&self) -> PoTailResTrimR {
        PoTailResTrimR::new(((self.bits >> 8) & 0x0f) as u8)
    }
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn po_tail_res_trim(&mut self) -> PoTailResTrimW<MiscOtpDataSpec> {
        PoTailResTrimW::new(self, 8)
    }
    #[doc = "Bits 12:14 - 14:12\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
