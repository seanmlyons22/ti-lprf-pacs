...
Internal. Only to be used through TI provided API."]
pub type DIS_IDLE_EXT_RD_R = crate::BitReader<bool>;
#[doc = "Field `DIS_IDLE_EXT_RD` writer - 3:3\\]
Internal. Only to be used through TI provided API."]
pub type DIS_IDLE_EXT_RD_W<'a, const O: u8> =
...
Internal. Only to be used through TI provided API."]
pub type DIS_IDLE_INT_RD_R = crate::BitReader<bool>;
#[doc = "Field `DIS_IDLE_INT_RD` writer - 11:11\\]
Internal. Only to be used through TI provided API."]
pub type DIS_IDLE_INT_RD_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, FLASH_OTP_DATA4_SPEC, bool, O>;
...
Internal. Only to be used through TI provided API."]
pub type DIS_IDLE_EXT_WRT_R = crate::BitReader<bool>;
#[doc = "Field `DIS_IDLE_EXT_WRT` writer - 19:19\\]
Internal. Only to be used through TI provided API."]
pub type DIS_IDLE_EXT_WRT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, FLASH_OTP_DATA4_SPEC, bool, O>;
...
Internal. Only to be used through TI provided API."]
pub type DIS_IDLE_INT_WRT_R = crate::BitReader<bool>;
#[doc = "Field `DIS_IDLE_INT_WRT` writer - 27:27\\]
Internal. Only to be used through TI provided API."]
pub type DIS_IDLE_INT_WRT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, FLASH_OTP_DATA4_SPEC, bool, O>;
...
Internal. Only to be used through TI provided API."]
    ...
    pub fn dis_idle_ext_rd(&self) -> DIS_IDLE_EXT_RD_R {
        DIS_IDLE_EXT_RD_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    ...
    pub fn dis_idle_int_rd(&self) -> DIS_IDLE_INT_RD_R {
        DIS_IDLE_INT_RD_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - 12:12\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    ...
    pub fn dis_idle_ext_wrt(&self) -> DIS_IDLE_EXT_WRT_R {
        DIS_IDLE_EXT_WRT_R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 20 - 20:20\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    ...
    pub fn dis_idle_int_wrt(&self) -> DIS_IDLE_INT_WRT_R {
        DIS_IDLE_INT_WRT_R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - 28:28\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn dis_idle_ext_rd(&mut self) -> DIS_IDLE_EXT_RD_W<3> {
        DIS_IDLE_EXT_RD_W::new(self)
    }
    #[doc = "Bit 4 - 4:4\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn dis_idle_int_rd(&mut self) -> DIS_IDLE_INT_RD_W<11> {
        DIS_IDLE_INT_RD_W::new(self)
    }
    #[doc = "Bit 12 - 12:12\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn dis_idle_ext_wrt(&mut self) -> DIS_IDLE_EXT_WRT_W<19> {
        DIS_IDLE_EXT_WRT_W::new(self)
    }
    #[doc = "Bit 20 - 20:20\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn dis_idle_int_wrt(&mut self) -> DIS_IDLE_INT_WRT_W<27> {
        DIS_IDLE_INT_WRT_W::new(self)
    }
    #[doc = "Bit 28 - 28:28\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
