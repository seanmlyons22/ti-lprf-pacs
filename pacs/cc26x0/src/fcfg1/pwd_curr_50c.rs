...
pub struct R(crate::R<PWD_CURR_50C_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PWD_CURR_50C_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PWD_CURR_50C_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PWD_CURR_50C_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PWD_CURR_50C` writer"]
pub struct W(crate::W<PWD_CURR_50C_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PWD_CURR_50C_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PWD_CURR_50C_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PWD_CURR_50C_SPEC>) -> Self {
        W(writer)
    }
}
...
Worst-case baseline maximum powerdown current, in units of 0.5uA"]
pub type BASELINE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PWD_CURR_50C_SPEC, u8, u8, 8, O>;
...
pub type DELTA_XOSC_LPM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PWD_CURR_50C_SPEC, u8, u8, 8, O>;
...
#[doc = "Power Down Current Control 50C\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwd_curr_50c](index.html) module"]
pub struct PWD_CURR_50C_SPEC;
impl crate::RegisterSpec for PWD_CURR_50C_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pwd_curr_50c::R](R) reader structure"]
impl crate::Readable for PWD_CURR_50C_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pwd_curr_50c::W](W) writer structure"]
impl crate::Writable for PWD_CURR_50C_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PWD_CURR_50C to value 0x1218_a20d"]
impl crate::Resettable for PWD_CURR_50C_SPEC {
    const RESET_VALUE: Self::Ux = 0x1218_a20d;
}
