...
pub struct R(crate::R<GPT3BCAPTSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPT3BCAPTSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPT3BCAPTSEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPT3BCAPTSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPT3BCAPTSEL` writer"]
pub struct W(crate::W<GPT3BCAPTSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPT3BCAPTSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPT3BCAPTSEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPT3BCAPTSEL_SPEC>) -> Self {
        W(writer)
    }
}
...
Read/write selection value Writing any other value than values defined by a ENUM may result in undefined behavior."]
pub type EV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPT3BCAPTSEL_SPEC, u8, EV_A, 7, O>;
...
#[doc = "Output Selection for GPT3 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpt3bcaptsel](index.html) module"]
pub struct GPT3BCAPTSEL_SPEC;
impl crate::RegisterSpec for GPT3BCAPTSEL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpt3bcaptsel::R](R) reader structure"]
impl crate::Readable for GPT3BCAPTSEL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpt3bcaptsel::W](W) writer structure"]
impl crate::Writable for GPT3BCAPTSEL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPT3BCAPTSEL to value 0x5c"]
impl crate::Resettable for GPT3BCAPTSEL_SPEC {
    const RESET_VALUE: Self::Ux = 0x5c;
}
