...
pub struct R(crate::R<UDMACH11BSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UDMACH11BSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UDMACH11BSEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UDMACH11BSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UDMACH11BSEL` writer"]
pub struct W(crate::W<UDMACH11BSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UDMACH11BSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UDMACH11BSEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UDMACH11BSEL_SPEC>) -> Self {
        W(writer)
    }
}
...
Read/write selection value Writing any other value than values defined by a ENUM may result in undefined behavior."]
pub type EV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, UDMACH11BSEL_SPEC, u8, EV_A, 7, O>;
