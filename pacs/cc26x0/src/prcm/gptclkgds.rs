...
pub type R = crate::R<GptclkgdsSpec>;
#[doc = "Register `GPTCLKGDS` writer"]
pub type W = crate::W<GptclkgdsSpec>;
#[doc = "3:0\\]
...
Each bit below has the following meaning: 0: Disable clock 1: Enable clock ENUMs can be combined For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    #[inline(always)]
    #[must_use]
    pub fn clk_en(&mut self) -> ClkEnW<GptclkgdsSpec> {
        ClkEnW::new(self, 0)
    }
    #[doc = "Bits 4:31 - 31:4\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved4(&mut self) -> Reserved4W<GptclkgdsSpec> {
        Reserved4W::new(self, 4)
    }
}
#[doc = "GPT Clock Gate For Deep Sleep Mode\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gptclkgds::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gptclkgds::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GptclkgdsSpec;
impl crate::RegisterSpec for GptclkgdsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gptclkgds::R`](R) reader structure"]
impl crate::Readable for GptclkgdsSpec {}
#[doc = "`write(|w| ..)` method takes [`gptclkgds::W`](W) writer structure"]
impl crate::Writable for GptclkgdsSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPTCLKGDS to value 0"]
impl crate::Resettable for GptclkgdsSpec {
