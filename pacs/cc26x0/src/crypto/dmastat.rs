...
pub type CH0_ACTIVE_R = crate::BitReader<bool>;
#[doc = "Field `CH0_ACTIVE` writer - 0:0\\]
This register field indicates if DMA channel 0 is active or not. 0: Not active 1: Active"]
pub type CH0_ACTIVE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTAT_SPEC, bool, O>;
#[doc = "Field `CH1_ACTIVE` reader - 1:1\\]
This register field indicates if DMA channel 1 is active or not. 0: Not active 1: Active"]
pub type CH1_ACTIVE_R = crate::BitReader<bool>;
#[doc = "Field `CH1_ACTIVE` writer - 1:1\\]
This register field indicates if DMA channel 1 is active or not. 0: Not active 1: Active"]
pub type CH1_ACTIVE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTAT_SPEC, bool, O>;
...
This register field indicates if DMA channel 0 is active or not. 0: Not active 1: Active"]
    ...
    pub fn ch0_active(&self) -> CH0_ACTIVE_R {
        CH0_ACTIVE_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - 1:1\\]
This register field indicates if DMA channel 1 is active or not. 0: Not active 1: Active"]
    #[inline(always)]
    pub fn ch1_active(&self) -> CH1_ACTIVE_R {
        CH1_ACTIVE_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bits 2:16 - 16:2\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
...
This register field indicates if DMA channel 0 is active or not. 0: Not active 1: Active"]
    #[inline(always)]
    #[must_use]
    pub fn ch0_active(&mut self) -> CH0_ACTIVE_W<0> {
        CH0_ACTIVE_W::new(self)
    }
    #[doc = "Bit 1 - 1:1\\]
This register field indicates if DMA channel 1 is active or not. 0: Not active 1: Active"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_active(&mut self) -> CH1_ACTIVE_W<1> {
        CH1_ACTIVE_W::new(self)
    }
    #[doc = "Bits 2:16 - 16:2\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
