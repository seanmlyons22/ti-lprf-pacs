...
pub type ACC_EP_R = crate::FieldReader<u16, u16>;
#[doc = "Field `ACC_EP` writer - 15:0\\]
Internal. Only to be used through TI provided API."]
pub type ACC_EP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FSM_ACC_EP_SPEC, u16, u16, 16, O>;
...
pub type RESERVED16_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FSM_ACC_EP_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - 15:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn acc_ep(&mut self) -> ACC_EP_W<0> {
        ACC_EP_W::new(self)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Internal. Only to be used through TI provided API."]
