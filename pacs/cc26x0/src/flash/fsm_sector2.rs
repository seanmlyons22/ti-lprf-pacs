...
pub type FSM_SECTOR2_R = crate::FieldReader<u32, u32>;
#[doc = "Field `FSM_SECTOR2` writer - 31:0\\]
Internal. Only to be used through TI provided API."]
pub type FSM_SECTOR2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FSM_SECTOR2_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn fsm_sector2(&self) -> FSM_SECTOR2_R {
        FSM_SECTOR2_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn fsm_sector2(&mut self) -> FSM_SECTOR2_W<0> {
        FSM_SECTOR2_W::new(self)
    }
