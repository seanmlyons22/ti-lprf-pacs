...
pub type EFUSE_CRC_ERROR_R = crate::BitReader<bool>;
#[doc = "Field `EFUSE_CRC_ERROR` writer - 13:13\\]
Efuse scanning resulted in scan chain CRC error. 0 : No CRC error 1 : CRC Error"]
pub type EFUSE_CRC_ERROR_W<'a, const O: u8> = crate::BitWriter<'a, u32, STAT_SPEC, bool, O>;
...
Efuse scanning resulted in scan chain CRC error. 0 : No CRC error 1 : CRC Error"]
    ...
    pub fn efuse_crc_error(&self) -> EFUSE_CRC_ERROR_R {
        EFUSE_CRC_ERROR_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - 14:14\\]
Efuse scanning resulted in timeout error. 0 : No Timeout error 1 : Timeout Error"]
    #[inline(always)]
...
Efuse scanning resulted in scan chain CRC error. 0 : No CRC error 1 : CRC Error"]
    #[inline(always)]
    #[must_use]
    pub fn efuse_crc_error(&mut self) -> EFUSE_CRC_ERROR_W<13> {
        EFUSE_CRC_ERROR_W::new(self)
    }
    #[doc = "Bit 14 - 14:14\\]
Efuse scanning resulted in timeout error. 0 : No Timeout error 1 : Timeout Error"]
    #[inline(always)]
