...
pub struct R(crate::R<IRQFLAGCLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IRQFLAGCLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IRQFLAGCLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IRQFLAGCLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IRQFLAGCLR` writer"]
pub struct W(crate::W<IRQFLAGCLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IRQFLAGCLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IRQFLAGCLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IRQFLAGCLR_SPEC>) -> Self {
        W(writer)
    }
}
...
1: Clear IRQFLAGSTAT.RDY."]
pub type RDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, IRQFLAGCLR_SPEC, bool, O>;
...
1: Clear IRQFLAGSTAT.SHUTDOWN_OVF."]
pub type SHUTDOWN_OVF_W<'a, const O: u8> = crate::BitWriter<'a, u32, IRQFLAGCLR_SPEC, bool, O>;
...
pub type RESERVED2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IRQFLAGCLR_SPEC, u32, u32, 30, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
1: Clear IRQFLAGSTAT.RDY."]
    #[inline(always)]
...
#[doc = "Interrupt Flag Clear\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [irqflagclr](index.html) module"]
pub struct IRQFLAGCLR_SPEC;
impl crate::RegisterSpec for IRQFLAGCLR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [irqflagclr::R](R) reader structure"]
impl crate::Readable for IRQFLAGCLR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [irqflagclr::W](W) writer structure"]
impl crate::Writable for IRQFLAGCLR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IRQFLAGCLR to value 0"]
impl crate::Resettable for IRQFLAGCLR_SPEC {
