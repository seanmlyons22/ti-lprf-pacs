...
impl START_SRC_R {
    ...
    pub fn variant(&self) -> Option<START_SRC_A> {
        match self.bits {
            ...
            62 => Some(START_SRC_A::AUX_TDC_PRE),
            61 => Some(START_SRC_A::AUX_SMPH_AUTOTAKE_DONE),
            60 => Some(START_SRC_A::AUX_ADC_FIFO_NOT_EMPTY),
            59 => Some(START_SRC_A::AUX_ADC_FIFO_ALMOST_FULL),
            58 => Some(START_SRC_A::AUX_ADC_IRQ),
            57 => Some(START_SRC_A::AUX_ADC_DONE),
            ...
            45 => Some(START_SRC_A::MCU_OBSMUX1),
            44 => Some(START_SRC_A::MCU_OBSMUX0),
...
pub type START_SRC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TRIGSRC_SPEC, u8, START_SRC_A, 6, O>;
...
impl STOP_SRC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<STOP_SRC_A> {
        match self.bits {
            63 => Some(STOP_SRC_A::NO_EVENT),
            62 => Some(STOP_SRC_A::AUX_TDC_PRE),
            61 => Some(STOP_SRC_A::AUX_SMPH_AUTOTAKE_DONE),
            60 => Some(STOP_SRC_A::AUX_ADC_FIFO_NOT_EMPTY),
            59 => Some(STOP_SRC_A::AUX_ADC_FIFO_ALMOST_FULL),
            58 => Some(STOP_SRC_A::AUX_ADC_IRQ),
            57 => Some(STOP_SRC_A::AUX_ADC_DONE),
            56 => Some(STOP_SRC_A::AUX_ISRC_RESET_N),
            55 => Some(STOP_SRC_A::AUX_TDC_DONE),
            54 => Some(STOP_SRC_A::AUX_TIMER0_EV),
            53 => Some(STOP_SRC_A::AUX_TIMER1_EV),
            47 => Some(STOP_SRC_A::AUX_COMPB),
            46 => Some(STOP_SRC_A::AUX_COMPA),
            45 => Some(STOP_SRC_A::MCU_OBSMUX1),
            44 => Some(STOP_SRC_A::MCU_OBSMUX0),
            43 => Some(STOP_SRC_A::MCU_EV),
            42 => Some(STOP_SRC_A::ACLK_REF),
            41 => Some(STOP_SRC_A::VDDR_RECHARGE),
            40 => Some(STOP_SRC_A::MCU_ACTIVE),
            39 => Some(STOP_SRC_A::PWR_DWN),
            38 => Some(STOP_SRC_A::SCLK_LF),
            35 => Some(STOP_SRC_A::AON_RTC_4KHZ),
            34 => Some(STOP_SRC_A::AON_RTC_CH2_DLY),
            33 => Some(STOP_SRC_A::AON_RTC_CH2),
            32 => Some(STOP_SRC_A::MANUAL_EV),
            31 => Some(STOP_SRC_A::AUXIO31),
            30 => Some(STOP_SRC_A::AUXIO30),
            29 => Some(STOP_SRC_A::AUXIO29),
            28 => Some(STOP_SRC_A::AUXIO28),
            27 => Some(STOP_SRC_A::AUXIO27),
            26 => Some(STOP_SRC_A::AUXIO26),
            25 => Some(STOP_SRC_A::AUXIO25),
            24 => Some(STOP_SRC_A::AUXIO24),
            23 => Some(STOP_SRC_A::AUXIO23),
            22 => Some(STOP_SRC_A::AUXIO22),
            21 => Some(STOP_SRC_A::AUXIO21),
            20 => Some(STOP_SRC_A::AUXIO20),
            19 => Some(STOP_SRC_A::AUXIO19),
            18 => Some(STOP_SRC_A::AUXIO18),
            17 => Some(STOP_SRC_A::AUXIO17),
            16 => Some(STOP_SRC_A::AUXIO16),
            15 => Some(STOP_SRC_A::AUXIO15),
            14 => Some(STOP_SRC_A::AUXIO14),
            13 => Some(STOP_SRC_A::AUXIO13),
            12 => Some(STOP_SRC_A::AUXIO12),
            11 => Some(STOP_SRC_A::AUXIO11),
            10 => Some(STOP_SRC_A::AUXIO10),
            9 => Some(STOP_SRC_A::AUXIO9),
            8 => Some(STOP_SRC_A::AUXIO8),
            7 => Some(STOP_SRC_A::AUXIO7),
            6 => Some(STOP_SRC_A::AUXIO6),
            5 => Some(STOP_SRC_A::AUXIO5),
            4 => Some(STOP_SRC_A::AUXIO4),
            3 => Some(STOP_SRC_A::AUXIO3),
            2 => Some(STOP_SRC_A::AUXIO2),
            1 => Some(STOP_SRC_A::AUXIO1),
            0 => Some(STOP_SRC_A::AUXIO0),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `NO_EVENT`"]
...
pub type STOP_SRC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TRIGSRC_SPEC, u8, STOP_SRC_A, 6, O>;
