...
impl StartSrcR {
    ...
    pub const fn variant(&self) -> Option<StartSrc> {
        match self.bits {
            ...
            62 => Some(StartSrc::AuxTdcPre),
            61 => Some(StartSrc::AuxSmphAutotakeDone),
            60 => Some(StartSrc::AuxAdcFifoNotEmpty),
            59 => Some(StartSrc::AuxAdcFifoAlmostFull),
            58 => Some(StartSrc::AuxAdcIrq),
            57 => Some(StartSrc::AuxAdcDone),
            ...
            45 => Some(StartSrc::McuObsmux1),
            44 => Some(StartSrc::McuObsmux0),
...
impl StopSrcR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<StopSrc> {
        match self.bits {
            63 => Some(StopSrc::NoEvent),
            62 => Some(StopSrc::AuxTdcPre),
            61 => Some(StopSrc::AuxSmphAutotakeDone),
            60 => Some(StopSrc::AuxAdcFifoNotEmpty),
            59 => Some(StopSrc::AuxAdcFifoAlmostFull),
            58 => Some(StopSrc::AuxAdcIrq),
            57 => Some(StopSrc::AuxAdcDone),
            56 => Some(StopSrc::AuxIsrcResetN),
            55 => Some(StopSrc::AuxTdcDone),
            54 => Some(StopSrc::AuxTimer0Ev),
            53 => Some(StopSrc::AuxTimer1Ev),
            47 => Some(StopSrc::AuxCompb),
            46 => Some(StopSrc::AuxCompa),
            45 => Some(StopSrc::McuObsmux1),
            44 => Some(StopSrc::McuObsmux0),
            43 => Some(StopSrc::McuEv),
            42 => Some(StopSrc::AclkRef),
            41 => Some(StopSrc::VddrRecharge),
            40 => Some(StopSrc::McuActive),
            39 => Some(StopSrc::PwrDwn),
            38 => Some(StopSrc::SclkLf),
            35 => Some(StopSrc::AonRtc4khz),
            34 => Some(StopSrc::AonRtcCh2Dly),
            33 => Some(StopSrc::AonRtcCh2),
            32 => Some(StopSrc::ManualEv),
            31 => Some(StopSrc::Auxio31),
            30 => Some(StopSrc::Auxio30),
            29 => Some(StopSrc::Auxio29),
            28 => Some(StopSrc::Auxio28),
            27 => Some(StopSrc::Auxio27),
            26 => Some(StopSrc::Auxio26),
            25 => Some(StopSrc::Auxio25),
            24 => Some(StopSrc::Auxio24),
            23 => Some(StopSrc::Auxio23),
            22 => Some(StopSrc::Auxio22),
            21 => Some(StopSrc::Auxio21),
            20 => Some(StopSrc::Auxio20),
            19 => Some(StopSrc::Auxio19),
            18 => Some(StopSrc::Auxio18),
            17 => Some(StopSrc::Auxio17),
            16 => Some(StopSrc::Auxio16),
            15 => Some(StopSrc::Auxio15),
            14 => Some(StopSrc::Auxio14),
            13 => Some(StopSrc::Auxio13),
            12 => Some(StopSrc::Auxio12),
            11 => Some(StopSrc::Auxio11),
            10 => Some(StopSrc::Auxio10),
            9 => Some(StopSrc::Auxio9),
            8 => Some(StopSrc::Auxio8),
            7 => Some(StopSrc::Auxio7),
            6 => Some(StopSrc::Auxio6),
            5 => Some(StopSrc::Auxio5),
            4 => Some(StopSrc::Auxio4),
            3 => Some(StopSrc::Auxio3),
            2 => Some(StopSrc::Auxio2),
            1 => Some(StopSrc::Auxio1),
            0 => Some(StopSrc::Auxio0),
            _ => None,
        }
    }
    #[doc = "No event."]
...
Select stop source from the asynchronous AUX event bus. Change only while STAT.STATE is IDLE."]
pub type StopSrcW<'a, REG> = crate::FieldWriter<'a, REG, 6, StopSrc>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved7(&mut self) -> Reserved7W<TrigsrcSpec> {
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved15(&mut self) -> Reserved15W<TrigsrcSpec> {
