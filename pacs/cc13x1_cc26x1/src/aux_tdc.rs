...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn precntr(&self) -> &Precntr {
        &self.precntr
    }
}
...
pub mod prectl;
#[doc = "PRECNTR (rw) register accessor: Prescaler Counter\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`precntr::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`precntr::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@precntr`]
module"]
#[doc(alias = "PRECNTR")]
pub type Precntr = crate::Reg<precntr::PrecntrSpec>;
