...
Internal. Only to be used through TI provided API."]
    ...
    pub fn rfc_mdm_demiqmc0_trimcomplete_n(
        &mut self,
    ) -> RfcMdmDemiqmc0TrimcompleteNW<ConfigSynthDiv15Spec> {
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn min_allowed_rtrim(&mut self) -> MinAllowedRtrimW<ConfigSynthDiv15Spec> {
...
#[doc = "`reset()` method sets CONFIG_SYNTH_DIV15 to value 0x1f"]
