...
Internal. Only to be used through TI provided API."]
pub type DisNoiseFilterR = crate::BitReader;
#[doc = "Field `DIS_NOISE_FILTER` writer - 9:9\\]
Internal. Only to be used through TI provided API."]
pub type DisNoiseFilterW<'a, REG> = crate::BitWriter<'a, REG>;
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn dis_noise_filter(&self) -> DisNoiseFilterR {
        DisNoiseFilterR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bits 10:31 - 31:10\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn reserved9(&self) -> Reserved9R {
        Reserved9R::new((self.bits >> 10) & 0x003f_ffff)
    }
}
impl W {
    #[doc = "Bits 0:3 - 3:0\\]
