...
AUX operational mode acknowledgement."]
pub type AckW<'a, REG> = crate::FieldWriter<'a, REG, 2, Ack, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn pdlp(self) -> &'a mut crate::W<REG> {
        self.variant(Ack::Pdlp)
    }
    #[doc = "Powerdown operational mode with wakeup to active mode is acknowledged."]
    #[inline(always)]
    pub fn pda(self) -> &'a mut crate::W<REG> {
        self.variant(Ack::Pda)
    }
    #[doc = "Lowpower operational mode is acknowledged."]
    #[inline(always)]
...
AUX operational mode acknowledgement."]
    #[inline(always)]
    #[must_use]
    pub fn ack(&mut self) -> AckW<OpmodeackSpec> {
        AckW::new(self, 0)
    }
    #[doc = "Bits 2:31 - 31:2\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved2(&mut self) -> Reserved2W<OpmodeackSpec> {
