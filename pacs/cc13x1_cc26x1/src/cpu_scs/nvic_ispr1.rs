...
pub type SETPEND34_R = crate::BitReader<bool>;
#[doc = "Field `SETPEND34` writer - 2:2\\]
Writing 0 to this bit has no effect, writing 1 to this bit pends the interrupt number 34 (See EVENT:CPUIRQSEL34.EV for details). Reading the bit returns its current state."]
pub type SETPEND34_W<'a, const O: u8> = crate::BitWriter<'a, u32, NVIC_ISPR1_SPEC, bool, O>;
...
pub type SETPEND35_R = crate::BitReader<bool>;
#[doc = "Field `SETPEND35` writer - 3:3\\]
Writing 0 to this bit has no effect, writing 1 to this bit pends the interrupt number 35 (See EVENT:CPUIRQSEL35.EV for details). Reading the bit returns its current state."]
pub type SETPEND35_W<'a, const O: u8> = crate::BitWriter<'a, u32, NVIC_ISPR1_SPEC, bool, O>;
...
pub type SETPEND36_R = crate::BitReader<bool>;
#[doc = "Field `SETPEND36` writer - 4:4\\]
Writing 0 to this bit has no effect, writing 1 to this bit pends the interrupt number 36 (See EVENT:CPUIRQSEL36.EV for details). Reading the bit returns its current state."]
pub type SETPEND36_W<'a, const O: u8> = crate::BitWriter<'a, u32, NVIC_ISPR1_SPEC, bool, O>;
...
pub type SETPEND37_R = crate::BitReader<bool>;
#[doc = "Field `SETPEND37` writer - 5:5\\]
Writing 0 to this bit has no effect, writing 1 to this bit pends the interrupt number 37 (See EVENT:CPUIRQSEL37.EV for details). Reading the bit returns its current state."]
pub type SETPEND37_W<'a, const O: u8> = crate::BitWriter<'a, u32, NVIC_ISPR1_SPEC, bool, O>;
...
pub type RESERVED6_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, NVIC_ISPR1_SPEC, u32, u32, 26, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Writing 0 to this bit has no effect, writing 1 to this bit pends the interrupt number 32 (See EVENT:CPUIRQSEL32.EV for details). Reading the bit returns its current state."]
    #[inline(always)]
...
Writing 0 to this bit has no effect, writing 1 to this bit pends the interrupt number 34 (See EVENT:CPUIRQSEL34.EV for details). Reading the bit returns its current state."]
    ...
    pub fn setpend34(&self) -> SETPEND34_R {
        SETPEND34_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - 3:3\\]
Writing 0 to this bit has no effect, writing 1 to this bit pends the interrupt number 35 (See EVENT:CPUIRQSEL35.EV for details). Reading the bit returns its current state."]
    #[inline(always)]
    pub fn setpend35(&self) -> SETPEND35_R {
        SETPEND35_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Writing 0 to this bit has no effect, writing 1 to this bit pends the interrupt number 36 (See EVENT:CPUIRQSEL36.EV for details). Reading the bit returns its current state."]
    #[inline(always)]
    pub fn setpend36(&self) -> SETPEND36_R {
        SETPEND36_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - 5:5\\]
Writing 0 to this bit has no effect, writing 1 to this bit pends the interrupt number 37 (See EVENT:CPUIRQSEL37.EV for details). Reading the bit returns its current state."]
    #[inline(always)]
    pub fn setpend37(&self) -> SETPEND37_R {
        SETPEND37_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bits 6:31 - 31:6\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
...
Writing 0 to this bit has no effect, writing 1 to this bit pends the interrupt number 34 (See EVENT:CPUIRQSEL34.EV for details). Reading the bit returns its current state."]
    #[inline(always)]
    #[must_use]
    pub fn setpend34(&mut self) -> SETPEND34_W<2> {
        SETPEND34_W::new(self)
    }
    #[doc = "Bit 3 - 3:3\\]
Writing 0 to this bit has no effect, writing 1 to this bit pends the interrupt number 35 (See EVENT:CPUIRQSEL35.EV for details). Reading the bit returns its current state."]
    #[inline(always)]
    #[must_use]
    pub fn setpend35(&mut self) -> SETPEND35_W<3> {
        SETPEND35_W::new(self)
    }
    #[doc = "Bit 4 - 4:4\\]
Writing 0 to this bit has no effect, writing 1 to this bit pends the interrupt number 36 (See EVENT:CPUIRQSEL36.EV for details). Reading the bit returns its current state."]
    #[inline(always)]
    #[must_use]
    pub fn setpend36(&mut self) -> SETPEND36_W<4> {
        SETPEND36_W::new(self)
    }
    #[doc = "Bit 5 - 5:5\\]
Writing 0 to this bit has no effect, writing 1 to this bit pends the interrupt number 37 (See EVENT:CPUIRQSEL37.EV for details). Reading the bit returns its current state."]
    #[inline(always)]
    #[must_use]
    pub fn setpend37(&mut self) -> SETPEND37_W<5> {
        SETPEND37_W::new(self)
    }
    #[doc = "Bits 6:31 - 31:6\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
