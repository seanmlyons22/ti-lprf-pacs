...
AUXIO3 pin level, read value corresponds to AUX_AIODIO0:GPIODIN bit 3."]
    #[inline(always)]
    #[must_use]
    pub fn auxio3(&mut self) -> Auxio3W<Evstat0Spec> {
        Auxio3W::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
AUXIO4 pin level, read value corresponds to AUX_AIODIO0:GPIODIN bit 4."]
    #[inline(always)]
    #[must_use]
    pub fn auxio4(&mut self) -> Auxio4W<Evstat0Spec> {
        Auxio4W::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
AUXIO5 pin level, read value corresponds to AUX_AIODIO0:GPIODIN bit 5."]
    #[inline(always)]
    #[must_use]
    pub fn auxio5(&mut self) -> Auxio5W<Evstat0Spec> {
        Auxio5W::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
AUXIO6 pin level, read value corresponds to AUX_AIODIO0:GPIODIN bit 6."]
    #[inline(always)]
    #[must_use]
    pub fn auxio6(&mut self) -> Auxio6W<Evstat0Spec> {
        Auxio6W::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
AUXIO7 pin level, read value corresponds to AUX_AIODIO0:GPIODIN bit 7."]
    #[inline(always)]
    #[must_use]
    pub fn auxio7(&mut self) -> Auxio7W<Evstat0Spec> {
        Auxio7W::new(self, 7)
    }
    #[doc = "Bit 8 - 8:8\\]
AUXIO8 pin level, read value corresponds to AUX_AIODIO1:GPIODIN bit 0."]
    #[inline(always)]
    #[must_use]
    pub fn auxio8(&mut self) -> Auxio8W<Evstat0Spec> {
        Auxio8W::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
AUXIO9 pin level, read value corresponds to AUX_AIODIO1:GPIODIN bit 1."]
    #[inline(always)]
    #[must_use]
    pub fn auxio9(&mut self) -> Auxio9W<Evstat0Spec> {
        Auxio9W::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
AUXIO10 pin level, read value corresponds to AUX_AIODIO1:GPIODIN bit 2."]
    #[inline(always)]
    #[must_use]
    pub fn auxio10(&mut self) -> Auxio10W<Evstat0Spec> {
        Auxio10W::new(self, 10)
    }
    #[doc = "Bit 11 - 11:11\\]
AUXIO11 pin level, read value corresponds to AUX_AIODIO1:GPIODIN bit 3."]
    #[inline(always)]
    #[must_use]
    pub fn auxio11(&mut self) -> Auxio11W<Evstat0Spec> {
        Auxio11W::new(self, 11)
    }
    #[doc = "Bit 12 - 12:12\\]
AUXIO12 pin level, read value corresponds to AUX_AIODIO1:GPIODIN bit 4."]
    #[inline(always)]
    #[must_use]
    pub fn auxio12(&mut self) -> Auxio12W<Evstat0Spec> {
        Auxio12W::new(self, 12)
    }
    #[doc = "Bit 13 - 13:13\\]
AUXIO13 pin level, read value corresponds to AUX_AIODIO1:GPIODIN bit 5."]
    #[inline(always)]
    #[must_use]
    pub fn auxio13(&mut self) -> Auxio13W<Evstat0Spec> {
        Auxio13W::new(self, 13)
    }
    #[doc = "Bit 14 - 14:14\\]
AUXIO14 pin level, read value corresponds to AUX_AIODIO1:GPIODIN bit 6."]
    #[inline(always)]
    #[must_use]
    pub fn auxio14(&mut self) -> Auxio14W<Evstat0Spec> {
        Auxio14W::new(self, 14)
    }
    #[doc = "Bit 15 - 15:15\\]
AUXIO15 pin level, read value corresponds to AUX_AIODIO1:GPIODIN bit 7."]
    #[inline(always)]
    #[must_use]
    pub fn auxio15(&mut self) -> Auxio15W<Evstat0Spec> {
        Auxio15W::new(self, 15)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved16(&mut self) -> Reserved16W<Evstat0Spec> {
