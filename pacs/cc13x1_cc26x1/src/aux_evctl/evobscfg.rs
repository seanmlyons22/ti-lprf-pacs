...
impl EVOBS_SEL_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<EVOBS_SEL_A> {
        match self.bits {
            62 => Some(EVOBS_SEL_A::AUX_DAC_HOLD_ACTIVE),
            61 => Some(EVOBS_SEL_A::AUX_SMPH_AUTOTAKE_DONE),
            60 => Some(EVOBS_SEL_A::AUX_ADC_FIFO_NOT_EMPTY),
            59 => Some(EVOBS_SEL_A::AUX_ADC_FIFO_ALMOST_FULL),
            58 => Some(EVOBS_SEL_A::AUX_ADC_IRQ),
            57 => Some(EVOBS_SEL_A::AUX_ADC_DONE),
            56 => Some(EVOBS_SEL_A::AUX_ISRC_RESET_N),
            55 => Some(EVOBS_SEL_A::AUX_TDC_DONE),
            54 => Some(EVOBS_SEL_A::AUX_TIMER0_EV),
            53 => Some(EVOBS_SEL_A::AUX_TIMER1_EV),
            47 => Some(EVOBS_SEL_A::AUX_COMPB),
            46 => Some(EVOBS_SEL_A::AUX_COMPA),
            45 => Some(EVOBS_SEL_A::MCU_OBSMUX1),
            44 => Some(EVOBS_SEL_A::MCU_OBSMUX0),
            43 => Some(EVOBS_SEL_A::MCU_EV),
            42 => Some(EVOBS_SEL_A::ACLK_REF),
            41 => Some(EVOBS_SEL_A::VDDR_RECHARGE),
            40 => Some(EVOBS_SEL_A::MCU_ACTIVE),
            39 => Some(EVOBS_SEL_A::PWR_DWN),
            38 => Some(EVOBS_SEL_A::SCLK_LF),
            35 => Some(EVOBS_SEL_A::AON_RTC_4KHZ),
            34 => Some(EVOBS_SEL_A::AON_RTC_CH2_DLY),
            33 => Some(EVOBS_SEL_A::AON_RTC_CH2),
            32 => Some(EVOBS_SEL_A::MANUAL_EV),
            31 => Some(EVOBS_SEL_A::AUXIO31),
            30 => Some(EVOBS_SEL_A::AUXIO30),
            29 => Some(EVOBS_SEL_A::AUXIO29),
            28 => Some(EVOBS_SEL_A::AUXIO28),
            27 => Some(EVOBS_SEL_A::AUXIO27),
            26 => Some(EVOBS_SEL_A::AUXIO26),
            25 => Some(EVOBS_SEL_A::AUXIO25),
            24 => Some(EVOBS_SEL_A::AUXIO24),
            23 => Some(EVOBS_SEL_A::AUXIO23),
            22 => Some(EVOBS_SEL_A::AUXIO22),
            21 => Some(EVOBS_SEL_A::AUXIO21),
            20 => Some(EVOBS_SEL_A::AUXIO20),
            19 => Some(EVOBS_SEL_A::AUXIO19),
            18 => Some(EVOBS_SEL_A::AUXIO18),
            17 => Some(EVOBS_SEL_A::AUXIO17),
            16 => Some(EVOBS_SEL_A::AUXIO16),
            15 => Some(EVOBS_SEL_A::AUXIO15),
            14 => Some(EVOBS_SEL_A::AUXIO14),
            13 => Some(EVOBS_SEL_A::AUXIO13),
            12 => Some(EVOBS_SEL_A::AUXIO12),
            11 => Some(EVOBS_SEL_A::AUXIO11),
            10 => Some(EVOBS_SEL_A::AUXIO10),
            9 => Some(EVOBS_SEL_A::AUXIO9),
            8 => Some(EVOBS_SEL_A::AUXIO8),
            7 => Some(EVOBS_SEL_A::AUXIO7),
            6 => Some(EVOBS_SEL_A::AUXIO6),
            5 => Some(EVOBS_SEL_A::AUXIO5),
            4 => Some(EVOBS_SEL_A::AUXIO4),
            3 => Some(EVOBS_SEL_A::AUXIO3),
            2 => Some(EVOBS_SEL_A::AUXIO2),
            1 => Some(EVOBS_SEL_A::AUXIO1),
            0 => Some(EVOBS_SEL_A::AUXIO0),
            _ => None,
        }
    }
...
pub type EVOBS_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EVOBSCFG_SPEC, u8, EVOBS_SEL_A, 6, O>;
