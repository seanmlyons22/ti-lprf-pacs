...
pub enum RELOAD_A {
    #[doc = "1: Continuous mode. Timer 1 restarts when the counter value becomes equal to or greater than ( T1TARGET.VALUE - 1)."]
    CONT = 1,
    #[doc = "0: Manual mode. Timer 1 stops and T1CTL.EN becomes 0 when the counter value becomes equal to or greater than T1TARGET.VALUE."]
    MAN = 0,
}
...
Timer 1 reload mode."]
pub type RELOAD_W<'a, const O: u8> = crate::BitWriter<'a, u32, T1CFG_SPEC, RELOAD_A, O>;
...
Timer 1 mode. Configure source for Timer 1 prescaler."]
pub type MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, T1CFG_SPEC, MODE_A, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, T1CFG_SPEC, u8, u8, 2, O>;
...
Prescaler division ratio is 2^PRE: 0x0: Divide by 1. 0x1: Divide by 2. 0x2: Divide by 4. ... 0xF: Divide by 32,768."]
pub type PRE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, T1CFG_SPEC, u8, u8, 4, O>;
...
impl TICK_SRC_R {
    ...
    pub fn variant(&self) -> Option<TICK_SRC_A> {
        match self.bits {
            62 => Some(TICK_SRC_A::AUX_DAC_HOLD_ACTIVE),
            61 => Some(TICK_SRC_A::AUX_SMPH_AUTOTAKE_DONE),
            60 => Some(TICK_SRC_A::AUX_ADC_FIFO_NOT_EMPTY),
            59 => Some(TICK_SRC_A::AUX_ADC_FIFO_ALMOST_FULL),
            58 => Some(TICK_SRC_A::AUX_ADC_IRQ),
            57 => Some(TICK_SRC_A::AUX_ADC_DONE),
            56 => Some(TICK_SRC_A::AUX_ISRC_RESET_N),
            55 => Some(TICK_SRC_A::AUX_TDC_DONE),
            54 => Some(TICK_SRC_A::AUX_TIMER0_EV),
            53 => Some(TICK_SRC_A::NO_EVENT),
            47 => Some(TICK_SRC_A::AUX_COMPB),
            46 => Some(TICK_SRC_A::AUX_COMPA),
            45 => Some(TICK_SRC_A::MCU_OBSMUX1),
            44 => Some(TICK_SRC_A::MCU_OBSMUX0),
            43 => Some(TICK_SRC_A::MCU_EV),
            42 => Some(TICK_SRC_A::ACLK_REF),
            41 => Some(TICK_SRC_A::VDDR_RECHARGE),
            40 => Some(TICK_SRC_A::MCU_ACTIVE),
            39 => Some(TICK_SRC_A::PWR_DWN),
            38 => Some(TICK_SRC_A::SCLK_LF),
            35 => Some(TICK_SRC_A::AON_RTC_4KHZ),
            34 => Some(TICK_SRC_A::AON_RTC_CH2_DLY),
            33 => Some(TICK_SRC_A::AON_RTC_CH2),
            32 => Some(TICK_SRC_A::MANUAL_EV),
            31 => Some(TICK_SRC_A::AUXIO31),
            30 => Some(TICK_SRC_A::AUXIO30),
            29 => Some(TICK_SRC_A::AUXIO29),
            28 => Some(TICK_SRC_A::AUXIO28),
            27 => Some(TICK_SRC_A::AUXIO27),
            26 => Some(TICK_SRC_A::AUXIO26),
            25 => Some(TICK_SRC_A::AUXIO25),
            24 => Some(TICK_SRC_A::AUXIO24),
            23 => Some(TICK_SRC_A::AUXIO23),
            22 => Some(TICK_SRC_A::AUXIO22),
            21 => Some(TICK_SRC_A::AUXIO21),
            20 => Some(TICK_SRC_A::AUXIO20),
            19 => Some(TICK_SRC_A::AUXIO19),
            18 => Some(TICK_SRC_A::AUXIO18),
            17 => Some(TICK_SRC_A::AUXIO17),
            16 => Some(TICK_SRC_A::AUXIO16),
            15 => Some(TICK_SRC_A::AUXIO15),
            14 => Some(TICK_SRC_A::AUXIO14),
            13 => Some(TICK_SRC_A::AUXIO13),
            12 => Some(TICK_SRC_A::AUXIO12),
            11 => Some(TICK_SRC_A::AUXIO11),
            10 => Some(TICK_SRC_A::AUXIO10),
            9 => Some(TICK_SRC_A::AUXIO9),
            8 => Some(TICK_SRC_A::AUXIO8),
            7 => Some(TICK_SRC_A::AUXIO7),
            6 => Some(TICK_SRC_A::AUXIO6),
            5 => Some(TICK_SRC_A::AUXIO5),
            4 => Some(TICK_SRC_A::AUXIO4),
            3 => Some(TICK_SRC_A::AUXIO3),
            2 => Some(TICK_SRC_A::AUXIO2),
            1 => Some(TICK_SRC_A::AUXIO1),
            0 => Some(TICK_SRC_A::AUXIO0),
            _ => None,
        }
    }
...
pub type TICK_SRC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, T1CFG_SPEC, u8, TICK_SRC_A, 6, O>;
...
Tick source polarity for Timer 1."]
pub type TICK_SRC_POL_W<'a, const O: u8> = crate::BitWriter<'a, u32, T1CFG_SPEC, TICK_SRC_POL_A, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED15_W<'a, const O: u8> = crate::FieldWriter<'a, u32, T1CFG_SPEC, u32, u32, 17, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Timer 1 reload mode."]
    #[inline(always)]
