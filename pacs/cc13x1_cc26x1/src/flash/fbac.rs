...
Internal. Only to be used through TI provided API."]
pub type OTPPROTDIS_R = crate::BitReader<bool>;
#[doc = "Field `OTPPROTDIS` writer - 16:16\\]
Internal. Only to be used through TI provided API."]
pub type OTPPROTDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, FBAC_SPEC, bool, O>;
#[doc = "Field `RESERVED17` reader - 31:17\\]
Internal. Only to be used through TI provided API."]
pub type RESERVED17_R = crate::FieldReader<u16, u16>;
#[doc = "Field `RESERVED17` writer - 31:17\\]
Internal. Only to be used through TI provided API."]
pub type RESERVED17_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FBAC_SPEC, u16, u16, 15, O>;
impl R {
    #[doc = "Bits 0:7 - 7:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    ...
    pub fn otpprotdis(&self) -> OTPPROTDIS_R {
        OTPPROTDIS_R::new(((self.bits >> 16) & 1) != 0)
    }
