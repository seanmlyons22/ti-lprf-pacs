...
pub type DIS_IDLE_R = crate::BitReader<bool>;
#[doc = "Field `DIS_IDLE` writer - 0:0\\]
Internal. Only to be used through TI provided API."]
pub type DIS_IDLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG_SPEC, bool, O>;
...
Internal. Only to be used through TI provided API."]
pub type RESERVED9_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFG_SPEC, u32, u32, 23, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn dis_idle(&self) -> DIS_IDLE_R {
        DIS_IDLE_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn dis_idle(&mut self) -> DIS_IDLE_W<0> {
        DIS_IDLE_W::new(self)
    }
    #[doc = "Bit 1 - 1:1\\]
Internal. Only to be used through TI provided API."]
