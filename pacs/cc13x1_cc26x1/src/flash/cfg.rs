...
pub type DisIdleR = crate::BitReader;
#[doc = "Field `DIS_IDLE` writer - 0:0\\]
Internal. Only to be used through TI provided API."]
pub type DisIdleW<'a, REG> = crate::BitWriter<'a, REG>;
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn dis_idle(&self) -> DisIdleR {
        DisIdleR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn dis_idle(&mut self) -> DisIdleW<CfgSpec> {
        DisIdleW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Internal. Only to be used through TI provided API."]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn reserved9(&mut self) -> Reserved9W<CfgSpec> {
