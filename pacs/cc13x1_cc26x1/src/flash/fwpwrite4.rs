...
pub type FWPWRITE4_R = crate::FieldReader<u32, u32>;
#[doc = "Field `FWPWRITE4` writer - 31:0\\]
Internal. Only to be used through TI provided API."]
pub type FWPWRITE4_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FWPWRITE4_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn fwpwrite4(&self) -> FWPWRITE4_R {
        FWPWRITE4_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn fwpwrite4(&mut self) -> FWPWRITE4_W<0> {
        FWPWRITE4_W::new(self)
    }
