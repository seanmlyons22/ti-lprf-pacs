#[doc = "Register `UDMACH11SSEL` reader"]
pub struct R(crate::R<UDMACH11SSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UDMACH11SSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UDMACH11SSEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UDMACH11SSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UDMACH11SSEL` writer"]
pub struct W(crate::W<UDMACH11SSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UDMACH11SSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UDMACH11SSEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UDMACH11SSEL_SPEC>) -> Self {
        W(writer)
    }
}
...
impl EV_R {
    ...
    #[doc = "Checks if the value of the field is `TIE_LOW71`"]
    #[inline(always)]
    pub fn is_tie_low71(&self) -> bool {
        *self == EV_A::TIE_LOW71
    }
...
Read/write selection value Writing any other value than values defined by a ENUM may result in undefined behavior."]
pub type EV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, UDMACH11SSEL_SPEC, u8, EV_A, 7, O>;
impl<'a, const O: u8> EV_W<'a, O> {
    ...
    #[inline(always)]
    pub fn tie_low71(self) -> &'a mut W {
        self.variant(EV_A::TIE_LOW71)
    }
    #[doc = "Always inactive"]
    #[inline(always)]
...
#[doc = "Output Selection for DMA Channel 11 SREQ DMA_DONE for the corresponding DMA channel is available as interrupt on GPT1 as GPT1:RIS.DMAARIS\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [udmach11ssel](index.html) module"]
pub struct UDMACH11SSEL_SPEC;
impl crate::RegisterSpec for UDMACH11SSEL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [udmach11ssel::R](R) reader structure"]
impl crate::Readable for UDMACH11SSEL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [udmach11ssel::W](W) writer structure"]
impl crate::Writable for UDMACH11SSEL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UDMACH11SSEL to value 0x47"]
impl crate::Resettable for UDMACH11SSEL_SPEC {
    const RESET_VALUE: Self::Ux = 0x47;
}
