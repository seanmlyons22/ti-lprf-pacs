...
pub type R = crate::R<Udmach11sselSpec>;
#[doc = "Register `UDMACH11SSEL` writer"]
pub type W = crate::W<Udmach11sselSpec>;
#[doc = "6:0\\]
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Not used tied to 0"]
    #[inline(always)]
    pub fn tie_low71(self) -> &'a mut crate::W<REG> {
        self.variant(Ev::TieLow71)
    }
    #[doc = "Always inactive"]
    #[inline(always)]
...
Read/write selection value Writing any other value than values defined by a ENUM may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn ev(&mut self) -> EvW<Udmach11sselSpec> {
        EvW::new(self, 0)
    }
}
#[doc = "Output Selection for DMA Channel 11 SREQ DMA_DONE for the corresponding DMA channel is available as interrupt on GPT1 as GPT1:RIS.DMAARIS\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`udmach11ssel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`udmach11ssel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Udmach11sselSpec;
impl crate::RegisterSpec for Udmach11sselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`udmach11ssel::R`](R) reader structure"]
impl crate::Readable for Udmach11sselSpec {}
#[doc = "`write(|w| ..)` method takes [`udmach11ssel::W`](W) writer structure"]
impl crate::Writable for Udmach11sselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets UDMACH11SSEL to value 0x47"]
impl crate::Resettable for Udmach11sselSpec {
