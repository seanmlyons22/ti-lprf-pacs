...
impl EV_R {
    ...
    pub fn variant(&self) -> Option<EV_A> {
        match self.bits {
            35 => Some(EV_A::TIE_LOW35),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `TIE_LOW35`"]
    #[inline(always)]
    pub fn is_tie_low35(&self) -> bool {
        *self == EV_A::TIE_LOW35
    }
}
#[doc = "Field `EV` writer - 6:0\\]
Read only selection value"]
pub type EV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CPUIRQSEL8_SPEC, u8, EV_A, 7, O>;
impl<'a, const O: u8> EV_W<'a, O> {
    #[doc = "Not used tied to 0"]
    #[inline(always)]
    pub fn tie_low35(self) -> &'a mut W {
        self.variant(EV_A::TIE_LOW35)
    }
}
impl R {
    #[doc = "Bits 0:6 - 6:0\\]
