...
impl EV_R {
    ...
    pub fn variant(&self) -> Option<EV_A> {
        match self.bits {
            52 => Some(EV_A::TIE_LOW52),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `TIE_LOW52`"]
    #[inline(always)]
    pub fn is_tie_low52(&self) -> bool {
        *self == EV_A::TIE_LOW52
    }
}
#[doc = "Field `EV` writer - 6:0\\]
Read only selection value"]
pub type EV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, UDMACH5BSEL_SPEC, u8, EV_A, 7, O>;
impl<'a, const O: u8> EV_W<'a, O> {
    #[doc = "Not used tied to 0"]
    #[inline(always)]
    pub fn tie_low52(self) -> &'a mut W {
        self.variant(EV_A::TIE_LOW52)
    }
}
impl R {
    #[doc = "Bits 0:6 - 6:0\\]
