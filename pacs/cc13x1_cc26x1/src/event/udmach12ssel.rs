...
pub type R = crate::R<Udmach12sselSpec>;
#[doc = "Register `UDMACH12SSEL` writer"]
pub type W = crate::W<Udmach12sselSpec>;
#[doc = "6:0\\]
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Not used tied to 0"]
    #[inline(always)]
    pub fn tie_low72(self) -> &'a mut crate::W<REG> {
        self.variant(Ev::TieLow72)
    }
    #[doc = "Always inactive"]
    #[inline(always)]
...
Read/write selection value Writing any other value than values defined by a ENUM may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn ev(&mut self) -> EvW<Udmach12sselSpec> {
        EvW::new(self, 0)
    }
}
#[doc = "Output Selection for DMA Channel 12 SREQ DMA_DONE for the corresponding DMA channel is available as interrupt on GPT1 as GPT1:RIS.DMABRIS\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`udmach12ssel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`udmach12ssel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Udmach12sselSpec;
impl crate::RegisterSpec for Udmach12sselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`udmach12ssel::R`](R) reader structure"]
impl crate::Readable for Udmach12sselSpec {}
#[doc = "`write(|w| ..)` method takes [`udmach12ssel::W`](W) writer structure"]
impl crate::Writable for Udmach12sselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets UDMACH12SSEL to value 0x48"]
impl crate::Resettable for Udmach12sselSpec {
