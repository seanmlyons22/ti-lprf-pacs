...
pub struct R(crate::R<UDMACH10SSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UDMACH10SSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UDMACH10SSEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UDMACH10SSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UDMACH10SSEL` writer"]
pub struct W(crate::W<UDMACH10SSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UDMACH10SSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UDMACH10SSEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UDMACH10SSEL_SPEC>) -> Self {
        W(writer)
    }
}
...
impl EV_R {
    ...
    #[doc = "Checks if the value of the field is `TIE_LOW70`"]
    #[inline(always)]
    pub fn is_tie_low70(&self) -> bool {
        *self == EV_A::TIE_LOW70
    }
...
Read/write selection value Writing any other value than values defined by a ENUM may result in undefined behavior."]
pub type EV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, UDMACH10SSEL_SPEC, u8, EV_A, 7, O>;
impl<'a, const O: u8> EV_W<'a, O> {
    ...
    #[inline(always)]
    pub fn tie_low70(self) -> &'a mut W {
        self.variant(EV_A::TIE_LOW70)
    }
    #[doc = "Always inactive"]
    #[inline(always)]
