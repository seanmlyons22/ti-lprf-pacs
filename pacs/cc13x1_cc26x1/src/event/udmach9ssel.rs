...
pub type R = crate::R<Udmach9sselSpec>;
#[doc = "Register `UDMACH9SSEL` writer"]
pub type W = crate::W<Udmach9sselSpec>;
#[doc = "6:0\\]
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Not used tied to 0"]
    #[inline(always)]
    pub fn tie_low69(self) -> &'a mut crate::W<REG> {
        self.variant(Ev::TieLow69)
    }
    #[doc = "Always inactive"]
    #[inline(always)]
...
Read/write selection value Writing any other value than values defined by a ENUM may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn ev(&mut self) -> EvW<Udmach9sselSpec> {
        EvW::new(self, 0)
    }
}
#[doc = "Output Selection for DMA Channel 9 SREQ DMA_DONE for the corresponding DMA channel is available as interrupt on GPT0 as GPT0:RIS.DMAARIS\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`udmach9ssel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`udmach9ssel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Udmach9sselSpec;
impl crate::RegisterSpec for Udmach9sselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`udmach9ssel::R`](R) reader structure"]
impl crate::Readable for Udmach9sselSpec {}
#[doc = "`write(|w| ..)` method takes [`udmach9ssel::W`](W) writer structure"]
impl crate::Writable for Udmach9sselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets UDMACH9SSEL to value 0x45"]
impl crate::Resettable for Udmach9sselSpec {
