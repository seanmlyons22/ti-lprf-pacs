...
impl EV_R {
    ...
    pub fn variant(&self) -> Option<EV_A> {
        match self.bits {
            44 => Some(EV_A::TIE_LOW44),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `TIE_LOW44`"]
    #[inline(always)]
    pub fn is_tie_low44(&self) -> bool {
        *self == EV_A::TIE_LOW44
    }
}
...
impl<'a, const O: u8> EV_W<'a, O> {
    ...
    #[inline(always)]
    pub fn tie_low44(self) -> &'a mut W {
        self.variant(EV_A::TIE_LOW44)
    }
}
impl R {
    #[doc = "Bits 0:6 - 6:0\\]
