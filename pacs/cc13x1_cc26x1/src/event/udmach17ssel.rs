...
impl EV_R {
    ...
    pub fn variant(&self) -> Option<EV_A> {
        match self.bits {
            47 => Some(EV_A::TIE_LOW47),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `TIE_LOW47`"]
    #[inline(always)]
    pub fn is_tie_low47(&self) -> bool {
        *self == EV_A::TIE_LOW47
    }
}
...
impl<'a, const O: u8> EV_W<'a, O> {
    ...
    #[inline(always)]
    pub fn tie_low47(self) -> &'a mut W {
        self.variant(EV_A::TIE_LOW47)
    }
}
impl R {
    #[doc = "Bits 0:6 - 6:0\\]
