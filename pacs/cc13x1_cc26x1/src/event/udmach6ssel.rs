...
impl EV_R {
    ...
    pub fn variant(&self) -> Option<EV_A> {
        match self.bits {
            55 => Some(EV_A::TIE_LOW55),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `TIE_LOW55`"]
    #[inline(always)]
...
Read only selection value"]
pub type EV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, UDMACH6SSEL_SPEC, u8, EV_A, 7, O>;
impl<'a, const O: u8> EV_W<'a, O> {
    #[doc = "Not used tied to 0"]
    #[inline(always)]
    pub fn tie_low55(self) -> &'a mut W {
        self.variant(EV_A::TIE_LOW55)
    }
}
impl R {
    #[doc = "Bits 0:6 - 6:0\\]
