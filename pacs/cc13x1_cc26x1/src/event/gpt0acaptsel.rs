...
pub type R = crate::R<Gpt0acaptselSpec>;
#[doc = "Register `GPT0ACAPTSEL` writer"]
pub type W = crate::W<Gpt0acaptselSpec>;
#[doc = "6:0\\]
...
Read/write selection value Writing any other value than values defined by a ENUM may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn ev(&mut self) -> EvW<Gpt0acaptselSpec> {
        EvW::new(self, 0)
    }
}
#[doc = "Output Selection for GPT0 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpt0acaptsel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpt0acaptsel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpt0acaptselSpec;
impl crate::RegisterSpec for Gpt0acaptselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpt0acaptsel::R`](R) reader structure"]
impl crate::Readable for Gpt0acaptselSpec {}
#[doc = "`write(|w| ..)` method takes [`gpt0acaptsel::W`](W) writer structure"]
impl crate::Writable for Gpt0acaptselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPT0ACAPTSEL to value 0x55"]
impl crate::Resettable for Gpt0acaptselSpec {
