#[doc = "Register `GPT0ACAPTSEL` reader"]
pub struct R(crate::R<GPT0ACAPTSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPT0ACAPTSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPT0ACAPTSEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPT0ACAPTSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPT0ACAPTSEL` writer"]
pub struct W(crate::W<GPT0ACAPTSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPT0ACAPTSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPT0ACAPTSEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPT0ACAPTSEL_SPEC>) -> Self {
        W(writer)
    }
}
...
Read/write selection value Writing any other value than values defined by a ENUM may result in undefined behavior."]
pub type EV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPT0ACAPTSEL_SPEC, u8, EV_A, 7, O>;
...
#[doc = "Output Selection for GPT0 0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpt0acaptsel](index.html) module"]
pub struct GPT0ACAPTSEL_SPEC;
impl crate::RegisterSpec for GPT0ACAPTSEL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpt0acaptsel::R](R) reader structure"]
impl crate::Readable for GPT0ACAPTSEL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpt0acaptsel::W](W) writer structure"]
impl crate::Writable for GPT0ACAPTSEL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPT0ACAPTSEL to value 0x55"]
impl crate::Resettable for GPT0ACAPTSEL_SPEC {
