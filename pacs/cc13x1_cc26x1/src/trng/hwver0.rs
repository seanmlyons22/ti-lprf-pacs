...
Bit-by-bit logic complement of bits \\[7:0\\]. This TRNG gives 0xB4."]
pub type EipNumComplW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
8 bits binary encoding of the module number. This TRNG gives 0x4B."]
    #[inline(always)]
    #[must_use]
    pub fn eip_num(&mut self) -> EipNumW<Hwver0Spec> {
        EipNumW::new(self, 0)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Bit-by-bit logic complement of bits \\[7:0\\]. This TRNG gives 0xB4."]
    #[inline(always)]
    #[must_use]
    pub fn eip_num_compl(&mut self) -> EipNumComplW<Hwver0Spec> {
        EipNumComplW::new(self, 8)
    }
    #[doc = "Bits 16:19 - 19:16\\]
4 bits binary encoding of the hardware patch level, initial release will carry value zero."]
    #[inline(always)]
    #[must_use]
    pub fn hw_patch_lvl(&mut self) -> HwPatchLvlW<Hwver0Spec> {
...
4 bits binary encoding of the minor hardware revision number."]
    #[inline(always)]
    #[must_use]
    pub fn hw_minor_ver(&mut self) -> HwMinorVerW<Hwver0Spec> {
...
4 bits binary encoding of the major hardware revision number."]
    #[inline(always)]
    #[must_use]
    pub fn hw_major_ver(&mut self) -> HwMajorVerW<Hwver0Spec> {
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved28(&mut self) -> Reserved28W<Hwver0Spec> {
