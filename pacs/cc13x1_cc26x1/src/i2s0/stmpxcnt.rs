...
Current value of the XOSC counter, latched when reading STMPWCNT."]
pub type CurrValueW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
...
Current value of the XOSC counter, latched when reading STMPWCNT."]
    #[inline(always)]
    #[must_use]
    pub fn curr_value(&mut self) -> CurrValueW<StmpxcntSpec> {
        CurrValueW::new(self, 0)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved16(&mut self) -> Reserved16W<StmpxcntSpec> {
