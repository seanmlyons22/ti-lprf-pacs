...
pub type R = crate::R<Pdctl0rfcSpec>;
#[doc = "Register `PDCTL0RFC` writer"]
pub type W = crate::W<Pdctl0rfcSpec>;
...
Alias for PDCTL0.RFC_ON"]
    #[inline(always)]
    #[must_use]
    pub fn on(&mut self) -> OnW<Pdctl0rfcSpec> {
        OnW::new(self, 0)
    }
    #[doc = "Bits 1:31 - 31:1\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved1(&mut self) -> Reserved1W<Pdctl0rfcSpec> {
        Reserved1W::new(self, 1)
    }
}
#[doc = "RFC Power Domain Control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pdctl0rfc::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pdctl0rfc::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pdctl0rfcSpec;
impl crate::RegisterSpec for Pdctl0rfcSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pdctl0rfc::R`](R) reader structure"]
impl crate::Readable for Pdctl0rfcSpec {}
#[doc = "`write(|w| ..)` method takes [`pdctl0rfc::W`](W) writer structure"]
impl crate::Writable for Pdctl0rfcSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PDCTL0RFC to value 0"]
impl crate::Resettable for Pdctl0rfcSpec {
