...
pub type VIMS_ON_R = crate::BitReader<bool>;
#[doc = "Field `VIMS_ON` writer - 3:3\\]
0: VIMS domain not accessible 1: VIMS domain is currently accessible"]
pub type VIMS_ON_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDSTAT1_SPEC, bool, O>;
...
0: VIMS domain not accessible 1: VIMS domain is currently accessible"]
    #[inline(always)]
    #[must_use]
    pub fn vims_on(&mut self) -> VIMS_ON_W<3> {
        VIMS_ON_W::new(self)
    }
    #[doc = "Bit 4 - 4:4\\]
0: BUS domain not accessible 1: BUS domain is currently accessible"]
