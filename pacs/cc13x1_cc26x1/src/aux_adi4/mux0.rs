...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED4_W<'a, const O: u8> = crate::FieldWriter<'a, u8, MUX0_SPEC, u8, u8, 2, O>;
#[doc = "Field `ADCCOMPB_IN` reader - 6:6\\]
Internal. Only to be used through TI provided API."]
pub type ADCCOMPB_IN_R = crate::BitReader<ADCCOMPB_IN_A>;
#[doc = "6:6\\]
Internal. Only to be used through TI provided API.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
Internal. Only to be used through TI provided API."]
pub type ADCCOMPB_IN_W<'a, const O: u8> = crate::BitWriter<'a, u8, MUX0_SPEC, ADCCOMPB_IN_A, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED7_W<'a, const O: u8> = crate::BitWriter<'a, u8, MUX0_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:3 - 3:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    ...
    pub fn reserved4(&self) -> RESERVED4_R {
        RESERVED4_R::new((self.bits >> 4) & 3)
    }
    #[doc = "Bit 6 - 6:6\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn adccompb_in(&self) -> ADCCOMPB_IN_R {
        ADCCOMPB_IN_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - 7:7\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn adccompb_in(&mut self) -> ADCCOMPB_IN_W<6> {
