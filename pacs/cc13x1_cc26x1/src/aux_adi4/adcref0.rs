...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type SPARE7_R = crate::BitReader<bool>;
#[doc = "Field `SPARE7` writer - 7:7\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type SPARE7_W<'a, const O: u8> = crate::BitWriter<'a, u8, ADCREF0_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
ADC reference module enable: 0: ADC reference module powered down 1: ADC reference module enabled"]
    #[inline(always)]
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn spare7(&mut self) -> SPARE7_W<7> {
        SPARE7_W::new(self)
    }
