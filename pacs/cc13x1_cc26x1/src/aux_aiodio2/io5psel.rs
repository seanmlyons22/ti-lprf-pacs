...
pub type R = crate::R<Io5pselSpec>;
#[doc = "Register `IO5PSEL` writer"]
pub type W = crate::W<Io5pselSpec>;
#[doc = "2:0\\]
...
you must configure this register while IOPOE bit 5 is 0. In the formulas i = 0 for AUX_AIODIO0, i = 1 for AUX_AIODIO1, and so forth.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`io5psel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`io5psel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Io5pselSpec;
impl crate::RegisterSpec for Io5pselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`io5psel::R`](R) reader structure"]
impl crate::Readable for Io5pselSpec {}
#[doc = "`write(|w| ..)` method takes [`io5psel::W`](W) writer structure"]
impl crate::Writable for Io5pselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets IO5PSEL to value 0"]
impl crate::Resettable for Io5pselSpec {
