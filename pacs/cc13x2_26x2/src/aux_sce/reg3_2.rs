...
Internal. Only to be used through TI provided API."]
pub type Reg2W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `REG3` reader - 31:16\\]
Internal. Only to be used through TI provided API."]
pub type Reg3R = crate::FieldReader<u16>;
#[doc = "Field `REG3` writer - 31:16\\]
Internal. Only to be used through TI provided API."]
pub type Reg3W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - 15:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn reg2(&mut self) -> Reg2W<Reg3_2Spec> {
        Reg2W::new(self, 0)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn reg3(&mut self) -> Reg3W<Reg3_2Spec> {
        Reg3W::new(self, 16)
    }
}
