...
impl From<CommandStarted> for bool {
    #[inline(always)]
    fn from(variant: CommandStarted) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `COMMAND_STARTED` reader - 12:12\\]
Select which CPU interrupt vector the RFCPEIFG.COMMAND_STARTED interrupt should use."]
pub type CommandStartedR = crate::BitReader<CommandStarted>;
impl CommandStartedR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> CommandStarted {
        match self.bits {
            true => CommandStarted::Cpe1,
            false => CommandStarted::Cpe0,
        }
    }
    #[doc = "Associate this interrupt line with INT_RF_CPE1 interrupt vector"]
    #[inline(always)]
    pub fn is_cpe1(&self) -> bool {
        *self == CommandStarted::Cpe1
    }
    #[doc = "Associate this interrupt line with INT_RF_CPE0 interrupt vector"]
    #[inline(always)]
    pub fn is_cpe0(&self) -> bool {
        *self == CommandStarted::Cpe0
    }
}
#[doc = "Field `COMMAND_STARTED` writer - 12:12\\]
Select which CPU interrupt vector the RFCPEIFG.COMMAND_STARTED interrupt should use."]
pub type CommandStartedW<'a, REG> = crate::BitWriter<'a, REG, CommandStarted>;
impl<'a, REG> CommandStartedW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Associate this interrupt line with INT_RF_CPE1 interrupt vector"]
    #[inline(always)]
    pub fn cpe1(self) -> &'a mut crate::W<REG> {
        self.variant(CommandStarted::Cpe1)
    }
    #[doc = "Associate this interrupt line with INT_RF_CPE0 interrupt vector"]
    #[inline(always)]
    pub fn cpe0(self) -> &'a mut crate::W<REG> {
        self.variant(CommandStarted::Cpe0)
    }
}
#[doc = "13:13\\]
Select which CPU interrupt vector the RFCPEIFG.FG_COMMAND_STARTED interrupt should use.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum FgCommandStarted {
    #[doc = "1: Associate this interrupt line with INT_RF_CPE1 interrupt vector"]
    Cpe1 = 1,
    #[doc = "0: Associate this interrupt line with INT_RF_CPE0 interrupt vector"]
    Cpe0 = 0,
}
impl From<FgCommandStarted> for bool {
    #[inline(always)]
    fn from(variant: FgCommandStarted) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `FG_COMMAND_STARTED` reader - 13:13\\]
Select which CPU interrupt vector the RFCPEIFG.FG_COMMAND_STARTED interrupt should use."]
pub type FgCommandStartedR = crate::BitReader<FgCommandStarted>;
impl FgCommandStartedR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> FgCommandStarted {
        match self.bits {
            true => FgCommandStarted::Cpe1,
            false => FgCommandStarted::Cpe0,
        }
    }
    #[doc = "Associate this interrupt line with INT_RF_CPE1 interrupt vector"]
    #[inline(always)]
    pub fn is_cpe1(&self) -> bool {
        *self == FgCommandStarted::Cpe1
    }
    #[doc = "Associate this interrupt line with INT_RF_CPE0 interrupt vector"]
    #[inline(always)]
    pub fn is_cpe0(&self) -> bool {
        *self == FgCommandStarted::Cpe0
    }
}
#[doc = "Field `FG_COMMAND_STARTED` writer - 13:13\\]
Select which CPU interrupt vector the RFCPEIFG.FG_COMMAND_STARTED interrupt should use."]
pub type FgCommandStartedW<'a, REG> = crate::BitWriter<'a, REG, FgCommandStarted>;
impl<'a, REG> FgCommandStartedW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Associate this interrupt line with INT_RF_CPE1 interrupt vector"]
    #[inline(always)]
    pub fn cpe1(self) -> &'a mut crate::W<REG> {
        self.variant(FgCommandStarted::Cpe1)
    }
    #[doc = "Associate this interrupt line with INT_RF_CPE0 interrupt vector"]
    #[inline(always)]
    pub fn cpe0(self) -> &'a mut crate::W<REG> {
        self.variant(FgCommandStarted::Cpe0)
    }
}
#[doc = "14:14\\]
...
Select which CPU interrupt vector the RFCPEIFG.COMMAND_STARTED interrupt should use."]
    #[inline(always)]
    pub fn command_started(&self) -> CommandStartedR {
        CommandStartedR::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - 13:13\\]
Select which CPU interrupt vector the RFCPEIFG.FG_COMMAND_STARTED interrupt should use."]
    #[inline(always)]
    pub fn fg_command_started(&self) -> FgCommandStartedR {
        FgCommandStartedR::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - 14:14\\]
Select which CPU interrupt vector the RFCPEIFG.IRQ14 interrupt should use."]
    #[inline(always)]
...
Select which CPU interrupt vector the RFCPEIFG.COMMAND_STARTED interrupt should use."]
    #[inline(always)]
    #[must_use]
    pub fn command_started(&mut self) -> CommandStartedW<RfcpeislSpec> {
        CommandStartedW::new(self, 12)
    }
    #[doc = "Bit 13 - 13:13\\]
Select which CPU interrupt vector the RFCPEIFG.FG_COMMAND_STARTED interrupt should use."]
    #[inline(always)]
    #[must_use]
    pub fn fg_command_started(&mut self) -> FgCommandStartedW<RfcpeislSpec> {
        FgCommandStartedW::new(self, 13)
    }
    #[doc = "Bit 14 - 14:14\\]
Select which CPU interrupt vector the RFCPEIFG.IRQ14 interrupt should use."]
    #[inline(always)]
