...
pub type R = crate::R<Comp7Spec>;
#[doc = "Register `COMP7` writer"]
pub type W = crate::W<Comp7Spec>;
...
Compare and remap enable comparator 7. CTRL.ENABLE must also be set to enable comparisons. 0x0: Compare and remap for comparator 7 disabled 0x1: Compare and remap for comparator 7 enabled"]
    #[inline(always)]
    #[must_use]
    pub fn enable(&mut self) -> EnableW<Comp7Spec> {
        EnableW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved1(&mut self) -> Reserved1W<Comp7Spec> {
...
Comparison address."]
    #[inline(always)]
    #[must_use]
    pub fn comp(&mut self) -> CompW<Comp7Spec> {
        CompW::new(self, 2)
    }
    #[doc = "Bit 29 - 29:29\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved29(&mut self) -> Reserved29W<Comp7Spec> {
...
This selects what happens when the COMP address is matched. Comparator 7 is a literal comparator and the only supported setting is 0x0. Other settings will be ignored. 0x0: Remap to remap address. See REMAP.REMAP 0x1: Set BKPT on lower halfword, upper is unaffected 0x2: Set BKPT on upper halfword, lower is unaffected 0x3: Set BKPT on both lower and upper halfwords."]
    #[inline(always)]
    #[must_use]
    pub fn replace(&mut self) -> ReplaceW<Comp7Spec> {
        ReplaceW::new(self, 30)
    }
}
#[doc = "Comparator 7\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`comp7::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`comp7::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Comp7Spec;
impl crate::RegisterSpec for Comp7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`comp7::R`](R) reader structure"]
impl crate::Readable for Comp7Spec {}
#[doc = "`write(|w| ..)` method takes [`comp7::W`](W) writer structure"]
impl crate::Writable for Comp7Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets COMP7 to value 0"]
impl crate::Resettable for Comp7Spec {
