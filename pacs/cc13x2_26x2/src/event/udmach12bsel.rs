...
pub type R = crate::R<Udmach12bselSpec>;
#[doc = "Register `UDMACH12BSEL` writer"]
pub type W = crate::W<Udmach12bselSpec>;
#[doc = "6:0\\]
...
Read/write selection value Writing any other value than values defined by a ENUM may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn ev(&mut self) -> EvW<Udmach12bselSpec> {
        EvW::new(self, 0)
    }
}
#[doc = "Output Selection for DMA Channel 12 REQ DMA_DONE for the corresponding DMA channel is available as interrupt on GPT1 as GPT1:RIS.DMABRIS\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`udmach12bsel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`udmach12bsel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Udmach12bselSpec;
impl crate::RegisterSpec for Udmach12bselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`udmach12bsel::R`](R) reader structure"]
impl crate::Readable for Udmach12bselSpec {}
#[doc = "`write(|w| ..)` method takes [`udmach12bsel::W`](W) writer structure"]
impl crate::Writable for Udmach12bselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets UDMACH12BSEL to value 0x50"]
impl crate::Resettable for Udmach12bselSpec {
