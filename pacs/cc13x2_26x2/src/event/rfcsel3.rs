...
pub type R = crate::R<Rfcsel3Spec>;
#[doc = "Register `RFCSEL3` writer"]
pub type W = crate::W<Rfcsel3Spec>;
#[doc = "6:0\\]
...
Read only selection value"]
    #[inline(always)]
    #[must_use]
    pub fn ev(&mut self) -> EvW<Rfcsel3Spec> {
        EvW::new(self, 0)
    }
}
#[doc = "Output Selection for RFC Event 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rfcsel3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rfcsel3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Rfcsel3Spec;
impl crate::RegisterSpec for Rfcsel3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rfcsel3::R`](R) reader structure"]
impl crate::Readable for Rfcsel3Spec {}
#[doc = "`write(|w| ..)` method takes [`rfcsel3::W`](W) writer structure"]
impl crate::Writable for Rfcsel3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RFCSEL3 to value 0x40"]
impl crate::Resettable for Rfcsel3Spec {
