...
pub type R = crate::R<Udmach10bselSpec>;
#[doc = "Register `UDMACH10BSEL` writer"]
pub type W = crate::W<Udmach10bselSpec>;
#[doc = "6:0\\]
...
Read/write selection value Writing any other value than values defined by a ENUM may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn ev(&mut self) -> EvW<Udmach10bselSpec> {
        EvW::new(self, 0)
    }
}
#[doc = "Output Selection for DMA Channel 10 REQ DMA_DONE for the corresponding DMA channel is available as interrupt on GPT0 as GPT0:RIS.DMABRIS\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`udmach10bsel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`udmach10bsel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Udmach10bselSpec;
impl crate::RegisterSpec for Udmach10bselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`udmach10bsel::R`](R) reader structure"]
impl crate::Readable for Udmach10bselSpec {}
#[doc = "`write(|w| ..)` method takes [`udmach10bsel::W`](W) writer structure"]
impl crate::Writable for Udmach10bselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets UDMACH10BSEL to value 0x4e"]
impl crate::Resettable for Udmach10bselSpec {
    const RESET_VALUE: u32 = 0x4e;
}
