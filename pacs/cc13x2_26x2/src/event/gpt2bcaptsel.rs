...
pub type R = crate::R<Gpt2bcaptselSpec>;
#[doc = "Register `GPT2BCAPTSEL` writer"]
pub type W = crate::W<Gpt2bcaptselSpec>;
#[doc = "6:0\\]
...
Read/write selection value Writing any other value than values defined by a ENUM may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn ev(&mut self) -> EvW<Gpt2bcaptselSpec> {
        EvW::new(self, 0)
    }
}
#[doc = "Output Selection for GPT2 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpt2bcaptsel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpt2bcaptsel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpt2bcaptselSpec;
impl crate::RegisterSpec for Gpt2bcaptselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpt2bcaptsel::R`](R) reader structure"]
impl crate::Readable for Gpt2bcaptselSpec {}
#[doc = "`write(|w| ..)` method takes [`gpt2bcaptsel::W`](W) writer structure"]
impl crate::Writable for Gpt2bcaptselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPT2BCAPTSEL to value 0x5a"]
impl crate::Resettable for Gpt2bcaptselSpec {
