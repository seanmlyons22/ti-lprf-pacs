...
pub type R = crate::R<Io3pselSpec>;
#[doc = "Register `IO3PSEL` writer"]
pub type W = crate::W<Io3pselSpec>;
#[doc = "2:0\\]
...
when IOPOE bit 3 is set."]
    #[inline(always)]
    #[must_use]
    pub fn src(&mut self) -> SrcW<Io3pselSpec> {
        SrcW::new(self, 0)
    }
    #[doc = "Bits 3:31 - 31:3\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved3(&mut self) -> Reserved3W<Io3pselSpec> {
...
you must configure this register while IOPOE bit 3 is 0. In the formulas i = 0 for AUX_AIODIO0, i = 1 for AUX_AIODIO1, and so forth.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`io3psel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`io3psel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Io3pselSpec;
impl crate::RegisterSpec for Io3pselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`io3psel::R`](R) reader structure"]
impl crate::Readable for Io3pselSpec {}
#[doc = "`write(|w| ..)` method takes [`io3psel::W`](W) writer structure"]
impl crate::Writable for Io3pselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets IO3PSEL to value 0"]
impl crate::Resettable for Io3pselSpec {
