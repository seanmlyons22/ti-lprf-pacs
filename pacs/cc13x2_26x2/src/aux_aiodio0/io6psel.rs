...
pub type R = crate::R<Io6pselSpec>;
#[doc = "Register `IO6PSEL` writer"]
pub type W = crate::W<Io6pselSpec>;
#[doc = "2:0\\]
...
when IOPOE bit 6 is set."]
    #[inline(always)]
    #[must_use]
    pub fn src(&mut self) -> SrcW<Io6pselSpec> {
        SrcW::new(self, 0)
    }
    #[doc = "Bits 3:31 - 31:3\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved3(&mut self) -> Reserved3W<Io6pselSpec> {
...
you must configure this register while IOPOE bit 6 is 0. In the formulas i = 0 for AUX_AIODIO0, i = 1 for AUX_AIODIO1, and so forth.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`io6psel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`io6psel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Io6pselSpec;
impl crate::RegisterSpec for Io6pselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`io6psel::R`](R) reader structure"]
impl crate::Readable for Io6pselSpec {}
#[doc = "`write(|w| ..)` method takes [`io6psel::W`](W) writer structure"]
impl crate::Writable for Io6pselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets IO6PSEL to value 0"]
impl crate::Resettable for Io6pselSpec {
