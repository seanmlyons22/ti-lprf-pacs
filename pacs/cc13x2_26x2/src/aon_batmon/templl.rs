...
pub type R = crate::R<TempllSpec>;
#[doc = "Register `TEMPLL` writer"]
pub type W = crate::W<TempllSpec>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved0(&mut self) -> Reserved0W<TempllSpec> {
...
Fractional part of temperature lower limit. Total value = INTEGER + FRACTIONAL The encoding is an extension of the 2's complement encoding. 00: 0.0C 01: 0.25C 10: 0.5C 11: 0.75C For example: 000000001,00 = ( 1+0,00) = 1,00 000000000,11 = ( 0+0,75) = 0,75 000000000,10 = ( 0+0,50) = 0,50 000000000,01 = ( 0+0,25) = 0,25 000000000,00 = ( 0+0,00) = 0,00 111111111,11 = (-1+0,75) = -0,25 111111111,10 = (-1+0,50) = -0,50 111111111,01 = (-1+0,25) = -0,75 111111111,00 = (-1+0,00) = -1,00 111111110,11 = (-2+0,75) = -1,25"]
    #[inline(always)]
    #[must_use]
    pub fn frac(&mut self) -> FracW<TempllSpec> {
        FracW::new(self, 6)
    }
    #[doc = "Bits 8:16 - 16:8\\]
Integer part (signed) of temperature lower limit. Total value = INTEGER + FRACTIONAL 2's complement encoding 0x100: Min value 0x1D8: -40C 0x1FF: -1C 0x00: 0C 0x1B: 27C 0x55: 85C 0xFF: Max value"]
    #[inline(always)]
    #[must_use]
    pub fn int(&mut self) -> IntW<TempllSpec> {
        IntW::new(self, 8)
    }
    #[doc = "Bits 17:31 - 31:17\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved17(&mut self) -> Reserved17W<TempllSpec> {
        Reserved17W::new(self, 17)
    }
}
#[doc = "Temperature Lower Limit\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`templl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`templl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TempllSpec;
impl crate::RegisterSpec for TempllSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`templl::R`](R) reader structure"]
impl crate::Readable for TempllSpec {}
#[doc = "`write(|w| ..)` method takes [`templl::W`](W) writer structure"]
impl crate::Writable for TempllSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TEMPLL to value 0x0001_0000"]
impl crate::Resettable for TempllSpec {
