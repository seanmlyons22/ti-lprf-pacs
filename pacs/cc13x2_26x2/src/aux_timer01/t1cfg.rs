...
pub type R = crate::R<T1cfgSpec>;
#[doc = "Register `T1CFG` writer"]
pub type W = crate::W<T1cfgSpec>;
#[doc = "0:0\\]
Timer 1 reload mode.\n\nValue on reset: 0"]
...
impl TickSrcR {
    ...
    pub const fn variant(&self) -> TickSrc {
        match self.bits {
            63 => TickSrc::AuxTimer2ClkswRdy,
            62 => TickSrc::AuxDacHoldActive,
            61 => TickSrc::AuxSmphAutotakeDone,
            60 => TickSrc::AuxAdcFifoNotEmpty,
            59 => TickSrc::AuxAdcFifoAlmostFull,
            58 => TickSrc::AuxAdcIrq,
            57 => TickSrc::AuxAdcDone,
            56 => TickSrc::AuxIsrcResetN,
            55 => TickSrc::AuxTdcDone,
            54 => TickSrc::AuxTimer0Ev,
            53 => TickSrc::NoEvent,
            52 => TickSrc::AuxTimer2Pulse,
            51 => TickSrc::AuxTimer2Ev3,
            50 => TickSrc::AuxTimer2Ev2,
            49 => TickSrc::AuxTimer2Ev1,
            48 => TickSrc::AuxTimer2Ev0,
            47 => TickSrc::AuxCompb,
            46 => TickSrc::AuxCompa,
            45 => TickSrc::McuObsmux1,
            44 => TickSrc::McuObsmux0,
            43 => TickSrc::McuEv,
            42 => TickSrc::AclkRef,
            41 => TickSrc::VddrRecharge,
            40 => TickSrc::McuActive,
            39 => TickSrc::PwrDwn,
            38 => TickSrc::SclkLf,
            37 => TickSrc::AonBatmonTempUpd,
            36 => TickSrc::AonBatmonBatUpd,
            35 => TickSrc::AonRtc4khz,
            34 => TickSrc::AonRtcCh2Dly,
            33 => TickSrc::AonRtcCh2,
            32 => TickSrc::ManualEv,
            31 => TickSrc::Auxio31,
            30 => TickSrc::Auxio30,
            29 => TickSrc::Auxio29,
    ...
    pub fn is_aux_timer2_clksw_rdy(&self) -> bool {
        *self == TickSrc::AuxTimer2ClkswRdy
    }
...
Select Timer 1 tick source from the synchronous event bus."]
pub type TickSrcW<'a, REG> = crate::FieldWriter<'a, REG, 6, TickSrc, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    #[doc = "AUX_EVCTL:EVSTAT3.AUX_TIMER2_CLKSWITCH_RDY"]
    #[inline(always)]
    pub fn aux_timer2_clksw_rdy(self) -> &'a mut crate::W<REG> {
        self.variant(TickSrc::AuxTimer2ClkswRdy)
    }
    #[doc = "AUX_EVCTL:EVSTAT3.AUX_DAC_HOLD_ACTIVE"]
    #[inline(always)]
    ...
    pub fn aux_timer0_ev(self) -> &'a mut crate::W<REG> {
        self.variant(TickSrc::AuxTimer0Ev)
    }
    #[doc = "No event."]
    #[inline(always)]
    ...
    pub fn aon_batmon_temp_upd(self) -> &'a mut crate::W<REG> {
        self.variant(TickSrc::AonBatmonTempUpd)
    }
    #[doc = "AUX_EVCTL:EVSTAT2.AON_BATMON_BAT_UPD"]
    #[inline(always)]
    pub fn aon_batmon_bat_upd(self) -> &'a mut crate::W<REG> {
        self.variant(TickSrc::AonBatmonBatUpd)
    }
    #[doc = "AUX_EVCTL:EVSTAT2.AON_RTC_4KHZ"]
    #[inline(always)]
...
Timer 1 reload mode."]
    #[inline(always)]
    #[must_use]
    pub fn reload(&mut self) -> ReloadW<T1cfgSpec> {
        ReloadW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Timer 1 mode. Configure source for Timer 1 prescaler."]
...
Prescaler division ratio is 2^PRE: 0x0: Divide by 1. 0x1: Divide by 2. 0x2: Divide by 4. ... 0xF: Divide by 32,768."]
    #[inline(always)]
    #[must_use]
    pub fn pre(&mut self) -> PreW<T1cfgSpec> {
        PreW::new(self, 4)
    }
    #[doc = "Bits 8:13 - 13:8\\]
Select Timer 1 tick source from the synchronous event bus."]
    #[inline(always)]
    #[must_use]
    pub fn tick_src(&mut self) -> TickSrcW<T1cfgSpec> {
        TickSrcW::new(self, 8)
    }
    #[doc = "Bit 14 - 14:14\\]
Tick source polarity for Timer 1."]
...
pub struct T1cfgSpec;
impl crate::RegisterSpec for T1cfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`t1cfg::R`](R) reader structure"]
impl crate::Readable for T1cfgSpec {}
#[doc = "`write(|w| ..)` method takes [`t1cfg::W`](W) writer structure"]
impl crate::Writable for T1cfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets T1CFG to value 0"]
impl crate::Resettable for T1cfgSpec {
