...
pub type R = crate::R<GpioclkgrSpec>;
#[doc = "Register `GPIOCLKGR` writer"]
pub type W = crate::W<GpioclkgrSpec>;
...
0: Disable clock 1: Enable clock Can be forced on by AM_CLK_EN For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    #[inline(always)]
    #[must_use]
    pub fn clk_en(&mut self) -> ClkEnW<GpioclkgrSpec> {
        ClkEnW::new(self, 0)
    }
    #[doc = "Bits 1:7 - 7:1\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved1(&mut self) -> Reserved1W<GpioclkgrSpec> {
...
0: No force 1: Force clock on for all modes (Run, Sleep and Deep Sleep) Overrides CLK_EN, GPIOCLKGS.CLK_EN and GPIOCLKGDS.CLK_EN when enabled. For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    #[inline(always)]
    #[must_use]
    pub fn am_clk_en(&mut self) -> AmClkEnW<GpioclkgrSpec> {
        AmClkEnW::new(self, 8)
    }
    #[doc = "Bits 9:31 - 31:9\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved9(&mut self) -> Reserved9W<GpioclkgrSpec> {
        Reserved9W::new(self, 9)
    }
}
#[doc = "GPIO Clock Gate For Run And All Modes\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpioclkgr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpioclkgr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioclkgrSpec;
impl crate::RegisterSpec for GpioclkgrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioclkgr::R`](R) reader structure"]
impl crate::Readable for GpioclkgrSpec {}
#[doc = "`write(|w| ..)` method takes [`gpioclkgr::W`](W) writer structure"]
impl crate::Writable for GpioclkgrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIOCLKGR to value 0"]
impl crate::Resettable for GpioclkgrSpec {
