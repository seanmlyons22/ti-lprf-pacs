...
pub type R = crate::R<SsiclkgsSpec>;
#[doc = "Register `SSICLKGS` writer"]
pub type W = crate::W<SsiclkgsSpec>;
#[doc = "1:0\\]
...
0: Disable clock 1: Enable clock Can be forced on by SSICLKGR.AM_CLK_EN For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    #[inline(always)]
    #[must_use]
    pub fn clk_en(&mut self) -> ClkEnW<SsiclkgsSpec> {
        ClkEnW::new(self, 0)
    }
    #[doc = "Bits 2:31 - 31:2\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved2(&mut self) -> Reserved2W<SsiclkgsSpec> {
        Reserved2W::new(self, 2)
    }
}
#[doc = "SSI Clock Gate For Sleep Mode\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ssiclkgs::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ssiclkgs::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SsiclkgsSpec;
impl crate::RegisterSpec for SsiclkgsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ssiclkgs::R`](R) reader structure"]
impl crate::Readable for SsiclkgsSpec {}
#[doc = "`write(|w| ..)` method takes [`ssiclkgs::W`](W) writer structure"]
impl crate::Writable for SsiclkgsSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SSICLKGS to value 0"]
impl crate::Resettable for SsiclkgsSpec {
