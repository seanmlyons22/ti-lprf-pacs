...
pub mod ffcr;
#[doc = "FSCR (rw) register accessor: Formatter Synchronization Counter\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`fscr::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`fscr::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fscr`]
module"]
#[doc(alias = "FSCR")]
