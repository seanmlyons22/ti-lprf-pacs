...
impl START_SRC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<START_SRC_A> {
        match self.bits {
            63 => Some(START_SRC_A::NO_EVENT),
            61 => Some(START_SRC_A::AUX_SMPH_AUTOTAKE_DONE),
            56 => Some(START_SRC_A::AUX_ISRC_RESET_N),
            55 => Some(START_SRC_A::AUX_TDC_DONE),
            54 => Some(START_SRC_A::AUX_TIMER0_EV),
            53 => Some(START_SRC_A::AUX_TIMER1_EV),
            52 => Some(START_SRC_A::AUX_TIMER2_PULSE),
            51 => Some(START_SRC_A::AUX_TIMER2_EV3),
            50 => Some(START_SRC_A::AUX_TIMER2_EV2),
            49 => Some(START_SRC_A::AUX_TIMER2_EV1),
            48 => Some(START_SRC_A::AUX_TIMER2_EV0),
            47 => Some(START_SRC_A::AUX_COMPB),
            46 => Some(START_SRC_A::AUX_COMPA),
            43 => Some(START_SRC_A::MCU_EV),
            42 => Some(START_SRC_A::ACLK_REF),
            41 => Some(START_SRC_A::VDDR_RECHARGE),
            40 => Some(START_SRC_A::MCU_ACTIVE),
            39 => Some(START_SRC_A::PWR_DWN),
            38 => Some(START_SRC_A::SCLK_LF),
            37 => Some(START_SRC_A::AON_BATMON_TEMP_UPD),
            36 => Some(START_SRC_A::AON_BATMON_BAT_UPD),
            35 => Some(START_SRC_A::AON_RTC_4KHZ),
            34 => Some(START_SRC_A::AON_RTC_CH2_DLY),
            33 => Some(START_SRC_A::AON_RTC_CH2),
            32 => Some(START_SRC_A::MANUAL_EV),
            31 => Some(START_SRC_A::AUXIO31),
            30 => Some(START_SRC_A::AUXIO30),
            29 => Some(START_SRC_A::AUXIO29),
            28 => Some(START_SRC_A::AUXIO28),
            27 => Some(START_SRC_A::AUXIO27),
            26 => Some(START_SRC_A::AUXIO26),
            25 => Some(START_SRC_A::AUXIO25),
            24 => Some(START_SRC_A::AUXIO24),
            23 => Some(START_SRC_A::AUXIO23),
            22 => Some(START_SRC_A::AUXIO22),
            21 => Some(START_SRC_A::AUXIO21),
            20 => Some(START_SRC_A::AUXIO20),
            19 => Some(START_SRC_A::AUXIO19),
            18 => Some(START_SRC_A::AUXIO18),
            17 => Some(START_SRC_A::AUXIO17),
            16 => Some(START_SRC_A::AUXIO16),
            15 => Some(START_SRC_A::AUXIO15),
            14 => Some(START_SRC_A::AUXIO14),
            13 => Some(START_SRC_A::AUXIO13),
            12 => Some(START_SRC_A::AUXIO12),
            11 => Some(START_SRC_A::AUXIO11),
            10 => Some(START_SRC_A::AUXIO10),
            9 => Some(START_SRC_A::AUXIO9),
            8 => Some(START_SRC_A::AUXIO8),
            7 => Some(START_SRC_A::AUXIO7),
            6 => Some(START_SRC_A::AUXIO6),
            5 => Some(START_SRC_A::AUXIO5),
            4 => Some(START_SRC_A::AUXIO4),
            3 => Some(START_SRC_A::AUXIO3),
            2 => Some(START_SRC_A::AUXIO2),
            1 => Some(START_SRC_A::AUXIO1),
            0 => Some(START_SRC_A::AUXIO0),
            _ => None,
        }
    }
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED15_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ADCCTL_SPEC, u32, u32, 17, O>;
impl R {
    #[doc = "Bits 0:1 - 1:0\\]
ADC interface command. Non-enumerated values are not supported. The written value is returned when read."]
    #[inline(always)]
...
Select ADC trigger event source from the asynchronous AUX event bus. Set START_SRC to NO_EVENT if you want to trigger the ADC manually through ADCTRIG.START. If you write a non-enumerated value the behavior is identical to NO_EVENT. The written value is returned when read."]
    ...
    pub fn start_src(&self) -> START_SRC_R {
        START_SRC_R::new(((self.bits >> 8) & 0x3f) as u8)
    }
    #[doc = "Bit 14 - 14:14\\]
Select active polarity for START_SRC event."]
    #[inline(always)]
    pub fn start_pol(&self) -> START_POL_R {
        START_POL_R::new(((self.bits >> 14) & 1) != 0)
    }
...
Select active polarity for START_SRC event."]
    #[inline(always)]
    #[must_use]
    pub fn start_pol(&mut self) -> START_POL_W<14> {
