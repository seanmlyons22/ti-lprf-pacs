...
#[doc = "Field `DIS_LINEAR_CAPARRAY_DELTA_WORKAROUND` reader - 4:4\\]
The default CAPARRAY setting is good as long as no CAPARRAY_DELTA adjustment is added but the CAPARRAY setting will give an un-linear behavior if the workaround is not enabled. The workaround is disabled by default to avoid unexpected changes upon software updates. 0: The CAPARRAY_DELTA workaround is enabled. 1: The CAPARRAY_DELTA workaround is disabled."]
pub type DIS_LINEAR_CAPARRAY_DELTA_WORKAROUND_R = crate::BitReader<bool>;
#[doc = "Field `DIS_LINEAR_CAPARRAY_DELTA_WORKAROUND` writer - 4:4\\]
The default CAPARRAY setting is good as long as no CAPARRAY_DELTA adjustment is added but the CAPARRAY setting will give an un-linear behavior if the workaround is not enabled. The workaround is disabled by default to avoid unexpected changes upon software updates. 0: The CAPARRAY_DELTA workaround is enabled. 1: The CAPARRAY_DELTA workaround is disabled."]
pub type DIS_LINEAR_CAPARRAY_DELTA_WORKAROUND_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SIZE_AND_DIS_FLAGS_SPEC, bool, O>;
#[doc = "Field `DISABLE_FLAGS` reader - 15:5\\]
...
#[doc = "Field `DISABLE_FLAGS` writer - 15:5\\]
Reserved for future use. Software should not rely on the value of a reserved. Writing any other value than the reset/default value may result in undefined behavior."]
pub type DISABLE_FLAGS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SIZE_AND_DIS_FLAGS_SPEC, u16, u16, 11, O>;
...
The default CAPARRAY setting is good as long as no CAPARRAY_DELTA adjustment is added but the CAPARRAY setting will give an un-linear behavior if the workaround is not enabled. The workaround is disabled by default to avoid unexpected changes upon software updates. 0: The CAPARRAY_DELTA workaround is enabled. 1: The CAPARRAY_DELTA workaround is disabled."]
    #[inline(always)]
    pub fn dis_linear_caparray_delta_workaround(&self) -> DIS_LINEAR_CAPARRAY_DELTA_WORKAROUND_R {
        DIS_LINEAR_CAPARRAY_DELTA_WORKAROUND_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bits 5:15 - 15:5\\]
Reserved for future use. Software should not rely on the value of a reserved. Writing any other value than the reset/default value may result in undefined behavior."]
    #[inline(always)]
    pub fn disable_flags(&self) -> DISABLE_FLAGS_R {
        DISABLE_FLAGS_R::new(((self.bits >> 5) & 0x07ff) as u16)
    }
...
The default CAPARRAY setting is good as long as no CAPARRAY_DELTA adjustment is added but the CAPARRAY setting will give an un-linear behavior if the workaround is not enabled. The workaround is disabled by default to avoid unexpected changes upon software updates. 0: The CAPARRAY_DELTA workaround is enabled. 1: The CAPARRAY_DELTA workaround is disabled."]
    #[inline(always)]
    #[must_use]
    pub fn dis_linear_caparray_delta_workaround(
        &mut self,
    ) -> DIS_LINEAR_CAPARRAY_DELTA_WORKAROUND_W<4> {
        DIS_LINEAR_CAPARRAY_DELTA_WORKAROUND_W::new(self)
    }
    #[doc = "Bits 5:15 - 15:5\\]
Reserved for future use. Software should not rely on the value of a reserved. Writing any other value than the reset/default value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn disable_flags(&mut self) -> DISABLE_FLAGS_W<5> {
