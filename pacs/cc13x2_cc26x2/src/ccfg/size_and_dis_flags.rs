...
pub type DisLinearCaparrayDeltaWorkaroundR = crate::BitReader;
#[doc = "Field `DIS_LINEAR_CAPARRAY_DELTA_WORKAROUND` writer - 4:4\\]
The default CAPARRAY setting is good as long as no CAPARRAY_DELTA adjustment is added but the CAPARRAY setting will give an un-linear behavior if the workaround is not enabled. The workaround is disabled by default to avoid unexpected changes upon software updates. 0: The CAPARRAY_DELTA workaround is enabled. 1: The CAPARRAY_DELTA workaround is disabled."]
pub type DisLinearCaparrayDeltaWorkaroundW<'a, REG> = crate::BitWriter<'a, REG>;
...
Reserved for future use. Software should not rely on the value of a reserved. Writing any other value than the reset/default value may result in undefined behavior."]
pub type DisableFlagsW<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
...
The default CAPARRAY setting is good as long as no CAPARRAY_DELTA adjustment is added but the CAPARRAY setting will give an un-linear behavior if the workaround is not enabled. The workaround is disabled by default to avoid unexpected changes upon software updates. 0: The CAPARRAY_DELTA workaround is enabled. 1: The CAPARRAY_DELTA workaround is disabled."]
    #[inline(always)]
    pub fn dis_linear_caparray_delta_workaround(&self) -> DisLinearCaparrayDeltaWorkaroundR {
        DisLinearCaparrayDeltaWorkaroundR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bits 5:15 - 15:5\\]
Reserved for future use. Software should not rely on the value of a reserved. Writing any other value than the reset/default value may result in undefined behavior."]
    #[inline(always)]
    pub fn disable_flags(&self) -> DisableFlagsR {
        DisableFlagsR::new(((self.bits >> 5) & 0x07ff) as u16)
    }
...
The default CAPARRAY setting is good as long as no CAPARRAY_DELTA adjustment is added but the CAPARRAY setting will give an un-linear behavior if the workaround is not enabled. The workaround is disabled by default to avoid unexpected changes upon software updates. 0: The CAPARRAY_DELTA workaround is enabled. 1: The CAPARRAY_DELTA workaround is disabled."]
    ...
    pub fn dis_linear_caparray_delta_workaround(
        &mut self,
    ) -> DisLinearCaparrayDeltaWorkaroundW<SizeAndDisFlagsSpec> {
        DisLinearCaparrayDeltaWorkaroundW::new(self, 4)
    }
    #[doc = "Bits 5:15 - 15:5\\]
Reserved for future use. Software should not rely on the value of a reserved. Writing any other value than the reset/default value may result in undefined behavior."]
    #[inline(always)]
