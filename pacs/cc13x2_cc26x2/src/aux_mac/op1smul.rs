...
pub struct R(crate::R<OP1SMUL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OP1SMUL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OP1SMUL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OP1SMUL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OP1SMUL` writer"]
pub struct W(crate::W<OP1SMUL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OP1SMUL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OP1SMUL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OP1SMUL_SPEC>) -> Self {
        W(writer)
    }
}
...
Signed operand 1 and multiplication trigger. Write OP1_VALUE to set signed operand 1 and trigger the following operation: When operand 0 was written to OP0S.OP0_VALUE: ACC = OP1_VALUE * OP0S.OP0_VALUE. When operand 0 was written to OP0U.OP0_VALUE: ACC = OP1_VALUE * OP0U.OP0_VALUE."]
pub type OP1_VALUE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OP1SMUL_SPEC, u16, u16, 16, O>;
#[doc = "Field `RESERVED16` reader - 31:16\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED16_R = crate::FieldReader<u16, u16>;
#[doc = "Field `RESERVED16` writer - 31:16\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED16_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OP1SMUL_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - 15:0\\]
Signed operand 1 and multiplication trigger. Write OP1_VALUE to set signed operand 1 and trigger the following operation: When operand 0 was written to OP0S.OP0_VALUE: ACC = OP1_VALUE * OP0S.OP0_VALUE. When operand 0 was written to OP0U.OP0_VALUE: ACC = OP1_VALUE * OP0U.OP0_VALUE."]
    #[inline(always)]
