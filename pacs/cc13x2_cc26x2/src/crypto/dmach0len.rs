...
pub type R = crate::R<Dmach0lenSpec>;
#[doc = "Register `DMACH0LEN` writer"]
pub type W = crate::W<Dmach0lenSpec>;
...
Channel DMA length in bytes During configuration, this register contains the DMA transfer length in bytes. During operation, it contains the last updated value of the DMA transfer length after being sent to the master interface. Note: Setting this register to a nonzero value starts the transfer if the channel is enabled. Therefore, this register must be written last when setting up a DMA channel."]
    #[inline(always)]
    #[must_use]
    pub fn dmalen(&mut self) -> DmalenW<Dmach0lenSpec> {
        DmalenW::new(self, 0)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved16(&mut self) -> Reserved16W<Dmach0lenSpec> {
        Reserved16W::new(self, 16)
    }
}
#[doc = "Channel 0 DMA Length\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dmach0len::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dmach0len::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Dmach0lenSpec;
impl crate::RegisterSpec for Dmach0lenSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dmach0len::R`](R) reader structure"]
impl crate::Readable for Dmach0lenSpec {}
#[doc = "`write(|w| ..)` method takes [`dmach0len::W`](W) writer structure"]
impl crate::Writable for Dmach0lenSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DMACH0LEN to value 0"]
impl crate::Resettable for Dmach0lenSpec {
