...
Internal. Only to be used through TI provided API."]
pub type SocDacVoutCalDecoupleC1W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
...
Internal. Only to be used through TI provided API."]
pub type SocDacVoutCalDecoupleC2W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - 15:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn soc_dac_vout_cal_decouple_c1(&mut self) -> SocDacVoutCalDecoupleC1W<DacCal0Spec> {
        SocDacVoutCalDecoupleC1W::new(self, 0)
    }
    #[doc = "Bits 16:31 - 31:16\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn soc_dac_vout_cal_decouple_c2(&mut self) -> SocDacVoutCalDecoupleC2W<DacCal0Spec> {
        SocDacVoutCalDecoupleC2W::new(self, 16)
    }
}
