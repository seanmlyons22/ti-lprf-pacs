#[doc = "Register `CONFIG_SYNTH_DIV2_CC13_2G4` reader"]
pub struct R(crate::R<CONFIG_SYNTH_DIV2_CC13_2G4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CONFIG_SYNTH_DIV2_CC13_2G4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CONFIG_SYNTH_DIV2_CC13_2G4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CONFIG_SYNTH_DIV2_CC13_2G4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CONFIG_SYNTH_DIV2_CC13_2G4` writer"]
pub struct W(crate::W<CONFIG_SYNTH_DIV2_CC13_2G4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CONFIG_SYNTH_DIV2_CC13_2G4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CONFIG_SYNTH_DIV2_CC13_2G4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CONFIG_SYNTH_DIV2_CC13_2G4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RFC_MDM_DEMIQMC0_TRIMCOMPLETE_N_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CONFIG_SYNTH_DIV2_CC13_2G4_SPEC, bool, O>;
...
pub type LDOVCO_TRIM_OUTPUT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONFIG_SYNTH_DIV2_CC13_2G4_SPEC, u8, u8, 6, O>;
...
pub type RFC_MDM_DEMIQMC0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONFIG_SYNTH_DIV2_CC13_2G4_SPEC, u16, u16, 16, O>;
...
pub type MIN_ALLOWED_RTRIM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONFIG_SYNTH_DIV2_CC13_2G4_SPEC, u8, u8, 4, O>;
impl R {
    #[doc = "Bit 5 - 5:5\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
#[doc = "Internal. Only to be used through TI provided API.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [config_synth_div2_cc13_2g4](index.html) module"]
pub struct CONFIG_SYNTH_DIV2_CC13_2G4_SPEC;
impl crate::RegisterSpec for CONFIG_SYNTH_DIV2_CC13_2G4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [config_synth_div2_cc13_2g4::R](R) reader structure"]
impl crate::Readable for CONFIG_SYNTH_DIV2_CC13_2G4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [config_synth_div2_cc13_2g4::W](W) writer structure"]
impl crate::Writable for CONFIG_SYNTH_DIV2_CC13_2G4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CONFIG_SYNTH_DIV2_CC13_2G4 to value 0x1f"]
impl crate::Resettable for CONFIG_SYNTH_DIV2_CC13_2G4_SPEC {
