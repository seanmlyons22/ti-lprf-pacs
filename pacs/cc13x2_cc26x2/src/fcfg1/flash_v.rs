...
Internal. Only to be used through TI provided API."]
pub type Trim0p8W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn trim0p8(&self) -> Trim0p8R {
        Trim0p8R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn trim0p8(&mut self) -> Trim0p8W<FlashVSpec> {
        Trim0p8W::new(self, 0)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Internal. Only to be used through TI provided API."]
