...
pub type COMMAND_STARTED_R = crate::BitReader<COMMAND_STARTED_A>;
#[doc = "12:12\\]
Select which CPU interrupt vector the RFCPEIFG.COMMAND_STARTED interrupt should use.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
Select which CPU interrupt vector the RFCPEIFG.COMMAND_STARTED interrupt should use."]
pub type COMMAND_STARTED_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RFCPEISL_SPEC, COMMAND_STARTED_A, O>;
impl<'a, const O: u8> COMMAND_STARTED_W<'a, O> {
    #[doc = "Associate this interrupt line with INT_RF_CPE1 interrupt vector"]
    #[inline(always)]
    pub fn cpe1(self) -> &'a mut W {
...
pub type FG_COMMAND_STARTED_R = crate::BitReader<FG_COMMAND_STARTED_A>;
#[doc = "13:13\\]
Select which CPU interrupt vector the RFCPEIFG.FG_COMMAND_STARTED interrupt should use.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
Select which CPU interrupt vector the RFCPEIFG.FG_COMMAND_STARTED interrupt should use."]
pub type FG_COMMAND_STARTED_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RFCPEISL_SPEC, FG_COMMAND_STARTED_A, O>;
impl<'a, const O: u8> FG_COMMAND_STARTED_W<'a, O> {
    #[doc = "Associate this interrupt line with INT_RF_CPE1 interrupt vector"]
    #[inline(always)]
    pub fn cpe1(self) -> &'a mut W {
...
Select which CPU interrupt vector the RFCPEIFG.COMMAND_STARTED interrupt should use."]
    ...
    pub fn command_started(&self) -> COMMAND_STARTED_R {
        COMMAND_STARTED_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - 13:13\\]
Select which CPU interrupt vector the RFCPEIFG.FG_COMMAND_STARTED interrupt should use."]
    #[inline(always)]
    pub fn fg_command_started(&self) -> FG_COMMAND_STARTED_R {
        FG_COMMAND_STARTED_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - 14:14\\]
Select which CPU interrupt vector the RFCPEIFG.IRQ14 interrupt should use."]
    #[inline(always)]
...
Select which CPU interrupt vector the RFCPEIFG.COMMAND_STARTED interrupt should use."]
    #[inline(always)]
    #[must_use]
    pub fn command_started(&mut self) -> COMMAND_STARTED_W<12> {
        COMMAND_STARTED_W::new(self)
    }
    #[doc = "Bit 13 - 13:13\\]
Select which CPU interrupt vector the RFCPEIFG.FG_COMMAND_STARTED interrupt should use."]
    #[inline(always)]
    #[must_use]
    pub fn fg_command_started(&mut self) -> FG_COMMAND_STARTED_W<13> {
        FG_COMMAND_STARTED_W::new(self)
    }
    #[doc = "Bit 14 - 14:14\\]
Select which CPU interrupt vector the RFCPEIFG.IRQ14 interrupt should use."]
    #[inline(always)]
