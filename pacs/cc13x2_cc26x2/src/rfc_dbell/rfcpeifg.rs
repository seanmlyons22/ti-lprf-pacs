...
pub type COMMAND_STARTED_R = crate::BitReader<bool>;
#[doc = "Field `COMMAND_STARTED` writer - 12:12\\]
Interrupt flag 12. A radio operation command has gone into active state."]
pub type COMMAND_STARTED_W<'a, const O: u8> = crate::BitWriter<'a, u32, RFCPEIFG_SPEC, bool, O>;
...
pub type FG_COMMAND_STARTED_R = crate::BitReader<bool>;
#[doc = "Field `FG_COMMAND_STARTED` writer - 13:13\\]
Interrupt flag 13. IEEE 802.15.4 mode only: A foreground radio operation command has gone into active state."]
pub type FG_COMMAND_STARTED_W<'a, const O: u8> = crate::BitWriter<'a, u32, RFCPEIFG_SPEC, bool, O>;
