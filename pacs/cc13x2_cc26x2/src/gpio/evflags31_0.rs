#[doc = "Register `EVFLAGS31_0` reader"]
pub struct R(crate::R<EVFLAGS31_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EVFLAGS31_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EVFLAGS31_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EVFLAGS31_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EVFLAGS31_0` writer"]
pub struct W(crate::W<EVFLAGS31_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EVFLAGS31_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EVFLAGS31_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EVFLAGS31_0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Event Register for DIO 0 to 31 Reading this registers will return 1 for triggered event and 0 for non-triggered events. Writing a 1 to a bit field will clear the event. The configuration of events is done inside MCU IOC, e.g. events for DIO #0 is configured in IOC:IOCFG0.EDGE_DET and IOC:IOCFG0.EDGE_IRQ_EN.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [evflags31_0](index.html) module"]
pub struct EVFLAGS31_0_SPEC;
impl crate::RegisterSpec for EVFLAGS31_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [evflags31_0::R](R) reader structure"]
impl crate::Readable for EVFLAGS31_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [evflags31_0::W](W) writer structure"]
impl crate::Writable for EVFLAGS31_0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets EVFLAGS31_0 to value 0"]
impl crate::Resettable for EVFLAGS31_0_SPEC {
