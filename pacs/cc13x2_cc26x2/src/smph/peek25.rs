...
pub type R = crate::R<Peek25Spec>;
#[doc = "Register `PEEK25` writer"]
pub type W = crate::W<Peek25Spec>;
...
Status when reading: 0: Semaphore is taken 1: Semaphore is available Used for semaphore debugging. A read operation will not change register value. Register writing is not possible."]
    #[inline(always)]
    #[must_use]
    pub fn stat(&mut self) -> StatW<Peek25Spec> {
        StatW::new(self, 0)
    }
    #[doc = "Bits 1:31 - 31:1\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved1(&mut self) -> Reserved1W<Peek25Spec> {
        Reserved1W::new(self, 1)
    }
}
#[doc = "MCU SEMAPHORE 25 ALIAS\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`peek25::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`peek25::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Peek25Spec;
impl crate::RegisterSpec for Peek25Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`peek25::R`](R) reader structure"]
impl crate::Readable for Peek25Spec {}
#[doc = "`write(|w| ..)` method takes [`peek25::W`](W) writer structure"]
impl crate::Writable for Peek25Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PEEK25 to value 0x01"]
impl crate::Resettable for Peek25Spec {
