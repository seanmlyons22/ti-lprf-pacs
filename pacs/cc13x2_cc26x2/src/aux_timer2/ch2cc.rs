...
pub struct R(crate::R<CH2CC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH2CC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH2CC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH2CC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH2CC` writer"]
pub struct W(crate::W<CH2CC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH2CC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH2CC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH2CC_SPEC>) -> Self {
        W(writer)
    }
}
...
Capture Compare value. 16-bit user defined compare value or channel-updated capture value. Compare mode: VALUE is compared against CNTR.VALUE and an event is generated as specified by CH2EVCFG.CCACT when these are equal. Capture mode: The current counter value is stored in VALUE when a capture event occurs. CH2EVCFG.CCACT determines if VALUE is a signal period or a regular capture value."]
pub type VALUE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH2CC_SPEC, u16, u16, 16, O>;
#[doc = "Field `RESERVED16` reader - 31:16\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED16_R = crate::FieldReader<u16, u16>;
#[doc = "Field `RESERVED16` writer - 31:16\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED16_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH2CC_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - 15:0\\]
Capture Compare value. 16-bit user defined compare value or channel-updated capture value. Compare mode: VALUE is compared against CNTR.VALUE and an event is generated as specified by CH2EVCFG.CCACT when these are equal. Capture mode: The current counter value is stored in VALUE when a capture event occurs. CH2EVCFG.CCACT determines if VALUE is a signal period or a regular capture value."]
    #[inline(always)]
