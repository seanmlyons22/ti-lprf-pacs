#[doc = "Register `CH2EVCFG` reader"]
pub struct R(crate::R<CH2EVCFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH2EVCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH2EVCFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH2EVCFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH2EVCFG` writer"]
pub struct W(crate::W<CH2EVCFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH2EVCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH2EVCFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH2EVCFG_SPEC>) -> Self {
        W(writer)
    }
}
...
#[repr(u8)]
pub enum CCACT_A {
    #[doc = "15: Pulse on compare repeatedly. Channel function sequence: - Pulse enabled events when CH2CC.VALUE = CNTR.VALUE. The event is high for two timer clock periods."]
    PULSE_ON_CMP = 15,
    #[doc = "14: Toggle on compare repeatedly. Channel function sequence: - Toggle enabled events when CH2CC.VALUE = CNTR.VALUE."]
    TGL_ON_CMP = 14,
    #[doc = "13: Set on compare repeatedly. Channel function sequence: - Set enabled events when CH2CC.VALUE = CNTR.VALUE."]
    SET_ON_CMP = 13,
    #[doc = "12: Clear on compare repeatedly. Channel function sequence: - Clear enabled events when CH2CC.VALUE = CNTR.VALUE."]
    CLR_ON_CMP = 12,
    ...
    #[doc = "7: Pulse on compare, and then disable channel. Channel function sequence: - Pulse enabled events when CH2CC.VALUE = CNTR.VALUE. - Disable channel. The event is high for two timer clock periods."]
    PULSE_ON_CMP_DIS = 7,
    #[doc = "6: Toggle on compare, and then disable channel. Channel function sequence: - Toggle enabled events when CH2CC.VALUE = CNTR.VALUE. - Disable channel."]
    TGL_ON_CMP_DIS = 6,
    #[doc = "5: Set on compare, and then disable channel. Channel function sequence: - Set enabled events when CH2CC.VALUE = CNTR.VALUE. - Disable channel."]
    SET_ON_CMP_DIS = 5,
    #[doc = "4: Clear on compare, and then disable channel. Channel function sequence: - Clear enabled events when CH2CC.VALUE = CNTR.VALUE. - Disable channel."]
    CLR_ON_CMP_DIS = 4,
    #[doc = "3: Set on zero, toggle on compare, and then disable channel. Channel function sequence: - Set enabled events when CNTR.VALUE = 0. - Toggle enabled events when CH2CC.VALUE = CNTR.VALUE. - Disable channel. Enabled events are cleared when CH2CC.VALUE = 0 and CNTR.VALUE = 0."]
    SET_ON_0_TGL_ON_CMP_DIS = 3,
    #[doc = "2: Clear on zero, toggle on compare, and then disable channel. Channel function sequence: - Clear enabled events when CNTR.VALUE = 0. - Toggle enabled events when CH2CC.VALUE = CNTR.VALUE. - Disable channel. Enabled events are set when CH2CC.VALUE = 0 and CNTR.VALUE = 0."]
    CLR_ON_0_TGL_ON_CMP_DIS = 2,
    #[doc = "1: Set on capture, and then disable channel. Channel function sequence: - Set enabled events on capture event and copy CNTR.VALUE to CH2CC.VALUE. - Disable channel. Primary use scenario is to select this function before you start the timer. Follow these steps if you need to select this function while CTL.MODE is different from DIS: - Set to SET_ON_CAPT with no event enable. - Configure CH2CCFG (optional). - Wait for three timer clock periods as defined in PRECFG before you set to SET_ON_CAPT_DIS. Event enable is optional. These steps prevent capture events caused by expired signal values in edge-detection circuit."]
    SET_ON_CAPT_DIS = 1,
...
pub type CCACT_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CH2EVCFG_SPEC, u8, CCACT_A, 4, O>;
impl<'a, const O: u8> CCACT_W<'a, O> {
    #[doc = "Pulse on compare repeatedly. Channel function sequence: - Pulse enabled events when CH2CC.VALUE = CNTR.VALUE. The event is high for two timer clock periods."]
    #[inline(always)]
    pub fn pulse_on_cmp(self) -> &'a mut W {
        self.variant(CCACT_A::PULSE_ON_CMP)
    }
    #[doc = "Toggle on compare repeatedly. Channel function sequence: - Toggle enabled events when CH2CC.VALUE = CNTR.VALUE."]
    #[inline(always)]
    pub fn tgl_on_cmp(self) -> &'a mut W {
        self.variant(CCACT_A::TGL_ON_CMP)
    }
    #[doc = "Set on compare repeatedly. Channel function sequence: - Set enabled events when CH2CC.VALUE = CNTR.VALUE."]
    #[inline(always)]
    pub fn set_on_cmp(self) -> &'a mut W {
        self.variant(CCACT_A::SET_ON_CMP)
    }
    #[doc = "Clear on compare repeatedly. Channel function sequence: - Clear enabled events when CH2CC.VALUE = CNTR.VALUE."]
    #[inline(always)]
    ...
    #[doc = "Pulse on compare, and then disable channel. Channel function sequence: - Pulse enabled events when CH2CC.VALUE = CNTR.VALUE. - Disable channel. The event is high for two timer clock periods."]
    #[inline(always)]
    pub fn pulse_on_cmp_dis(self) -> &'a mut W {
        self.variant(CCACT_A::PULSE_ON_CMP_DIS)
    }
    #[doc = "Toggle on compare, and then disable channel. Channel function sequence: - Toggle enabled events when CH2CC.VALUE = CNTR.VALUE. - Disable channel."]
    #[inline(always)]
    pub fn tgl_on_cmp_dis(self) -> &'a mut W {
        self.variant(CCACT_A::TGL_ON_CMP_DIS)
    }
    #[doc = "Set on compare, and then disable channel. Channel function sequence: - Set enabled events when CH2CC.VALUE = CNTR.VALUE. - Disable channel."]
    #[inline(always)]
    pub fn set_on_cmp_dis(self) -> &'a mut W {
        self.variant(CCACT_A::SET_ON_CMP_DIS)
    }
    #[doc = "Clear on compare, and then disable channel. Channel function sequence: - Clear enabled events when CH2CC.VALUE = CNTR.VALUE. - Disable channel."]
    #[inline(always)]
    pub fn clr_on_cmp_dis(self) -> &'a mut W {
        self.variant(CCACT_A::CLR_ON_CMP_DIS)
    }
    #[doc = "Set on zero, toggle on compare, and then disable channel. Channel function sequence: - Set enabled events when CNTR.VALUE = 0. - Toggle enabled events when CH2CC.VALUE = CNTR.VALUE. - Disable channel. Enabled events are cleared when CH2CC.VALUE = 0 and CNTR.VALUE = 0."]
    #[inline(always)]
    pub fn set_on_0_tgl_on_cmp_dis(self) -> &'a mut W {
        self.variant(CCACT_A::SET_ON_0_TGL_ON_CMP_DIS)
    }
    #[doc = "Clear on zero, toggle on compare, and then disable channel. Channel function sequence: - Clear enabled events when CNTR.VALUE = 0. - Toggle enabled events when CH2CC.VALUE = CNTR.VALUE. - Disable channel. Enabled events are set when CH2CC.VALUE = 0 and CNTR.VALUE = 0."]
    #[inline(always)]
...
Event 0 enable. 0: Channel 2 does not control event 0. 1: Channel 2 controls event 0. When 0 < CCACT < 8, EV0_GEN becomes zero after a capture or compare event."]
pub type EV0_GEN_R = crate::BitReader<bool>;
#[doc = "Field `EV0_GEN` writer - 4:4\\]
Event 0 enable. 0: Channel 2 does not control event 0. 1: Channel 2 controls event 0. When 0 < CCACT < 8, EV0_GEN becomes zero after a capture or compare event."]
pub type EV0_GEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH2EVCFG_SPEC, bool, O>;
#[doc = "Field `EV1_GEN` reader - 5:5\\]
Event 1 enable. 0: Channel 2 does not control event 1. 1: Channel 2 controls event 1. When 0 < CCACT < 8, EV1_GEN becomes zero after a capture or compare event."]
pub type EV1_GEN_R = crate::BitReader<bool>;
#[doc = "Field `EV1_GEN` writer - 5:5\\]
Event 1 enable. 0: Channel 2 does not control event 1. 1: Channel 2 controls event 1. When 0 < CCACT < 8, EV1_GEN becomes zero after a capture or compare event."]
pub type EV1_GEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH2EVCFG_SPEC, bool, O>;
#[doc = "Field `EV2_GEN` reader - 6:6\\]
Event 2 enable. 0: Channel 2 does not control event 2. 1: Channel 2 controls event 2. When 0 < CCACT < 8, EV2_GEN becomes zero after a capture or compare event."]
pub type EV2_GEN_R = crate::BitReader<bool>;
#[doc = "Field `EV2_GEN` writer - 6:6\\]
Event 2 enable. 0: Channel 2 does not control event 2. 1: Channel 2 controls event 2. When 0 < CCACT < 8, EV2_GEN becomes zero after a capture or compare event."]
pub type EV2_GEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH2EVCFG_SPEC, bool, O>;
#[doc = "Field `EV3_GEN` reader - 7:7\\]
Event 3 enable. 0: Channel 2 does not control event 3. 1: Channel 2 controls event 3. When 0 < CCACT < 8, EV3_GEN becomes zero after a capture or compare event."]
pub type EV3_GEN_R = crate::BitReader<bool>;
#[doc = "Field `EV3_GEN` writer - 7:7\\]
Event 3 enable. 0: Channel 2 does not control event 3. 1: Channel 2 controls event 3. When 0 < CCACT < 8, EV3_GEN becomes zero after a capture or compare event."]
pub type EV3_GEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH2EVCFG_SPEC, bool, O>;
#[doc = "Field `RESERVED8` reader - 31:8\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED8_R = crate::FieldReader<u32, u32>;
#[doc = "Field `RESERVED8` writer - 31:8\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED8_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH2EVCFG_SPEC, u32, u32, 24, O>;
impl R {
    #[doc = "Bits 0:3 - 3:0\\]
Capture-Compare action. Capture-Compare action defines 15 different channel functions that utilize capture, compare, and zero events."]
    #[inline(always)]
