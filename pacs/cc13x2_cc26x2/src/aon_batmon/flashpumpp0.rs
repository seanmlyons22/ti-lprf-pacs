...
#[doc = "Field `DIS_NOISE_FILTER` reader - 9:9\\]
Internal. Only to be used through TI provided API."]
pub type DIS_NOISE_FILTER_R = crate::BitReader<bool>;
#[doc = "Field `DIS_NOISE_FILTER` writer - 9:9\\]
Internal. Only to be used through TI provided API."]
pub type DIS_NOISE_FILTER_W<'a, const O: u8> = crate::BitWriter<'a, u32, FLASHPUMPP0_SPEC, bool, O>;
...
pub type RESERVED9_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FLASHPUMPP0_SPEC, u32, u32, 22, O>;
impl R {
    #[doc = "Bits 0:3 - 3:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn dis_noise_filter(&self) -> DIS_NOISE_FILTER_R {
        DIS_NOISE_FILTER_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bits 10:31 - 31:10\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn reserved9(&self) -> RESERVED9_R {
        RESERVED9_R::new((self.bits >> 10) & 0x003f_ffff)
    }
}
impl W {
    #[doc = "Bits 0:3 - 3:0\\]
...
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn dis_noise_filter(&mut self) -> DIS_NOISE_FILTER_W<9> {
        DIS_NOISE_FILTER_W::new(self)
    }
    #[doc = "Bits 10:31 - 31:10\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn reserved9(&mut self) -> RESERVED9_W<10> {
