...
pub struct R(crate::R<SECDMACLKGDS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SECDMACLKGDS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SECDMACLKGDS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SECDMACLKGDS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SECDMACLKGDS` writer"]
pub struct W(crate::W<SECDMACLKGDS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SECDMACLKGDS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SECDMACLKGDS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SECDMACLKGDS_SPEC>) -> Self {
        W(writer)
    }
}
...
0: Disable clock 1: Enable clock SYSBUS clock will always run when enabled Can be forced on by SECDMACLKGR.CRYPTO_AM_CLK_EN For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
pub type CRYPTO_CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SECDMACLKGDS_SPEC, bool, O>;
...
0: Disable clock 1: Enable clock SYSBUS clock will always run when enabled Can be forced on by SECDMACLKGR.TRNG_AM_CLK_EN For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
pub type TRNG_CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SECDMACLKGDS_SPEC, bool, O>;
...
0: Disable clock 1: Enable clock Can be forced on by SECDMACLKGR.PKA_AM_CLK_EN For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
pub type PKA_CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SECDMACLKGDS_SPEC, bool, O>;
...
pub type RESERVED3_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SECDMACLKGDS_SPEC, u8, u8, 5, O>;
...
0: Disable clock 1: Enable clock Can be forced on by SECDMACLKGR.DMA_AM_CLK_EN For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
pub type DMA_CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SECDMACLKGDS_SPEC, bool, O>;
...
pub type RESERVED9_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SECDMACLKGDS_SPEC, u32, u32, 23, O>;
impl R {
    #[doc = "Bit 0 - 0:0\\]
0: Disable clock 1: Enable clock SYSBUS clock will always run when enabled Can be forced on by SECDMACLKGR.CRYPTO_AM_CLK_EN For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    #[inline(always)]
