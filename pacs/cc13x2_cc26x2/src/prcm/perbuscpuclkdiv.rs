#[doc = "Register `PERBUSCPUCLKDIV` reader"]
pub struct R(crate::R<PERBUSCPUCLKDIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PERBUSCPUCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PERBUSCPUCLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PERBUSCPUCLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PERBUSCPUCLKDIV` writer"]
pub struct W(crate::W<PERBUSCPUCLKDIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PERBUSCPUCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PERBUSCPUCLKDIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PERBUSCPUCLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RATIO_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PERBUSCPUCLKDIV_SPEC, u8, RATIO_A, 4, O>;
...
pub type RESERVED4_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PERBUSCPUCLKDIV_SPEC, u32, u32, 28, O>;
impl R {
    #[doc = "Bits 0:3 - 3:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
...
#[doc = "Internal. Only to be used through TI provided API.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [perbuscpuclkdiv](index.html) module"]
pub struct PERBUSCPUCLKDIV_SPEC;
impl crate::RegisterSpec for PERBUSCPUCLKDIV_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [perbuscpuclkdiv::R](R) reader structure"]
impl crate::Readable for PERBUSCPUCLKDIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [perbuscpuclkdiv::W](W) writer structure"]
impl crate::Writable for PERBUSCPUCLKDIV_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PERBUSCPUCLKDIV to value 0"]
impl crate::Resettable for PERBUSCPUCLKDIV_SPEC {
