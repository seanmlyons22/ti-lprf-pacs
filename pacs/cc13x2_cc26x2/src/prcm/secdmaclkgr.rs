...
0: Disable clock 1: Enable clock Can be forced on by PKA_AM_CLK_EN For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
pub type PKA_CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SECDMACLKGR_SPEC, bool, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SECDMACLKGR_SPEC, u8, u8, 5, O>;
...
pub type PKA_AM_CLK_EN_R = crate::BitReader<bool>;
#[doc = "Field `PKA_AM_CLK_EN` writer - 18:18\\]
0: No force 1: Force clock on for all modes (Run, Sleep and Deep Sleep) Overrides PKA_CLK_EN, SECDMACLKGS.PKA_CLK_EN and SECDMACLKGDS.PKA_CLK_EN when enabled. For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
pub type PKA_AM_CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SECDMACLKGR_SPEC, bool, O>;
...
pub type PKA_ZERIOZE_RESET_N_R = crate::BitReader<bool>;
#[doc = "Field `PKA_ZERIOZE_RESET_N` writer - 19:19\\]
Zeroization logic hardware reset. 0: pka_zeroize logic inactive. 1: pka_zeroize of memory is enabled. This register must remain active until the memory are completely zeroized which requires 256 periods on systembus clock."]
pub type PKA_ZERIOZE_RESET_N_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SECDMACLKGR_SPEC, bool, O>;
...
pub type RESERVED20_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SECDMACLKGR_SPEC, u8, u8, 4, O>;
...
0: No force 1: Force clock on for all modes (Run, Sleep and Deep Sleep) Overrides PKA_CLK_EN, SECDMACLKGS.PKA_CLK_EN and SECDMACLKGDS.PKA_CLK_EN when enabled. For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    ...
    pub fn pka_am_clk_en(&self) -> PKA_AM_CLK_EN_R {
        PKA_AM_CLK_EN_R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - 19:19\\]
Zeroization logic hardware reset. 0: pka_zeroize logic inactive. 1: pka_zeroize of memory is enabled. This register must remain active until the memory are completely zeroized which requires 256 periods on systembus clock."]
    #[inline(always)]
    pub fn pka_zerioze_reset_n(&self) -> PKA_ZERIOZE_RESET_N_R {
        PKA_ZERIOZE_RESET_N_R::new(((self.bits >> 19) & 1) != 0)
    }
...
0: No force 1: Force clock on for all modes (Run, Sleep and Deep Sleep) Overrides PKA_CLK_EN, SECDMACLKGS.PKA_CLK_EN and SECDMACLKGDS.PKA_CLK_EN when enabled. For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    #[inline(always)]
    #[must_use]
    pub fn pka_am_clk_en(&mut self) -> PKA_AM_CLK_EN_W<18> {
        PKA_AM_CLK_EN_W::new(self)
    }
    #[doc = "Bit 19 - 19:19\\]
Zeroization logic hardware reset. 0: pka_zeroize logic inactive. 1: pka_zeroize of memory is enabled. This register must remain active until the memory are completely zeroized which requires 256 periods on systembus clock."]
    #[inline(always)]
    #[must_use]
    pub fn pka_zerioze_reset_n(&mut self) -> PKA_ZERIOZE_RESET_N_W<19> {
        PKA_ZERIOZE_RESET_N_W::new(self)
    }
    #[doc = "Bits 20:23 - 23:20\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
