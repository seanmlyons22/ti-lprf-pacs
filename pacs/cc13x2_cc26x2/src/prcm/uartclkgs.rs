...
pub type R = crate::R<UartclkgsSpec>;
#[doc = "Register `UARTCLKGS` writer"]
pub type W = crate::W<UartclkgsSpec>;
#[doc = "1:0\\]
...
0: Disable clock 1: Enable clock Can be forced on by UARTCLKGR.AM_CLK_EN For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    #[inline(always)]
    #[must_use]
    pub fn clk_en(&mut self) -> ClkEnW<UartclkgsSpec> {
        ClkEnW::new(self, 0)
    }
    #[doc = "Bits 2:31 - 31:2\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved2(&mut self) -> Reserved2W<UartclkgsSpec> {
        Reserved2W::new(self, 2)
    }
}
#[doc = "UART Clock Gate For Sleep Mode\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`uartclkgs::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`uartclkgs::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UartclkgsSpec;
impl crate::RegisterSpec for UartclkgsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uartclkgs::R`](R) reader structure"]
impl crate::Readable for UartclkgsSpec {}
#[doc = "`write(|w| ..)` method takes [`uartclkgs::W`](W) writer structure"]
impl crate::Writable for UartclkgsSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets UARTCLKGS to value 0"]
impl crate::Resettable for UartclkgsSpec {
