...
impl AmClkEnR {
    ...
    pub const fn variant(&self) -> Option<AmClkEn> {
        match self.bits {
            8 => Some(AmClkEn::AmGpt3),
            4 => Some(AmClkEn::AmGpt2),
            2 => Some(AmClkEn::AmGpt1),
            1 => Some(AmClkEn::AmGpt0),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    #[doc = "Enable clock for GPT3 in all modes"]
    #[inline(always)]
    pub fn am_gpt3(self) -> &'a mut crate::W<REG> {
        self.variant(AmClkEn::AmGpt3)
    }
    #[doc = "Enable clock for GPT2 in all modes"]
    #[inline(always)]
    pub fn am_gpt2(self) -> &'a mut crate::W<REG> {
        self.variant(AmClkEn::AmGpt2)
    }
    #[doc = "Enable clock for GPT1 in all modes"]
    #[inline(always)]
    pub fn am_gpt1(self) -> &'a mut crate::W<REG> {
        self.variant(AmClkEn::AmGpt1)
    }
    #[doc = "Enable clock for GPT0 in all modes"]
    #[inline(always)]
    pub fn am_gpt0(self) -> &'a mut crate::W<REG> {
        self.variant(AmClkEn::AmGpt0)
    }
}
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved4(&mut self) -> Reserved4W<GptclkgrSpec> {
...
Each bit below has the following meaning: 0: No force 1: Force clock on for all modes (Run, Sleep and Deep Sleep) Overrides CLK_EN, GPTCLKGS.CLK_EN and GPTCLKGDS.CLK_EN when enabled. ENUMs can be combined For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    #[inline(always)]
    #[must_use]
    pub fn am_clk_en(&mut self) -> AmClkEnW<GptclkgrSpec> {
        AmClkEnW::new(self, 8)
    }
    #[doc = "Bits 12:31 - 31:12\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved12(&mut self) -> Reserved12W<GptclkgrSpec> {
