...
pub type PORT_ID_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IOCFG30_SPEC, u8, PORT_ID_A, 6, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED15_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG30_SPEC, bool, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED31_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOCFG30_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:5 - 5:0\\]
Selects usage for DIO30 Note: This field should not be written other than the times when PORT_ID value is specifically required to change."]
    #[inline(always)]
...
#[doc = "`reset()` method sets IOCFG30 to value 0x6000"]
