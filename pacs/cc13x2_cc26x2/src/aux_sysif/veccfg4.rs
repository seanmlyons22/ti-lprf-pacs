...
pub struct R(crate::R<VECCFG4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<VECCFG4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<VECCFG4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<VECCFG4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `VECCFG4` writer"]
pub struct W(crate::W<VECCFG4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<VECCFG4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<VECCFG4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<VECCFG4_SPEC>) -> Self {
        W(writer)
    }
}
...
Select trigger event for vector 4. Non-enumerated values are treated as NONE."]
pub type VEC_EV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, VECCFG4_SPEC, u8, VEC_EV_A, 4, O>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
pub type RESERVED4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, VECCFG4_SPEC, u32, u32, 28, O>;
impl R {
    #[doc = "Bits 0:3 - 3:0\\]
Select trigger event for vector 4. Non-enumerated values are treated as NONE."]
    #[inline(always)]
