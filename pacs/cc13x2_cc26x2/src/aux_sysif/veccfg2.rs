...
pub type R = crate::R<Veccfg2Spec>;
#[doc = "Register `VECCFG2` writer"]
pub type W = crate::W<Veccfg2Spec>;
#[doc = "3:0\\]
...
Select trigger event for vector 2. Non-enumerated values are treated as NONE."]
    #[inline(always)]
    #[must_use]
    pub fn vec_ev(&mut self) -> VecEvW<Veccfg2Spec> {
        VecEvW::new(self, 0)
    }
    #[doc = "Bits 4:31 - 31:4\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved4(&mut self) -> Reserved4W<Veccfg2Spec> {
        Reserved4W::new(self, 4)
    }
}
#[doc = "Vector Configuration 2 AUX_SCE wakeup vector 2 configuration\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`veccfg2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`veccfg2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Veccfg2Spec;
impl crate::RegisterSpec for Veccfg2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`veccfg2::R`](R) reader structure"]
impl crate::Readable for Veccfg2Spec {}
#[doc = "`write(|w| ..)` method takes [`veccfg2::W`](W) writer structure"]
impl crate::Writable for Veccfg2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets VECCFG2 to value 0"]
impl crate::Resettable for Veccfg2Spec {
