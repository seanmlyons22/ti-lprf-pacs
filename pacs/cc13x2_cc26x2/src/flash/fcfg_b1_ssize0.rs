...
pub type B1_SECT_SIZE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `B1_SECT_SIZE` writer - 31:0\\]
Internal. Only to be used through TI provided API."]
pub type B1_SECT_SIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FCFG_B1_SSIZE0_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    pub fn b1_sect_size(&self) -> B1_SECT_SIZE_R {
        B1_SECT_SIZE_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - 31:0\\]
Internal. Only to be used through TI provided API."]
    #[inline(always)]
    #[must_use]
    pub fn b1_sect_size(&mut self) -> B1_SECT_SIZE_W<0> {
        B1_SECT_SIZE_W::new(self)
    }
