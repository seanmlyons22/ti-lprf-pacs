...
#[doc = "Field `RESERVED_31_26` reader - 31:26\\]
Reserved"]
pub type Reserved31_26R = crate::FieldReader;
#[doc = "Field `RESERVED_31_26` writer - 31:26\\]
Reserved"]
pub type Reserved31_26W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:15 - 15:0\\]
Current Bank Address A bank offset address is stored in this register."]
    #[inline(always)]
...
Reserved"]
    #[inline(always)]
    pub fn reserved_31_26(&self) -> Reserved31_26R {
        Reserved31_26R::new(((self.bits >> 26) & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:15 - 15:0\\]
...
Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn reserved_31_26(&mut self) -> Reserved31_26W<StataddrSpec> {
        Reserved31_26W::new(self, 26)
    }
}
...
#[doc = "`reset()` method sets STATADDR to value 0x0021_0000"]
