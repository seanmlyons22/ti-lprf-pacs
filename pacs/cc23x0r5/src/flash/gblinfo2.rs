...
Number of data registers present."]
pub type DataregistersW<'a, REG> = crate::FieldWriter<'a, REG, 4, Dataregisters>;
impl<'a, REG> DataregistersW<'a, REG>
where
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn maximum(self) -> &'a mut crate::W<REG> {
        self.variant(Dataregisters::Maximum)
    }
    #[doc = "Minimum value of DATAREGISTERS"]
    #[inline(always)]
    pub fn minimum(self) -> &'a mut crate::W<REG> {
        self.variant(Dataregisters::Minimum)
    }
}
#[doc = "Field `RESERVED_31_4` reader - 31:4\\]
Reserved"]
pub type Reserved31_4R = crate::FieldReader<u32>;
#[doc = "Field `RESERVED_31_4` writer - 31:4\\]
Reserved"]
pub type Reserved31_4W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    #[doc = "Bits 0:3 - 3:0\\]
Number of data registers present."]
    #[inline(always)]
...
Number of data registers present."]
    #[inline(always)]
    #[must_use]
    pub fn dataregisters(&mut self) -> DataregistersW<Gblinfo2Spec> {
        DataregistersW::new(self, 0)
    }
    #[doc = "Bits 4:31 - 31:4\\]
Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn reserved_31_4(&mut self) -> Reserved31_4W<Gblinfo2Spec> {
        Reserved31_4W::new(self, 4)
    }
}
