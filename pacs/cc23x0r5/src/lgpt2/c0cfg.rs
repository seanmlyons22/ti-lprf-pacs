#[doc = "Register `C0CFG` reader"]
pub type R = crate::R<C0cfgSpec>;
#[doc = "Register `C0CFG` writer"]
pub type W = crate::W<C0cfgSpec>;
#[doc = "3:0\\]
Capture-Compare action. Capture-Compare action defines 15 different channel functions that utilize capture, compare, and zero events. In every compare event the timer looks at the current value of CNTR. The corresponding output event will be set 1 timer period after CNTR = C0CC.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Ccact {
    #[doc = "15: Pulse on compare repeatedly. Channel function sequence: - Pulse enabled outputs when C0CC.VAL = CNTR.VAL. The output is high for two timer clock periods."]
    PulseOnCmp = 15,
    #[doc = "14: Toggle on compare repeatedly. Channel function sequence: - Toggle enabled outputs when C0CC.VAL = CNTR.VAL."]
    TglOnCmp = 14,
    #[doc = "13: Set on compare repeatedly. Channel function sequence: - Set enabled outputs when C0CC.VAL = CNTR.VAL."]
    SetOnCmp = 13,
    #[doc = "12: Clear on compare repeatedly. Channel function sequence: - Clear enabled outputs when C0CC.VAL = CNTR.VAL."]
    ClrOnCmp = 12,
    #[doc = "11: Set on zero, toggle on compare repeatedly. Channel function sequence: - Set enabled outputs when CNTR.VAL = 0. - Toggle enabled outputs when C0CC.VAL = CNTR.VAL. Set CTL.MODE to UP_PER for edge-aligned PWM generation. Duty cycle is given by: When C0CC.VAL $lt;= TGT.VAL: Duty cycle = C0CC.VAL / ( TGT.VAL + 1 ). When C0CC.VAL $gt; TGT.VAL: Duty cycle = 1. Enabled outputs are cleared when C0CC.VAL = 0 and CNTR.VAL = 0."]
    SetOn0TglOnCmp = 11,
    #[doc = "10: Clear on zero, toggle on compare repeatedly. Channel function sequence: - Clear enabled outputs when CNTR.VAL = 0. - Toggle enabled outputs when C0CC.VAL = CNTR.VAL. Set CTL.MODE to UPDWN_PER for center-aligned PWM generation. Duty cycle is given by: When C0CC.VAL $lt;= TGT.VAL: Duty cycle = 1 - ( C0CC.VAL / TGT.VAL ). When C0CC.VAL $gt; TGT.VAL: Duty cycle = 0. Enabled outputs are set when C0CC.VAL = 0 and CNTR.VAL = 0."]
    ClrOn0TglOnCmp = 10,
    #[doc = "9: Set on capture repeatedly. Channel function sequence: - Set enabled outputs on capture event and copy CNTR.VAL to C0CC.VAL."]
    SetOnCapt = 9,
    ...
    PerPulseWidthMeas = 8,
    #[doc = "7: Pulse on compare, and then disable channel. Channel function sequence: - Pulse enabled outputs when C0CC.VAL = CNTR.VAL. - Disable channel. The output is high for two timer clock periods."]
    PulseOnCmpDis = 7,
    #[doc = "6: Toggle on compare, and then disable channel. Channel function sequence: - Toggle enabled outputs when C0CC.VAL = CNTR.VAL. - Disable channel."]
    TglOnCmpDis = 6,
    #[doc = "5: Set on compare, and then disable channel. Channel function sequence: - Set enabled outputs when C0CC.VAL = CNTR.VAL. - Disable channel."]
    SetOnCmpDis = 5,
    #[doc = "4: Clear on compare, and then disable channel. Channel function sequence: - Clear enabled outputs when C0CC.VAL = CNTR.VAL. - Disable channel."]
    ClrOnCmpDis = 4,
    #[doc = "3: Set on zero, toggle on compare, and then disable channel. Channel function sequence: - Set enabled outputs when CNTR.VAL = 0. - Toggle enabled outputs when C0CC.VAL = CNTR.VAL. - Disable channel. Enabled outputs are cleared when C0CC.VAL = 0 and CNTR.VAL = 0."]
    SetOn0TglOnCmpDis = 3,
    #[doc = "2: Clear on zero, toggle on compare, and then disable channel. Channel function sequence: - Clear enabled outputs when CNTR.VAL = 0. - Toggle enabled outputs when C0CC.VAL = CNTR.VAL. - Disable channel. Enabled outputs are set when C0CC.VAL = 0 and CNTR.VAL = 0."]
    ClrOn0TglOnCmpDis = 2,
...
impl CcactR {
    ...
    #[doc = "Pulse on compare repeatedly. Channel function sequence: - Pulse enabled outputs when C0CC.VAL = CNTR.VAL. The output is high for two timer clock periods."]
    #[inline(always)]
    pub fn is_pulse_on_cmp(&self) -> bool {
        *self == Ccact::PulseOnCmp
    }
    #[doc = "Toggle on compare repeatedly. Channel function sequence: - Toggle enabled outputs when C0CC.VAL = CNTR.VAL."]
    #[inline(always)]
    pub fn is_tgl_on_cmp(&self) -> bool {
        *self == Ccact::TglOnCmp
    }
    #[doc = "Set on compare repeatedly. Channel function sequence: - Set enabled outputs when C0CC.VAL = CNTR.VAL."]
    #[inline(always)]
    pub fn is_set_on_cmp(&self) -> bool {
        *self == Ccact::SetOnCmp
    }
    #[doc = "Clear on compare repeatedly. Channel function sequence: - Clear enabled outputs when C0CC.VAL = CNTR.VAL."]
    #[inline(always)]
    ...
    #[doc = "Set on capture repeatedly. Channel function sequence: - Set enabled outputs on capture event and copy CNTR.VAL to C0CC.VAL."]
    #[inline(always)]
    ...
    #[doc = "Pulse on compare, and then disable channel. Channel function sequence: - Pulse enabled outputs when C0CC.VAL = CNTR.VAL. - Disable channel. The output is high for two timer clock periods."]
    #[inline(always)]
    pub fn is_pulse_on_cmp_dis(&self) -> bool {
        *self == Ccact::PulseOnCmpDis
    }
    #[doc = "Toggle on compare, and then disable channel. Channel function sequence: - Toggle enabled outputs when C0CC.VAL = CNTR.VAL. - Disable channel."]
    #[inline(always)]
    pub fn is_tgl_on_cmp_dis(&self) -> bool {
        *self == Ccact::TglOnCmpDis
    }
    #[doc = "Set on compare, and then disable channel. Channel function sequence: - Set enabled outputs when C0CC.VAL = CNTR.VAL. - Disable channel."]
    #[inline(always)]
    pub fn is_set_on_cmp_dis(&self) -> bool {
        *self == Ccact::SetOnCmpDis
    }
    #[doc = "Clear on compare, and then disable channel. Channel function sequence: - Clear enabled outputs when C0CC.VAL = CNTR.VAL. - Disable channel."]
    #[inline(always)]
    pub fn is_clr_on_cmp_dis(&self) -> bool {
        *self == Ccact::ClrOnCmpDis
    }
    #[doc = "Set on zero, toggle on compare, and then disable channel. Channel function sequence: - Set enabled outputs when CNTR.VAL = 0. - Toggle enabled outputs when C0CC.VAL = CNTR.VAL. - Disable channel. Enabled outputs are cleared when C0CC.VAL = 0 and CNTR.VAL = 0."]
    #[inline(always)]
    pub fn is_set_on_0_tgl_on_cmp_dis(&self) -> bool {
        *self == Ccact::SetOn0TglOnCmpDis
    }
    #[doc = "Clear on zero, toggle on compare, and then disable channel. Channel function sequence: - Clear enabled outputs when CNTR.VAL = 0. - Toggle enabled outputs when C0CC.VAL = CNTR.VAL. - Disable channel. Enabled outputs are set when C0CC.VAL = 0 and CNTR.VAL = 0."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Out0 {
    #[doc = "1: Channel 0 controls output 0."]
    En = 1,
    #[doc = "0: Channel 0 does not control output 0."]
    Dis = 0,
}
...
impl Out0R {
    ...
    #[doc = "Channel 0 controls output 0."]
    #[inline(always)]
    pub fn is_en(&self) -> bool {
        *self == Out0::En
    }
    #[doc = "Channel 0 does not control output 0."]
    #[inline(always)]
    pub fn is_dis(&self) -> bool {
        *self == Out0::Dis
    }
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Out1 {
    #[doc = "1: Channel 0 controls output 1."]
    En = 1,
    #[doc = "0: Channel 0 does not control output 1."]
    Dis = 0,
}
...
impl Out1R {
    ...
    #[doc = "Channel 0 controls output 1."]
    #[inline(always)]
    pub fn is_en(&self) -> bool {
        *self == Out1::En
    }
    #[doc = "Channel 0 does not control output 1."]
    #[inline(always)]
    pub fn is_dis(&self) -> bool {
        *self == Out1::Dis
    }
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Out2 {
    #[doc = "1: Channel 0 controls output 2."]
    En = 1,
    #[doc = "0: Channel 0 does not control output 2."]
    Dis = 0,
}
...
impl Out2R {
    ...
    #[doc = "Channel 0 controls output 2."]
    #[inline(always)]
    pub fn is_en(&self) -> bool {
        *self == Out2::En
    }
    #[doc = "Channel 0 does not control output 2."]
    #[inline(always)]
    pub fn is_dis(&self) -> bool {
        *self == Out2::Dis
    }
...
Capture-Compare action. Capture-Compare action defines 15 different channel functions that utilize capture, compare, and zero events. In every compare event the timer looks at the current value of CNTR. The corresponding output event will be set 1 timer period after CNTR = C0CC."]
    #[inline(always)]
    #[must_use]
    pub fn ccact(&mut self) -> CcactW<C0cfgSpec> {
        CcactW::new(self, 0)
    }
    #[doc = "Bits 4:5 - 5:4\\]
Determines the edge that triggers the channel input event. This happens post filter."]
    #[inline(always)]
    #[must_use]
    pub fn edge(&mut self) -> EdgeW<C0cfgSpec> {
        EdgeW::new(self, 4)
    }
    #[doc = "Bit 6 - 6:6\\]
Select channel input."]
    #[inline(always)]
    #[must_use]
    pub fn input(&mut self) -> InputW<C0cfgSpec> {
        InputW::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved7(&mut self) -> Reserved7W<C0cfgSpec> {
...
Output 0 enable. When 0 $lt; CCACT $lt; 8, OUT0 becomes zero after a capture or compare event."]
    #[inline(always)]
    #[must_use]
    pub fn out0(&mut self) -> Out0W<C0cfgSpec> {
        Out0W::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Output 1 enable. When 0 $lt; CCACT $lt; 8, OUT1 becomes zero after a capture or compare event."]
    #[inline(always)]
    #[must_use]
    pub fn out1(&mut self) -> Out1W<C0cfgSpec> {
        Out1W::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
Output 2 enable. When 0 $lt; CCACT $lt; 8, OUT2 becomes zero after a capture or compare event."]
    #[inline(always)]
    #[must_use]
    pub fn out2(&mut self) -> Out2W<C0cfgSpec> {
        Out2W::new(self, 10)
    }
    #[doc = "Bits 11:31 - 31:11\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
