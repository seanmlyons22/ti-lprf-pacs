#[doc = "Register `IOC15` reader"]
pub type R = crate::R<Ioc15Spec>;
#[doc = "Register `IOC15` writer"]
pub type W = crate::W<Ioc15Spec>;
#[doc = "2:0\\]
Port configuration.\n\nValue on reset: 0"]
...
Port configuration."]
    #[inline(always)]
    #[must_use]
    pub fn portcfg(&mut self) -> PortcfgW<Ioc15Spec> {
        PortcfgW::new(self, 0)
    }
    #[doc = "Bits 3:12 - 12:3\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved3(&mut self) -> Reserved3W<Ioc15Spec> {
...
Pull control. Setting this to value 0x3 disables pull."]
    #[inline(always)]
    #[must_use]
    pub fn pullctl(&mut self) -> PullctlW<Ioc15Spec> {
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved15(&mut self) -> Reserved15W<Ioc15Spec> {
...
Edge detect configuration"]
    #[inline(always)]
    #[must_use]
    pub fn edgedet(&mut self) -> EdgedetW<Ioc15Spec> {
...
Wakeup enable from standby"]
    #[inline(always)]
    #[must_use]
    pub fn wuensb(&mut self) -> WuensbW<Ioc15Spec> {
        WuensbW::new(self, 18)
    }
    #[doc = "Bit 19 - 19:19\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved19(&mut self) -> Reserved19W<Ioc15Spec> {
...
Wakeup configuration from shutdown"]
    #[inline(always)]
    #[must_use]
    pub fn wucfgsd(&mut self) -> WucfgsdW<Ioc15Spec> {
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved22(&mut self) -> Reserved22W<Ioc15Spec> {
...
IO Mode. Setting this to value 0x6 or 0x7 will default to normal IO behavior."]
    #[inline(always)]
    #[must_use]
    pub fn iomode(&mut self) -> IomodeW<Ioc15Spec> {
        IomodeW::new(self, 24)
    }
    #[doc = "Bits 27:28 - 28:27\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved27(&mut self) -> Reserved27W<Ioc15Spec> {
...
Input enable"]
    #[inline(always)]
    #[must_use]
    pub fn inpen(&mut self) -> InpenW<Ioc15Spec> {
        InpenW::new(self, 29)
    }
    #[doc = "Bit 30 - 30:30\\]
This field controls input hysteresis"]
    #[inline(always)]
    #[must_use]
    pub fn hysten(&mut self) -> HystenW<Ioc15Spec> {
        HystenW::new(self, 30)
    }
    #[doc = "Bit 31 - 31:31\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved31(&mut self) -> Reserved31W<Ioc15Spec> {
        Reserved31W::new(self, 31)
    }
}
#[doc = "Configuration of DIO15\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ioc15::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ioc15::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ioc15Spec;
impl crate::RegisterSpec for Ioc15Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ioc15::R`](R) reader structure"]
impl crate::Readable for Ioc15Spec {}
#[doc = "`write(|w| ..)` method takes [`ioc15::W`](W) writer structure"]
impl crate::Writable for Ioc15Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets IOC15 to value 0"]
impl crate::Resettable for Ioc15Spec {
