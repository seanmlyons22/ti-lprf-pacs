#[doc = "Register `IOC14` reader"]
pub type R = crate::R<Ioc14Spec>;
#[doc = "Register `IOC14` writer"]
pub type W = crate::W<Ioc14Spec>;
#[doc = "2:0\\]
Port configuration.\n\nValue on reset: 0"]
...
Port configuration."]
    #[inline(always)]
    #[must_use]
    pub fn portcfg(&mut self) -> PortcfgW<Ioc14Spec> {
        PortcfgW::new(self, 0)
    }
    #[doc = "Bits 3:12 - 12:3\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved3(&mut self) -> Reserved3W<Ioc14Spec> {
...
Pull control. Setting this to value 0x3 disables pull."]
    #[inline(always)]
    #[must_use]
    pub fn pullctl(&mut self) -> PullctlW<Ioc14Spec> {
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved15(&mut self) -> Reserved15W<Ioc14Spec> {
...
Edge detect configuration"]
    #[inline(always)]
    #[must_use]
    pub fn edgedet(&mut self) -> EdgedetW<Ioc14Spec> {
...
Wakeup enable from standby"]
    #[inline(always)]
    #[must_use]
    pub fn wuensb(&mut self) -> WuensbW<Ioc14Spec> {
        WuensbW::new(self, 18)
    }
    #[doc = "Bit 19 - 19:19\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved19(&mut self) -> Reserved19W<Ioc14Spec> {
...
Wakeup configuration from shutdown"]
    #[inline(always)]
    #[must_use]
    pub fn wucfgsd(&mut self) -> WucfgsdW<Ioc14Spec> {
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved22(&mut self) -> Reserved22W<Ioc14Spec> {
...
IO Mode. Setting this to value 0x6 or 0x7 will default to normal IO behavior."]
    #[inline(always)]
    #[must_use]
    pub fn iomode(&mut self) -> IomodeW<Ioc14Spec> {
        IomodeW::new(self, 24)
    }
    #[doc = "Bits 27:28 - 28:27\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved27(&mut self) -> Reserved27W<Ioc14Spec> {
...
Input enable"]
    #[inline(always)]
    #[must_use]
    pub fn inpen(&mut self) -> InpenW<Ioc14Spec> {
        InpenW::new(self, 29)
    }
    #[doc = "Bit 30 - 30:30\\]
This field controls input hysteresis"]
    #[inline(always)]
    #[must_use]
    pub fn hysten(&mut self) -> HystenW<Ioc14Spec> {
        HystenW::new(self, 30)
    }
    #[doc = "Bit 31 - 31:31\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved31(&mut self) -> Reserved31W<Ioc14Spec> {
        Reserved31W::new(self, 31)
    }
}
#[doc = "Configuration of DIO14\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ioc14::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ioc14::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ioc14Spec;
impl crate::RegisterSpec for Ioc14Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ioc14::R`](R) reader structure"]
impl crate::Readable for Ioc14Spec {}
#[doc = "`write(|w| ..)` method takes [`ioc14::W`](W) writer structure"]
impl crate::Writable for Ioc14Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets IOC14 to value 0"]
impl crate::Resettable for Ioc14Spec {
