#[doc = "Register `IOC19` reader"]
pub type R = crate::R<Ioc19Spec>;
#[doc = "Register `IOC19` writer"]
pub type W = crate::W<Ioc19Spec>;
#[doc = "2:0\\]
Port configuration.\n\nValue on reset: 0"]
...
Port configuration."]
    #[inline(always)]
    #[must_use]
    pub fn portcfg(&mut self) -> PortcfgW<Ioc19Spec> {
        PortcfgW::new(self, 0)
    }
    #[doc = "Bits 3:7 - 7:3\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved3(&mut self) -> Reserved3W<Ioc19Spec> {
...
Drive strength configuration"]
    #[inline(always)]
    #[must_use]
    pub fn iostr(&mut self) -> IostrW<Ioc19Spec> {
        IostrW::new(self, 8)
    }
    #[doc = "Bits 10:11 - 11:10\\]
Output current configuration. Writing value 0x3 defaults to 2mA current setting."]
    #[inline(always)]
    #[must_use]
    pub fn iocurr(&mut self) -> IocurrW<Ioc19Spec> {
        IocurrW::new(self, 10)
    }
    #[doc = "Bit 12 - 12:12\\]
Slew rate configuration"]
    #[inline(always)]
    #[must_use]
    pub fn slewred(&mut self) -> SlewredW<Ioc19Spec> {
...
Pull control. Setting this to value 0x3 disables pull."]
    #[inline(always)]
    #[must_use]
    pub fn pullctl(&mut self) -> PullctlW<Ioc19Spec> {
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved15(&mut self) -> Reserved15W<Ioc19Spec> {
...
Edge detect configuration"]
    #[inline(always)]
    #[must_use]
    pub fn edgedet(&mut self) -> EdgedetW<Ioc19Spec> {
...
Wakeup enable from standby"]
    #[inline(always)]
    #[must_use]
    pub fn wuensb(&mut self) -> WuensbW<Ioc19Spec> {
        WuensbW::new(self, 18)
    }
    #[doc = "Bit 19 - 19:19\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved19(&mut self) -> Reserved19W<Ioc19Spec> {
...
Wakeup configuration from shutdown"]
    #[inline(always)]
    #[must_use]
    pub fn wucfgsd(&mut self) -> WucfgsdW<Ioc19Spec> {
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved22(&mut self) -> Reserved22W<Ioc19Spec> {
...
IO Mode. Setting this to value 0x6 or 0x7 will default to normal IO behavior."]
    #[inline(always)]
    #[must_use]
    pub fn iomode(&mut self) -> IomodeW<Ioc19Spec> {
        IomodeW::new(self, 24)
    }
    #[doc = "Bits 27:28 - 28:27\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved27(&mut self) -> Reserved27W<Ioc19Spec> {
...
Input enable"]
    #[inline(always)]
    #[must_use]
    pub fn inpen(&mut self) -> InpenW<Ioc19Spec> {
        InpenW::new(self, 29)
    }
    #[doc = "Bit 30 - 30:30\\]
This field controls input hysteresis"]
    #[inline(always)]
    #[must_use]
    pub fn hysten(&mut self) -> HystenW<Ioc19Spec> {
        HystenW::new(self, 30)
    }
    #[doc = "Bit 31 - 31:31\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved31(&mut self) -> Reserved31W<Ioc19Spec> {
        Reserved31W::new(self, 31)
    }
}
#[doc = "Configuration of DIO19\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ioc19::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ioc19::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ioc19Spec;
impl crate::RegisterSpec for Ioc19Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ioc19::R`](R) reader structure"]
impl crate::Readable for Ioc19Spec {}
#[doc = "`write(|w| ..)` method takes [`ioc19::W`](W) writer structure"]
impl crate::Writable for Ioc19Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets IOC19 to value 0"]
impl crate::Resettable for Ioc19Spec {
