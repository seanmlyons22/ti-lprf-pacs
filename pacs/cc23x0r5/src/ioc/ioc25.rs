#[doc = "Register `IOC25` reader"]
pub type R = crate::R<Ioc25Spec>;
#[doc = "Register `IOC25` writer"]
pub type W = crate::W<Ioc25Spec>;
#[doc = "2:0\\]
Port configuration.\n\nValue on reset: 0"]
...
Edge detect configuration"]
    #[inline(always)]
    #[must_use]
    pub fn edgedet(&mut self) -> EdgedetW<Ioc25Spec> {
...
Input enable"]
    #[inline(always)]
    #[must_use]
    pub fn inpen(&mut self) -> InpenW<Ioc25Spec> {
        InpenW::new(self, 29)
    }
    #[doc = "Bit 30 - 30:30\\]
This field controls input hysteresis"]
...
pub struct Ioc25Spec;
impl crate::RegisterSpec for Ioc25Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ioc25::R`](R) reader structure"]
impl crate::Readable for Ioc25Spec {}
#[doc = "`write(|w| ..)` method takes [`ioc25::W`](W) writer structure"]
impl crate::Writable for Ioc25Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets IOC25 to value 0"]
impl crate::Resettable for Ioc25Spec {
