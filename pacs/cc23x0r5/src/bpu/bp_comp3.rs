#[doc = "Register `BP_COMP3` reader"]
pub type R = crate::R<BpComp3Spec>;
#[doc = "Register `BP_COMP3` writer"]
pub type W = crate::W<BpComp3Spec>;
#[doc = "0:0\\]
Compare enable for Breakpoint Comparator Register 3. The ENABLE bit of BP_CTRL must also be set to enable comparisons. DBGRESETn clears the ENABLE bit.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Enable {
    #[doc = "1: Breakpoint Comparator Register 3 compare enabled"]
    BkptCompDis = 1,
    #[doc = "0: Breakpoint Comparator Register 3 compare disabled"]
    BkptCompEn = 0,
}
...
impl EnableR {
    ...
    #[doc = "Breakpoint Comparator Register 3 compare enabled"]
    #[inline(always)]
    pub fn is_bkpt_comp_dis(&self) -> bool {
        *self == Enable::BkptCompDis
    }
    #[doc = "Breakpoint Comparator Register 3 compare disabled"]
    #[inline(always)]
...
Compare enable for Breakpoint Comparator Register 3. The ENABLE bit of BP_CTRL must also be set to enable comparisons. DBGRESETn clears the ENABLE bit."]
    #[inline(always)]
    #[must_use]
    pub fn enable(&mut self) -> EnableW<BpComp3Spec> {
        EnableW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved1(&mut self) -> Reserved1W<BpComp3Spec> {
...
Comparison address, UNKNOWN on reset."]
    #[inline(always)]
    #[must_use]
    pub fn comp(&mut self) -> CompW<BpComp3Spec> {
        CompW::new(self, 2)
    }
    #[doc = "Bit 29 - 29:29\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved29(&mut self) -> Reserved29W<BpComp3Spec> {
...
This selects what happens when the COMP address is matched"]
    #[inline(always)]
    #[must_use]
    pub fn bp_match(&mut self) -> BpMatchW<BpComp3Spec> {
        BpMatchW::new(self, 30)
    }
}
#[doc = "Use the Breakpoint Comparator Registers to store the values to compare with the instruction address.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bp_comp3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bp_comp3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BpComp3Spec;
impl crate::RegisterSpec for BpComp3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bp_comp3::R`](R) reader structure"]
impl crate::Readable for BpComp3Spec {}
#[doc = "`write(|w| ..)` method takes [`bp_comp3::W`](W) writer structure"]
impl crate::Writable for BpComp3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BP_COMP3 to value 0"]
impl crate::Resettable for BpComp3Spec {
