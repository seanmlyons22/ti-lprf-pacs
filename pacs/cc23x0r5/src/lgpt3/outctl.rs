...
Clear output 0. Write 1 to clear output 0."]
    ...
    pub fn clrout0(&self) -> Clrout0R {
        Clrout0R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Set output 0. Write 1 to set output 0."]
    #[inline(always)]
    pub fn setout0(&self) -> Setout0R {
        Setout0R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - 2:2\\]
Clear output 1. Write 1 to clear output 1."]
    #[inline(always)]
    pub fn clrout1(&self) -> Clrout1R {
        Clrout1R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - 3:3\\]
Set output 1. Write 1 to set output 1."]
    #[inline(always)]
    pub fn setout1(&self) -> Setout1R {
        Setout1R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - 4:4\\]
Clear output 2. Write 1 to clear output 2."]
    #[inline(always)]
    pub fn clrout2(&self) -> Clrout2R {
        Clrout2R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - 5:5\\]
Set output 2. Write 1 to set output 2."]
    #[inline(always)]
    pub fn setout2(&self) -> Setout2R {
        Setout2R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bits 6:31 - 31:6\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved6(&mut self) -> Reserved6W<OutctlSpec> {
