#[doc = "Register `PC1CCNC` reader"]
pub type R = crate::R<Pc1ccncSpec>;
#[doc = "Register `PC1CCNC` writer"]
pub type W = crate::W<Pc1ccncSpec>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved24(&mut self) -> Reserved24W<Pc1ccncSpec> {
...
pub struct Pc1ccncSpec;
impl crate::RegisterSpec for Pc1ccncSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pc1ccnc::R`](R) reader structure"]
impl crate::Readable for Pc1ccncSpec {}
#[doc = "`write(|w| ..)` method takes [`pc1ccnc::W`](W) writer structure"]
impl crate::Writable for Pc1ccncSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PC1CCNC to value 0"]
impl crate::Resettable for Pc1ccncSpec {
