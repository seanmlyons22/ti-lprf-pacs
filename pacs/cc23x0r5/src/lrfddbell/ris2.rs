...
PBE0 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe0(&mut self) -> Pbe0W<Ris2Spec> {
        Pbe0W::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
PBE1 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe1(&mut self) -> Pbe1W<Ris2Spec> {
        Pbe1W::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
PBE2 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe2(&mut self) -> Pbe2W<Ris2Spec> {
        Pbe2W::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
PBE3 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe3(&mut self) -> Pbe3W<Ris2Spec> {
        Pbe3W::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
PBE4 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe4(&mut self) -> Pbe4W<Ris2Spec> {
        Pbe4W::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
PBE5 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe5(&mut self) -> Pbe5W<Ris2Spec> {
        Pbe5W::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
PBE6 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe6(&mut self) -> Pbe6W<Ris2Spec> {
        Pbe6W::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
PBE7 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe7(&mut self) -> Pbe7W<Ris2Spec> {
        Pbe7W::new(self, 7)
    }
    #[doc = "Bit 8 - 8:8\\]
PBE8 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe8(&mut self) -> Pbe8W<Ris2Spec> {
        Pbe8W::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
PBE9 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe9(&mut self) -> Pbe9W<Ris2Spec> {
        Pbe9W::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
PBE10 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe10(&mut self) -> Pbe10W<Ris2Spec> {
        Pbe10W::new(self, 10)
    }
    #[doc = "Bit 11 - 11:11\\]
PBE11 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe11(&mut self) -> Pbe11W<Ris2Spec> {
        Pbe11W::new(self, 11)
    }
    #[doc = "Bit 12 - 12:12\\]
PBE12 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe12(&mut self) -> Pbe12W<Ris2Spec> {
        Pbe12W::new(self, 12)
    }
    #[doc = "Bit 13 - 13:13\\]
PBE13 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe13(&mut self) -> Pbe13W<Ris2Spec> {
        Pbe13W::new(self, 13)
    }
    #[doc = "Bit 14 - 14:14\\]
PBE14 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe14(&mut self) -> Pbe14W<Ris2Spec> {
        Pbe14W::new(self, 14)
    }
    #[doc = "Bit 15 - 15:15\\]
PBE15 event"]
    #[inline(always)]
    #[must_use]
    pub fn pbe15(&mut self) -> Pbe15W<Ris2Spec> {
        Pbe15W::new(self, 15)
    }
    #[doc = "Bit 16 - 16:16\\]
RXFIFO event"]
    #[inline(always)]
    #[must_use]
    pub fn rxfifo(&mut self) -> RxfifoW<Ris2Spec> {
        RxfifoW::new(self, 16)
    }
    #[doc = "Bit 17 - 17:17\\]
TXFIFO event"]
    #[inline(always)]
    #[must_use]
    pub fn txfifo(&mut self) -> TxfifoW<Ris2Spec> {
        TxfifoW::new(self, 17)
    }
    #[doc = "Bit 18 - 18:18\\]
LOSS_OF_LOCK event"]
    #[inline(always)]
    #[must_use]
    pub fn lol(&mut self) -> LolW<Ris2Spec> {
        LolW::new(self, 18)
    }
    #[doc = "Bit 19 - 19:19\\]
LOCK event"]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LockW<Ris2Spec> {
        LockW::new(self, 19)
    }
    #[doc = "Bit 20 - 20:20\\]
RFESOFT0 event"]
    #[inline(always)]
    #[must_use]
    pub fn rfesoft0(&mut self) -> Rfesoft0W<Ris2Spec> {
...
RFESOFT1 event"]
    #[inline(always)]
    #[must_use]
    pub fn rfesoft1(&mut self) -> Rfesoft1W<Ris2Spec> {
...
RFEDONE event"]
    #[inline(always)]
    #[must_use]
    pub fn rfedone(&mut self) -> RfedoneW<Ris2Spec> {
...
MDMSOFT event"]
    #[inline(always)]
    #[must_use]
    pub fn mdmsoft0(&mut self) -> Mdmsoft0W<Ris2Spec> {
...
MDMSOFT1 event"]
    #[inline(always)]
    #[must_use]
    pub fn mdmsoft1(&mut self) -> Mdmsoft1W<Ris2Spec> {
...
MDMSOFT event"]
    #[inline(always)]
    #[must_use]
    pub fn mdmsoft2(&mut self) -> Mdmsoft2W<Ris2Spec> {
...
MDMOUT event"]
    #[inline(always)]
    #[must_use]
    pub fn mdmout(&mut self) -> MdmoutW<Ris2Spec> {
        MdmoutW::new(self, 26)
    }
    #[doc = "Bit 27 - 27:27\\]
MDMIN event"]
    #[inline(always)]
    #[must_use]
    pub fn mdmin(&mut self) -> MdminW<Ris2Spec> {
        MdminW::new(self, 27)
    }
    #[doc = "Bit 28 - 28:28\\]
MDMDONE event"]
    #[inline(always)]
    #[must_use]
    pub fn mdmdone(&mut self) -> MdmdoneW<Ris2Spec> {
...
SYSTIM0 event"]
    #[inline(always)]
    #[must_use]
    pub fn systim0(&mut self) -> Systim0W<Ris2Spec> {
...
SYSTIM1 event"]
    #[inline(always)]
    #[must_use]
    pub fn systim1(&mut self) -> Systim1W<Ris2Spec> {
...
SYSTIM2 event"]
    #[inline(always)]
    #[must_use]
    pub fn systim2(&mut self) -> Systim2W<Ris2Spec> {
