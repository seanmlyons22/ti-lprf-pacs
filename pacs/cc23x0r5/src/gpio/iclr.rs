...
Clears DIO0 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio0(&mut self) -> Dio0W<IclrSpec> {
        Dio0W::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Clears DIO1 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio1(&mut self) -> Dio1W<IclrSpec> {
        Dio1W::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Clears DIO2 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio2(&mut self) -> Dio2W<IclrSpec> {
        Dio2W::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Clears DIO3 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio3(&mut self) -> Dio3W<IclrSpec> {
        Dio3W::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Clears DIO4 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio4(&mut self) -> Dio4W<IclrSpec> {
        Dio4W::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Clears DIO5 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio5(&mut self) -> Dio5W<IclrSpec> {
        Dio5W::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Clears DIO6 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio6(&mut self) -> Dio6W<IclrSpec> {
        Dio6W::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Clears DIO7 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio7(&mut self) -> Dio7W<IclrSpec> {
        Dio7W::new(self, 7)
    }
    #[doc = "Bit 8 - 8:8\\]
Clears DIO8 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio8(&mut self) -> Dio8W<IclrSpec> {
        Dio8W::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Clears DIO9 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio9(&mut self) -> Dio9W<IclrSpec> {
        Dio9W::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
Clears DIO10 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio10(&mut self) -> Dio10W<IclrSpec> {
        Dio10W::new(self, 10)
    }
    #[doc = "Bit 11 - 11:11\\]
Clears DIO11 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio11(&mut self) -> Dio11W<IclrSpec> {
        Dio11W::new(self, 11)
    }
    #[doc = "Bit 12 - 12:12\\]
Clears DIO12 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio12(&mut self) -> Dio12W<IclrSpec> {
        Dio12W::new(self, 12)
    }
    #[doc = "Bit 13 - 13:13\\]
Clears DIO13 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio13(&mut self) -> Dio13W<IclrSpec> {
        Dio13W::new(self, 13)
    }
    #[doc = "Bit 14 - 14:14\\]
Clears DIO14 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio14(&mut self) -> Dio14W<IclrSpec> {
        Dio14W::new(self, 14)
    }
    #[doc = "Bit 15 - 15:15\\]
Clears DIO15 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio15(&mut self) -> Dio15W<IclrSpec> {
        Dio15W::new(self, 15)
    }
    #[doc = "Bit 16 - 16:16\\]
Clears DIO16 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio16(&mut self) -> Dio16W<IclrSpec> {
        Dio16W::new(self, 16)
    }
    #[doc = "Bit 17 - 17:17\\]
Clears DIO17 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio17(&mut self) -> Dio17W<IclrSpec> {
        Dio17W::new(self, 17)
    }
    #[doc = "Bit 18 - 18:18\\]
Clears DIO18 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio18(&mut self) -> Dio18W<IclrSpec> {
        Dio18W::new(self, 18)
    }
    #[doc = "Bit 19 - 19:19\\]
Clears DIO19 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio19(&mut self) -> Dio19W<IclrSpec> {
        Dio19W::new(self, 19)
    }
    #[doc = "Bit 20 - 20:20\\]
Clears DIO20 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio20(&mut self) -> Dio20W<IclrSpec> {
        Dio20W::new(self, 20)
    }
    #[doc = "Bit 21 - 21:21\\]
Clears DIO21 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio21(&mut self) -> Dio21W<IclrSpec> {
        Dio21W::new(self, 21)
    }
    #[doc = "Bit 22 - 22:22\\]
Clears DIO22 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio22(&mut self) -> Dio22W<IclrSpec> {
        Dio22W::new(self, 22)
    }
    #[doc = "Bit 23 - 23:23\\]
Clears DIO23 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio23(&mut self) -> Dio23W<IclrSpec> {
        Dio23W::new(self, 23)
    }
    #[doc = "Bit 24 - 24:24\\]
Clears DIO24 in RIS"]
    #[inline(always)]
    #[must_use]
    pub fn dio24(&mut self) -> Dio24W<IclrSpec> {
        Dio24W::new(self, 24)
    }
    #[doc = "Bit 25 - 25:25\\]
Clears DIO25 in RIS"]
