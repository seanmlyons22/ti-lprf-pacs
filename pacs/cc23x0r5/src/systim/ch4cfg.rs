#[doc = "Register `CH4CFG` reader"]
pub type R = crate::R<Ch4cfgSpec>;
#[doc = "Register `CH4CFG` writer"]
...
Decides the channel mode."]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<Ch4cfgSpec> {
        ModeW::new(self, 0)
    }
    #[doc = "Bits 1:2 - 2:1\\]
Decides the channel input signal's mode. Setting the Value as 2'b11 selects the Rise Function"]
    #[inline(always)]
    #[must_use]
    pub fn inp(&mut self) -> InpW<Ch4cfgSpec> {
        InpW::new(self, 1)
    }
    #[doc = "Bit 3 - 3:3\\]
When Rearm is enabled the channel remains in continous capture mode. Otherwise it'll be in One shot capture mode. Rearm is only valid for capture mode."]
    #[inline(always)]
    #[must_use]
    pub fn rearm(&mut self) -> RearmW<Ch4cfgSpec> {
        RearmW::new(self, 3)
    }
    #[doc = "Bits 4:31 - 31:4\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved4(&mut self) -> Reserved4W<Ch4cfgSpec> {
        Reserved4W::new(self, 4)
    }
}
#[doc = "Systimer channel 4 configuration. This channel works in 250ns based capture and compare operations.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch4cfg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch4cfg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch4cfgSpec;
impl crate::RegisterSpec for Ch4cfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch4cfg::R`](R) reader structure"]
impl crate::Readable for Ch4cfgSpec {}
#[doc = "`write(|w| ..)` method takes [`ch4cfg::W`](W) writer structure"]
impl crate::Writable for Ch4cfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH4CFG to value 0"]
