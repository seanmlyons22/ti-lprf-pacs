...
IP Instance ID number. If multiple instances of IP exists in SOC, this field can identify the instance number 0-15"]
...
#[doc = "`reset()` method sets DESC to value 0x9443_1010"]
impl crate::Resettable for DescSpec {
    const RESET_VALUE: u32 = 0x9443_1010;
}
