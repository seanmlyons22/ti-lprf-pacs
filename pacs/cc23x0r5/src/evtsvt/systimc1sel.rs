#[doc = "Register `SYSTIMC1SEL` reader"]
pub type R = crate::R<Systimc1selSpec>;
#[doc = "Register `SYSTIMC1SEL` writer"]
pub type W = crate::W<Systimc1selSpec>;
#[doc = "5:0\\]
...
Read/write selection value. Writing any other value than values defined by a ENUM may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn pubid(&mut self) -> PubidW<Systimc1selSpec> {
        PubidW::new(self, 0)
    }
    #[doc = "Bits 6:31 - 31:6\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior"]
    #[inline(always)]
    #[must_use]
    pub fn reserved6(&mut self) -> Reserved6W<Systimc1selSpec> {
        Reserved6W::new(self, 6)
    }
}
#[doc = "Output Selection for CPU Interrupt SYSTIMC1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`systimc1sel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`systimc1sel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Systimc1selSpec;
impl crate::RegisterSpec for Systimc1selSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`systimc1sel::R`](R) reader structure"]
impl crate::Readable for Systimc1selSpec {}
#[doc = "`write(|w| ..)` method takes [`systimc1sel::W`](W) writer structure"]
impl crate::Writable for Systimc1selSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SYSTIMC1SEL to value 0"]
impl crate::Resettable for Systimc1selSpec {
