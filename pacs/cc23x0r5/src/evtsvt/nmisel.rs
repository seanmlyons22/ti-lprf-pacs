#[doc = "Register `NMISEL` reader"]
pub type R = crate::R<NmiselSpec>;
#[doc = "Register `NMISEL` writer"]
pub type W = crate::W<NmiselSpec>;
#[doc = "5:0\\]
...
pub enum Pubid {
    ...
    SystimComb = 8,
    #[doc = "1: Selects an AON_NMI source, controlled by EVTULL:NMISEL"]
    AonNmiSel = 1,
...
impl PubidR {
    ...
    #[doc = "Selects an AON_NMI source, controlled by EVTULL:NMISEL"]
    #[inline(always)]
    pub fn is_aon_nmi_sel(&self) -> bool {
        *self == Pubid::AonNmiSel
    }
    #[doc = "Always inactive"]
    #[inline(always)]
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Selects an AON_NMI source, controlled by EVTULL:NMISEL"]
    #[inline(always)]
    pub fn aon_nmi_sel(self) -> &'a mut crate::W<REG> {
        self.variant(Pubid::AonNmiSel)
    }
    #[doc = "Always inactive"]
    #[inline(always)]
...
Read/write selection value. Writing any other value than values defined by a ENUM may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn pubid(&mut self) -> PubidW<NmiselSpec> {
        PubidW::new(self, 0)
    }
    #[doc = "Bits 6:31 - 31:6\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior"]
    #[inline(always)]
    #[must_use]
    pub fn reserved6(&mut self) -> Reserved6W<NmiselSpec> {
        Reserved6W::new(self, 6)
    }
}
#[doc = "Output Selection for CPU NMI Interrupt\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`nmisel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`nmisel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct NmiselSpec;
impl crate::RegisterSpec for NmiselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`nmisel::R`](R) reader structure"]
impl crate::Readable for NmiselSpec {}
#[doc = "`write(|w| ..)` method takes [`nmisel::W`](W) writer structure"]
impl crate::Writable for NmiselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets NMISEL to value 0"]
impl crate::Resettable for NmiselSpec {
