#[doc = "Register `ADCTRGSEL` reader"]
pub type R = crate::R<AdctrgselSpec>;
#[doc = "Register `ADCTRGSEL` writer"]
pub type W = crate::W<AdctrgselSpec>;
#[doc = "5:0\\]
...
Read/write selection value. Writing any other value than values defined by a ENUM may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn pubid(&mut self) -> PubidW<AdctrgselSpec> {
        PubidW::new(self, 0)
    }
    #[doc = "Bits 6:31 - 31:6\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior"]
    #[inline(always)]
    #[must_use]
    pub fn reserved6(&mut self) -> Reserved6W<AdctrgselSpec> {
        Reserved6W::new(self, 6)
    }
}
#[doc = "Output Selection for CPU Interrupt ADCTRG\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`adctrgsel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`adctrgsel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AdctrgselSpec;
impl crate::RegisterSpec for AdctrgselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adctrgsel::R`](R) reader structure"]
impl crate::Readable for AdctrgselSpec {}
#[doc = "`write(|w| ..)` method takes [`adctrgsel::W`](W) writer structure"]
impl crate::Writable for AdctrgselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ADCTRGSEL to value 0"]
impl crate::Resettable for AdctrgselSpec {
