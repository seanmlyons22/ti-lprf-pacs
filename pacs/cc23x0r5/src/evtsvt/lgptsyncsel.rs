#[doc = "Register `LGPTSYNCSEL` reader"]
pub type R = crate::R<LgptsyncselSpec>;
#[doc = "Register `LGPTSYNCSEL` writer"]
pub type W = crate::W<LgptsyncselSpec>;
#[doc = "5:0\\]
...
Read/write selection value. Writing any other value than values defined by a ENUM may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn pubid(&mut self) -> PubidW<LgptsyncselSpec> {
        PubidW::new(self, 0)
    }
    #[doc = "Bits 6:31 - 31:6\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior"]
    #[inline(always)]
    #[must_use]
    pub fn reserved6(&mut self) -> Reserved6W<LgptsyncselSpec> {
        Reserved6W::new(self, 6)
    }
}
#[doc = "Output Selection for CPU Interrupt LGPTSYNC\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lgptsyncsel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lgptsyncsel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LgptsyncselSpec;
impl crate::RegisterSpec for LgptsyncselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lgptsyncsel::R`](R) reader structure"]
impl crate::Readable for LgptsyncselSpec {}
#[doc = "`write(|w| ..)` method takes [`lgptsyncsel::W`](W) writer structure"]
impl crate::Writable for LgptsyncselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LGPTSYNCSEL to value 0"]
impl crate::Resettable for LgptsyncselSpec {
