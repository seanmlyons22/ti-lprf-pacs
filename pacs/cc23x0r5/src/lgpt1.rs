...
pub mod chfilt;
#[doc = "FAULT (rw) register accessor: Fault This register is used to configure the fault input logic. Primary use scenario is to select CTL before starting the timer. Follow these steps to configure CTL while CTL.MODE is different from DIS: - Set C0CFG.EDGE to NONE. - Configure CTL. - Wait for three system clock periods before setting C0CFG.EDGE different from NONE. These steps prevent fault detection caused by expired signal values in synchronizers and edge-detection circuit.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`fault::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`fault::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fault`]
module"]
#[doc(alias = "FAULT")]
pub type Fault = crate::Reg<fault::FaultSpec>;
#[doc = "Fault This register is used to configure the fault input logic. Primary use scenario is to select CTL before starting the timer. Follow these steps to configure CTL while CTL.MODE is different from DIS: - Set C0CFG.EDGE to NONE. - Configure CTL. - Wait for three system clock periods before setting C0CFG.EDGE different from NONE. These steps prevent fault detection caused by expired signal values in synchronizers and edge-detection circuit."]
pub mod fault;
#[doc = "PARK (rw) register accessor: Park This register configures how the outputs should be set in Park mode. Park mode is either entered by debug halt or fault. Park mode is activated when the counter stops. Park mode is inactive when the counter starts. When park mode is active all outputs are set to their predefined states. For IO output signals which have enabled dead band, a dead band insertion will be done before switching to the predefined state.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`park::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`park::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@park`]
module"]
#[doc(alias = "PARK")]
pub type Park = crate::Reg<park::ParkSpec>;
#[doc = "Park This register configures how the outputs should be set in Park mode. Park mode is either entered by debug halt or fault. Park mode is activated when the counter stops. Park mode is inactive when the counter starts. When park mode is active all outputs are set to their predefined states. For IO output signals which have enabled dead band, a dead band insertion will be done before switching to the predefined state."]
pub mod park;
#[doc = "DBDLY (rw) register accessor: Dead Band Delay This register is used to insert a dead band delay when generating complementary PWM signals. To enable dead band, on for example IO output 0, create a reference PWM signal on Output 0, then set DBCTL.IOC0 = EN. TBD: 12-bit width fall delay and rise delay may be excessive, if 8-bits are enough we can join DBDLY and DBCTL.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dbdly::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dbdly::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@dbdly`]
module"]
#[doc(alias = "DBDLY")]
pub type Dbdly = crate::Reg<dbdly::DbdlySpec>;
#[doc = "Dead Band Delay This register is used to insert a dead band delay when generating complementary PWM signals. To enable dead band, on for example IO output 0, create a reference PWM signal on Output 0, then set DBCTL.IOC0 = EN. TBD: 12-bit width fall delay and rise delay may be excessive, if 8-bits are enough we can join DBDLY and DBCTL."]
pub mod dbdly;
#[doc = "DBCTL (rw) register accessor: Dead Band Control This register is used to enable dead band for IOC outputs.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dbctl::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dbctl::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@dbctl`]
module"]
#[doc(alias = "DBCTL")]
