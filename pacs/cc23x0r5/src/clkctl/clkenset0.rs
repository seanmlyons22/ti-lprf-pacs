#[doc = "Register `CLKENSET0` reader"]
pub type R = crate::R<Clkenset0Spec>;
#[doc = "Register `CLKENSET0` writer"]
pub type W = crate::W<Clkenset0Spec>;
#[doc = "0:0\\]
Configure IP clock enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Gpio {
    #[doc = "1: Set IP clock enable"]
    ClkSet = 1,
...
impl GpioR {
    ...
    #[doc = "Set IP clock enable"]
    #[inline(always)]
    pub fn is_clk_set(&self) -> bool {
        *self == Gpio::ClkSet
    }
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Set IP clock enable"]
    #[inline(always)]
    pub fn clk_set(self) -> &'a mut crate::W<REG> {
        self.variant(Gpio::ClkSet)
    }
    #[doc = "IP clock enable is unchanged"]
    #[inline(always)]
...
Configure IP clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpio(&mut self) -> GpioW<Clkenset0Spec> {
        GpioW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Configure IP clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn lrfd(&mut self) -> LrfdW<Clkenset0Spec> {
        LrfdW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Configure IP clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn uart0(&mut self) -> Uart0W<Clkenset0Spec> {
        Uart0W::new(self, 2)
    }
    #[doc = "Bits 3:5 - 5:3\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved3(&mut self) -> Reserved3W<Clkenset0Spec> {
...
Configure IP clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn i2c0(&mut self) -> I2c0W<Clkenset0Spec> {
        I2c0W::new(self, 6)
    }
    #[doc = "Bits 7:9 - 9:7\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved7(&mut self) -> Reserved7W<Clkenset0Spec> {
...
Configure IP clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn spi0(&mut self) -> Spi0W<Clkenset0Spec> {
        Spi0W::new(self, 10)
    }
    #[doc = "Bits 11:13 - 13:11\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved11(&mut self) -> Reserved11W<Clkenset0Spec> {
...
Configure IP clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn adc0(&mut self) -> Adc0W<Clkenset0Spec> {
        Adc0W::new(self, 14)
    }
    #[doc = "Bit 15 - 15:15\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved15(&mut self) -> Reserved15W<Clkenset0Spec> {
...
Configure IP clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn laes(&mut self) -> LaesW<Clkenset0Spec> {
        LaesW::new(self, 16)
    }
    #[doc = "Bit 17 - 17:17\\]
Configure IP clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma(&mut self) -> DmaW<Clkenset0Spec> {
        DmaW::new(self, 17)
    }
    #[doc = "Bits 18:26 - 26:18\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved18(&mut self) -> Reserved18W<Clkenset0Spec> {
...
Configure IP clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn lgpt0(&mut self) -> Lgpt0W<Clkenset0Spec> {
        Lgpt0W::new(self, 27)
    }
    #[doc = "Bit 28 - 28:28\\]
Configure IP clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn lgpt1(&mut self) -> Lgpt1W<Clkenset0Spec> {
        Lgpt1W::new(self, 28)
    }
    #[doc = "Bit 29 - 29:29\\]
Configure IP clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn lgpt2(&mut self) -> Lgpt2W<Clkenset0Spec> {
        Lgpt2W::new(self, 29)
    }
    #[doc = "Bit 30 - 30:30\\]
Configure IP clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn lgpt3(&mut self) -> Lgpt3W<Clkenset0Spec> {
        Lgpt3W::new(self, 30)
    }
    #[doc = "Bit 31 - 31:31\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved31(&mut self) -> Reserved31W<Clkenset0Spec> {
        Reserved31W::new(self, 31)
    }
}
#[doc = "Clock Enable Set Register 0. This register enables IP clocks in the system. Used to set the corresponding fields in CLKCFG0 to 1.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clkenset0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clkenset0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Clkenset0Spec;
impl crate::RegisterSpec for Clkenset0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clkenset0::R`](R) reader structure"]
impl crate::Readable for Clkenset0Spec {}
#[doc = "`write(|w| ..)` method takes [`clkenset0::W`](W) writer structure"]
impl crate::Writable for Clkenset0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLKENSET0 to value 0"]
impl crate::Resettable for Clkenset0Spec {
