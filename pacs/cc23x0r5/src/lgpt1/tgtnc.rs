#[doc = "Register `TGTNC` reader"]
pub type R = crate::R<TgtncSpec>;
#[doc = "Register `TGTNC` writer"]
pub type W = crate::W<TgtncSpec>;
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved16(&mut self) -> Reserved16W<TgtncSpec> {
...
pub struct TgtncSpec;
impl crate::RegisterSpec for TgtncSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tgtnc::R`](R) reader structure"]
impl crate::Readable for TgtncSpec {}
#[doc = "`write(|w| ..)` method takes [`tgtnc::W`](W) writer structure"]
impl crate::Writable for TgtncSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TGTNC to value 0xffff"]
impl crate::Resettable for TgtncSpec {
