#[doc = "Register `MEMCTL3` reader"]
pub type R = crate::R<Memctl3Spec>;
#[doc = "Register `MEMCTL3` writer"]
pub type W = crate::W<Memctl3Spec>;
#[doc = "4:0\\]
...
pub struct Memctl3Spec;
impl crate::RegisterSpec for Memctl3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`memctl3::R`](R) reader structure"]
impl crate::Readable for Memctl3Spec {}
#[doc = "`write(|w| ..)` method takes [`memctl3::W`](W) writer structure"]
impl crate::Writable for Memctl3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MEMCTL3 to value 0"]
impl crate::Resettable for Memctl3Spec {
