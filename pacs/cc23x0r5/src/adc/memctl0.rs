#[doc = "Register `MEMCTL0` reader"]
pub type R = crate::R<Memctl0Spec>;
#[doc = "Register `MEMCTL0` writer"]
pub type W = crate::W<Memctl0Spec>;
#[doc = "4:0\\]
...
Input channel select."]
    #[inline(always)]
    #[must_use]
    pub fn chansel(&mut self) -> ChanselW<Memctl0Spec> {
        ChanselW::new(self, 0)
    }
    #[doc = "Bits 5:7 - 7:5\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved5(&mut self) -> Reserved5W<Memctl0Spec> {
...
Voltage reference selection. AREF- must be connected to on-board ground when external reference option is selected. Note: Writing value 0x3 defaults to INTREF."]
    #[inline(always)]
    #[must_use]
    pub fn vrsel(&mut self) -> VrselW<Memctl0Spec> {
        VrselW::new(self, 8)
    }
    #[doc = "Bits 10:11 - 11:10\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved10(&mut self) -> Reserved10W<Memctl0Spec> {
...
Selects the source of sample timer period between SCOMP0 and SCOMP1."]
    #[inline(always)]
    #[must_use]
    pub fn stime(&mut self) -> StimeW<Memctl0Spec> {
        StimeW::new(self, 12)
    }
    #[doc = "Bits 13:23 - 23:13\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved13(&mut self) -> Reserved13W<Memctl0Spec> {
...
Trigger policy. Indicates if a trigger will be needed to step to the next MEMCTL in the sequence or to perform next conversion in the case of repeat single channel conversions."]
    #[inline(always)]
    #[must_use]
    pub fn trig(&mut self) -> TrigW<Memctl0Spec> {
        TrigW::new(self, 24)
    }
    #[doc = "Bits 25:27 - 27:25\\]
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved25(&mut self) -> Reserved25W<Memctl0Spec> {
...
Enable window comparator."]
    #[inline(always)]
    #[must_use]
    pub fn wincomp(&mut self) -> WincompW<Memctl0Spec> {
...
Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline(always)]
    #[must_use]
    pub fn reserved29(&mut self) -> Reserved29W<Memctl0Spec> {
        Reserved29W::new(self, 29)
    }
}
#[doc = "Conversion Memory Control Register 0. CTL0.ENC must be set to 0 to write to this register.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`memctl0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`memctl0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Memctl0Spec;
impl crate::RegisterSpec for Memctl0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`memctl0::R`](R) reader structure"]
impl crate::Readable for Memctl0Spec {}
#[doc = "`write(|w| ..)` method takes [`memctl0::W`](W) writer structure"]
impl crate::Writable for Memctl0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MEMCTL0 to value 0"]
impl crate::Resettable for Memctl0Spec {
